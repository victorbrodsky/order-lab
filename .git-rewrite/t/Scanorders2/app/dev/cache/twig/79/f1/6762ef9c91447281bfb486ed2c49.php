...
class __TwigTemplate_79f16762ef9c91447281bfb486ed2c49 extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Scan edit</h1>

    <form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("scan_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "OlegOrderformBundle:Scan:edit.html.twig";
    }
