...
/* OlegOrderformBundle:OrderInfo:new.html.twig */
class __TwigTemplate_832481a6830b5da978e926f33545f0f6 extends Twig_Template
{
...
;
    ...
    ";
        // line 14
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "provider"), 'row');
        echo "
    ";
        // line 15
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "pathologyService"), 'row');
        echo "
    ";
        // line 16
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "priority"), 'row');
        echo "
    ";
        // line 17
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "slideDelivery"), 'row');
        echo "
    ";
        // line 18
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "returnSlide"), 'row');
        echo "
...
";
        ...
        // line 26
        echo twig_escape_filter($this->env, $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "patient"), "vars"), "prototype"), "children"), "specimen", array(), "array"), "vars"), "prototype"), 'widget'));
        echo "\"
                    data-prototype-specimen=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "patient"), "vars"), "prototype"), 'widget'));
        echo "\"
     >  
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["patient"]) {
            ...
            echo "            <li>
                Patient!!!!!!!!";
            // line 32
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["patient"]) ? $context["patient"] : $this->getContext($context, "patient")), 'row');
            echo "
            </li>
            
            ";
            // line 35
            if ((!twig_test_empty($this->getAttribute((isset($context["patient"]) ? $context["patient"] : $this->getContext($context, "patient")), "specimen")))) {
                // line 36
                echo "                <h3>Specimen:</h3>
            ";
            }
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["specimen"]) {
                ...
                Specimen!!!!!!!";
                // line 40
                echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["specimen"]) ? $context["specimen"] : $this->getContext($context, "specimen")), 'row');
                echo "
                </li>
            ";
            }
...
";
    ...
    {
        return "OlegOrderformBundle:OrderInfo:new.html.twig";
    }
