...
//        $entity->setScan($scan_entity);
              
        $stain_entity = new Stain();
        $stain_entity->setName( key($helper->getStains()) );
        $entity->setStain($stain_entity);
...
//            $entity->setAccession($accession);
    ...
    /**
     * Finds and displays a Slide entity. //Option defaults={"id" = 1} does not work: it does slide/1 => slide/
     *
     * @Route("/{id}", name="slide_show", requirements={"id" = "\d+"})
     * @Method("GET")
     * @Template()
     */
