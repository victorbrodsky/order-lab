...
";
    ...
    public function getwidget_prototype($_widget = null, $_remove_text = null)
    {
        ...
        try {
            // line 3
            echo "    ";
            if ($this->getAttribute((isset($context["widget"]) ? $context["widget"] : $this->getContext($context, "widget")), "get", array(0 => "prototype"), "method")) {
                // line 4
                echo "        ";
                $context["form"] = $this->getAttribute((isset($context["widget"]) ? $context["widget"] : $this->getContext($context, "widget")), "get", array(0 => "prototype"), "method");
                // line 5
                echo "        ";
                $context["name"] = $this->getAttribute($this->getAttribute((isset($context["widget"]) ? $context["widget"] : $this->getContext($context, "widget")), "get", array(0 => "prototype"), "method"), "get", array(0 => "mrn"), "method");
                // line 6
                echo "    ";
            } else {
                // line 7
                ...
                // line 8
                echo "        ";
                $context["name"] = $this->getAttribute((isset($context["widget"]) ? $context["widget"] : $this->getContext($context, "widget")), "get", array(0 => "full_name"), "method");
                // line 9
                echo "    ";
            }
            // line 10
    ...
    <div data-content=\"";
        ...
        <a class=\"btn-remove\" data-related=\"";
            ...
            echo twig_escape_filter($this->env, (isset($context["name"]) ? $context["name"] : $this->getContext($context, "name")), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, (isset($context["remove_text"]) ? $context["remove_text"] : $this->getContext($context, "remove_text")), "html", null, true);
            echo "</a>
        ";
            // line 13
