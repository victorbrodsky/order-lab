...
class __TwigTemplate_16dc3d38801406856bf47740bef46804 extends Twig_Template
{
...
";
    ...
    {
        // line 7
        echo "<div class=\"jumbotron alert-info well\">
        <p><h1>Thank You For Your Order !</h1></p>
        <p><h3>Order #";
        // line 9
        echo twig_escape_filter($this->env, (isset($context["orderid"]) ? $context["orderid"] : $this->getContext($context, "orderid")), "html", null, true);
        echo " Successfully Submitted.</h3></p>
        <p><h3>Confirmation Email was sent to ";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "security"), "getToken", array(), "method"), "getAttribute", array(0 => "email"), "method"), "html", null, true);
        echo "</h3></p>      
    </div>
...
";
    ...
    {
        return "OlegOrderformBundle:ScanOrder:email.html.twig";
    }
