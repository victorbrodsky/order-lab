...
";
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            ";
            } elseif (($this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "status") == "cancel")) {
                // line 28
                echo "                <tr class=\"canceltr\" >
            ";
            } elseif (($this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "status") == "completed")) {
                // line 30
                echo "                <tr class=\"completedtr\" >
            ";
            } elseif (($this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "status") == "uncompleted")) {
                // line 32
            ...
            echo "                    ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "patient"));
            foreach ($context['_seq'] as $context["_key"] => $context["patient"]) {
                // line 47
                echo "                        <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("patient_show", array("id" => $this->getAttribute((isset($context["patient"]) ? $context["patient"] : null), "id"))), "html", null, true);
                echo "\">
                            Patient: (ID=";
                // line 48
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["patient"]) ? $context["patient"] : null), "id"), "html", null, true);
                echo ", MRN=";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["patient"]) ? $context["patient"] : null), "mrn"), "html", null, true);
                echo ")<br>
                        </a>
                    ";
            }
            ...
            if ($this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "orderdate")) {
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "orderdate"), "Y-m-d H"), "html", null, true);
                echo "h";
            }
            echo "</td>
                <td>";
