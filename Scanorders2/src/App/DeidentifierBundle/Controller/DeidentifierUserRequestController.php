...
class DeidentifierUserRequestController extends UserRequestController
{
     ...
     *
     * @Route("/account-requests/new", name="deidentifier_accountrequest_new")
     * @Method("GET")
     ...
     *
     * @Route("/account-requests/new", name="deidentifier_accountrequest_create")
     * @Method("POST")
     * @Template("OlegUserdirectoryBundle:UserRequest:account_request.html.twig")
     */
     ...
     *
     * @Route("/account-requests", name="deidentifier_accountrequest")
     * @Method("GET")
    ...
    /**
     * @Route("/account-requests/{id}/{status}/status", name="deidentifier_accountrequest_status", requirements={"id" = "\d+"})
     * @Method("GET")
     * @Template("OlegUserdirectoryBundle:UserRequest:index.html.twig")
     */
     ...
     *
     * @Route("/account-requests-approve", name="deidentifier_accountrequest_approve")
     * @Method("POST")
     * @Template("OlegUserdirectoryBundle:UserRequest:index.html.twig")
     */
