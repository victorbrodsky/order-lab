...
class CallLogUserRequestController extends UserRequestController
{

    public function __construct() {
        $this->siteName = 'calllog';
        $this->siteNameShowuser = 'calllog';
     ...
     *
     * @Route("/account-requests/new", name="calllog_accountrequest_new")
     * @Method("GET")
     ...
     *
     * @Route("/account-requests/new", name="calllog_accountrequest_create")
     * @Method("POST")
     * @Template("OlegUserdirectoryBundle:UserRequest:account_request.html.twig")
     */
     ...
     *
     * @Route("/account-requests", name="calllog_accountrequest")
     * @Method("GET")
    ...
    /**
     * @Route("/account-requests/{id}/{status}/status", name="calllog_accountrequest_status", requirements={"id" = "\d+"})
     * @Method("GET")
     * @Template("OlegUserdirectoryBundle:UserRequest:index.html.twig")
     */
     ...
     *
     * @Route("/account-requests-approve", name="calllog_accountrequest_approve")
     * @Method("POST")
     * @Template("OlegUserdirectoryBundle:UserRequest:index.html.twig")
     */
