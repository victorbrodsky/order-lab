    ...
    public function mergePatientAjaxAction(Request $request)
    {
        ...
        if( $patient1 && $patient2 ) {
            ...
            if( !$mergedMrn1 && !$mergedMrn2 ) {
                ...
                $calllogUtil->addGenerateMergeMrnToPatient($patient1,$autoGeneratedMergeMrn,$user);
                $calllogUtil->addGenerateMergeMrnToPatient($patient2,$autoGeneratedMergeMrn,$user);
            }
