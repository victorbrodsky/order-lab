...
//            $this->generateFellAppReport( $fellowshipApplication->getId() );
...
//        }
        ...
        $fellappUtil->createFellAppReportDB($entity,$author,$uniqueid,$filename,$fileUniqueName,$uploadReportPath,$filesize);
        ...
        $event = "Report for Fellowship Application with ID".$id." has been successfully ".$actionStr." " . $filenameMerged;
    ...
    public function generateApplicationPdf($applicationId,$applicationOutputFilePath) {
        ...
        $pageUrl = $router->generate('fellapp_download',array('id' => $applicationId),true);
...
//            echo "add merge: filepath=(".$file.") => ";
    ...
    public function createFellAppReportDB($holderEntity,$author,$uniqueid,$title,$fileUniqueName,$path,$filesize) {
