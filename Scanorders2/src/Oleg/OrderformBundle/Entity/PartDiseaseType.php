...
//    /**
//     * @ORM\ManyToOne(targetEntity="", inversedBy="part", cascade={"persist"})
//     * @ORM\JoinColumn(name="diseasetype_id", referencedColumnName="id", nullable=true)
//     */
//    protected $field; //serve as "diseaseType"
    /**
