...
class BlocknameTransformer implements DataTransformerInterface
{
    /**
     * @var ObjectManager
     */
    ...
    public function reverseTransform($text)
    {
        ...
        if( is_numeric ( $text ) ) {    //number => most probably it is id
            ...
            $entity = $this->em->getRepository('OlegOrderformBundle:BlockList')->findOneById($text);
    ...
    public function createNew($name) {
        ...
        $entity = $this->em->getRepository('OlegOrderformBundle:BlockList')->findOneByName($name);
        
        if( null === $entity ) {

            $newEntity = new BlockList();
