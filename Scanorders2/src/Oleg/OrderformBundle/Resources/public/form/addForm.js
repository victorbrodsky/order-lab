...
$(document).ready(function() {
    ...
    $('.form_body_toggle_btn').on('click', function(e) {
        ...
        if( className == 'form_body_toggle_btn icon-folder-open') {
            $('.form_body_toggle_btn').removeClass('icon-folder-open');
            $('.form_body_toggle_btn').addClass('icon-folder-close');
        } else {
            $('.form_body_toggle_btn').removeClass('icon-folder-close');
            $('.form_body_toggle_btn').addClass('icon-folder-open');
        }
    });
    ...
    var formhtml =
        '<div id="formpanel_' +name + '_' + idsu + '" class="panel panel-'+name+'">' +
            '<div class="panel-heading" align="left">' +
                ...
                '<div class="form_body_toggle_btn icon-folder-open" data-toggle="collapse" data-target="#form_body_'+name+'_'+idsu+'"></div>' +
                ...
                '<div class="form-btn-options">' +
                    ...
                    '<button onclick="return confirm(\'Are you sure?\');" id="'+name+'_'+idsu+'" type="button" class="delete_form_btn span1 btn btn-danger btn_margin btn-mini">Delete</button>' +
                '</div>' +
            '</div>' +
