...
function addDiffdiagFieldFirstTime( name, ids ) {
    ...
    //add button   
    var btn = '<button onClick="addDiffdiagField(\'diffdiagnoses\',' + "\'multi\'," + patient + ',' +specimen+','+accession+','+part+')" class="btn btn-sm btn-info" type="button">+</button>';
...
function delDiffdiagField( name, type, patient, specimen, accession, part ) {
    ...
    //console.log("name="+name+",patient="+patient+ ",specimen="+specimen+",accession="+accession+",part="+part);
