...
//    var collectionHolder =  $('#'+name+'-data');
    ...
    if( name == "part" ) {
        //var diffdiagForm = getDiffdiagForm(idsu,diffdiag);
        //addDiffdiagField( form, patient, specimen, accession, part )
        //newForm = newForm + diffdiagForm;
        var diffdiagForm = addDiffdiagField( '', patientid, procedureid, accessionid, partid );
        //newForm = newForm + diffdiagForm;
    }
...
function getDiffdiagForm(idsu,diffdiag) {
    //diffDiagnoses_field_0_0_0_0_0_0_0_0_diffdiag_0
    var dataholder =  '#diffDiagnoses_field_'+idsu+'_diffdiag_'+diffdiag;
    console.log("dataholder="+dataholder);
    //diffDiagnoses_field_0_0_0_1_0_0_0_0_diffdiag_0
    var collectionHolder =  $(dataholder);
    var prototype = collectionHolder.data('prototype-diffDiagnoses');
    var newForm = prototype.replace(/__diffDiagnoses__/g, diffdiag);
    return newForm;
}
...
//var diffdiag = 0;
function addDiffdiagField_111( form, patient, specimen, accession, part ) {
    ...
    var partialId = "oleg_orderformbundle_orderinfotype_"+uid+"_diffDiagnoses";
    ...
    var addto = "#oleg_orderformbundle_orderinfotype_" + uid + "_diffDiagnoses_" + (diffdiagInt-1) + "_name";

    var nextId = "oleg_orderformbundle_orderinfotype_" + uid + "_diffDiagnoses_" + diffdiagInt + "_name";

    //console.log("addto="+addto);

    var newIn = '<br/><input id="' + nextId + '" type="text" class="form-control form-control-modif">';
...
//add different diagnoses input field
function addDiffdiagField( form, patient, specimen, accession, part ) {
    ...
    var newForm = getDiffdiagField( form, patient, specimen, accession, part, diffdiagInt );

    if( diffdiagInt == 0 ) {
        //<div id="diffdiagnoses_{{ uid }}">
        //diffdiagnoses_0_0_0_1_0_0_0_0
        //diffdiagnoses_0_0_0_1_0_0_0_0
        //oleg_orderformbundle_orderinfotype_patient_0_specimen_0_accession_0_part_1_diagnosis
        var addto = "#diffdiagnoses_" + patient+'_'+specimen+'_'+accession+'_'+part+'_0_0_0_0';
        console.log("addto="+addto);
        $(addto).after(newForm);
...
function getDiffdiagField( form, patient, specimen, accession, part, diffdiag ) {
    //diffDiagnoses_field_0_0_0_0_0_0_0_0_diffdiag_0
    var dataholder = "#formpanel_part_0_0_0_0_0_0_0_0"; //fixed data holder
    //console.log(dataholder);
    var collectionHolder =  $(dataholder);
