...
function addSameForm( name, patientid, procedureid, accessionid, partid, blockid, slideid, scanid, stainid ) {
    ...
    if( name == "part" ) {      
        addDiffdiagFieldFirstTime( name, ids, patientid, procedureid, accessionid, partid );      
    }
...
function addChildForms( parentName, name, prevName, patientid, procedureid, accessionid, partid, blockid, slideid, scanid, stainid ) {
    ...
    if( name == "part" ) {      
        addDiffdiagFieldFirstTime( parentName, ids, patientid, procedureid, accessionid, partid );      
    }
...
function getDiffdiagForm_todel(idsu,diffdiag) {
...
function addDiffdiagField( name, patient, specimen, accession, part ) {
...
function addDiffdiagFieldFirstTime( name, ids, patient, specimen, accession, part ) {
...
//    console.log("diffdiagInt="+diffdiagInt);
    ...
    //attach to: diffdiagnoses_0_0_0_1_0_0_0_0
    //var addto = "diffdiagnoses_" + patient+'_'+specimen+'_'+accession+'_'+part+'_0_0_0_0'; 
    var addto = "diffdiagnoses_" + patient+'_'+specimen+'_'+accession+'_';
    ...
    var btn = '<button onClick="addDiffdiagField(\'diffdiagnoses\',' + patient + ',' +specimen+','+accession+','+part+')" class="btn btn-sm btn-info" type="button">+</button>';
    //{% endif %}
