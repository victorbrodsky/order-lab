...
function getDiffdiagField( name, patient, specimen, accession, part, diffdiag ) {
    ...
    //inputGroupId_patient_0_specimen_0_accession_0_part_0_diffDiagnoses_0_diffDiagnoses
    var ending = "_diffDiagnoses_" + diffdiag + "_diffDiagnoses";
    var inputGroupId = 'inputGroupId_patient_'+patient+'_specimen_'+specimen+'_accession_'+accession+'_part_'+part+ending;
...
//        var addBtn = getAddBtn(name, type, patient, specimen, accession, part, diffdiag+11);
...
function getAddBtn(ident, type, patient, specimen, accession, part, collInt) {
    var addbtnId = 'addbtn_patient_'+patient+'_specimen_'+specimen+'_accession_'+accession+'_part_'+part+'_'+ident+'_'+collInt+'_'+ident;
    var btn = '<span id="'+addbtnId+'" onClick="addDiffdiagField(\''+ident+'\',\'' + type + '\',' + patient + ',' +specimen+','+accession+','+part+')"'+
        'class="input-group-addon btn" data-toggle="datepicker" type="button"><i class="glyphicon glyphicon-plus-sign"></i></span>';
    return btn;
}

function getDelBtn(ident, type, patient, specimen, accession, part, collInt) {
    var addbtnId = 'delbtn_patient_'+patient+'_specimen_'+specimen+'_accession_'+accession+'_part_'+part+'_'+ident+'_'+collInt+'_'+ident;
    var btn = '<span id="'+addbtnId+'" onClick="delDiffdiagField(\''+ident+'\',\'' + type + '\',' + patient + ',' +specimen+','+accession+','+part+','+collInt+')"'+
