...
function getCollField( ident, patient, procedure, accession, part, block, slide, coll ) {
    //console.log("coll field input:"+ident+"_"+patient+"_"+procedure+"_"+accession+"_"+part+"_"+block+"_"+slide+"_"+coll);
...
function delCollField( ident, type, patient, procedure, accession, part, block, slide ) {
    ...
    //Id Generated by Symfony: oleg_orderformbundle_orderinfotype_patient_0_procedure_0_accession_0_part_0_diffDiagnoses_0_name
    var uid = 'patient_'+patient+'_procedure_'+procedure+'_accession_'+accession+'_part_'+part+'_block_'+block+'_slide_'+slide+'_'+ident;
    ...
    //remove id: oleg_orderformbundle_orderinfotype_patient_0_procedure_0_accession_0_part_0_diffDiagnoses_1_name
...
function addDiffdiagField( name, type, patient, procedure, accession, part, block, slide ) {
    ...
    var partialUid = 'patient_'+patient+'_procedure_'+procedure+'_accession_'+accession+'_part_'+part+'_block_'+block+'_slide_'+slide;
    ...
    if( name == "relevantScans" ) {
        var uid = 'patient_'+patient+'_procedure_'+procedure+'_accession_'+accession+'_part_'+part+'_block_'+block+'_slide_'+slide;
    }
    var typeuid = uid + "_";
    ...
    //console.log("partialId="+partialId);
    //inputGroupId_patient_0_procedure_0_accession_0_part_1_block_0_slide_0_diffDiagnoses
    //inputGroupId_patient_0_procedure_0_accession_0_part_0_block_1_slide_0_diffDiagnoses_0_diffDiagnoses
    ...
    var newForm = getDiffdiagField( name, type, patient, procedure, accession, part, block, slide, diffdiagInt, false );
    ...
    if( diffdiagInt == 1 ) {
        //id of the input field: oleg_orderformbundle_orderinfotype_patient_0_procedure_0_accession_0_part_0_diffDiagnoses_4_name
        ...
        var btnDel = getDelBtn(name, type, patient, procedure, accession, part, block, slide, currFiledCollId);
    ...
    //delbtn_patient_0_procedure_0_accession_0_part_0_diffDiagnoses_3_diffDiagnoses
...
function addDiffdiagFieldFirstTime( name, ids ) {
    ...
    if( name == "part" ) {
        ...
        var prevId = 'oleg_orderformbundle_orderinfotype_patient_'+patient+'_procedure_'+procedure+'_accession_'+accession+'_part_'+part+'_diagnosis';
    }
...
function getDiffdiagField( name, type, patient, procedure, accession, part, block, slide, diffdiag, noDelBtn ) {
    ...
    //inputGroupId_patient_0_procedure_0_accession_0_part_0_diffDiagnoses_0_diffDiagnoses
    ...
    var btnAdd = getAddBtn(name, type, patient, procedure, accession, part, block, slide, diffdiag);

    var btnDel = "";
    if( noDelBtn != true ) {
        btnDel = getDelBtn(name, type, patient, procedure, accession, part, block, slide, diffdiag);
    }
...
function delDiffdiagField( name, type, patient, procedure, accession, part, block, slide, diffdiag ) {

    //console.log("name="+name+",type="+type+",patient="+patient+ ",procedure="+procedure+",accession="+accession+",part="+part);

    //Id Generated by Symfony: oleg_orderformbundle_orderinfotype_patient_0_procedure_0_accession_0_part_0_diffDiagnoses_0_name
    //var uid = 'patient_'+patient+'_procedure_'+procedure+'_accession_'+accession+'_part_'+part;
    var fullUid = 'patient_'+patient+'_procedure_'+procedure+'_accession_'+accession+'_part_'+part+'_block_'+block+'_slide_'+slide;
    if( name == "diffDiagnoses" ) {
        var uid = 'patient_'+patient+'_procedure_'+procedure+'_accession_'+accession+'_part_'+part;
    }
    if( name == "relevantScans" ) {
    ...
    //delete without asking confirmation if the input field is empty
    //remove id: oleg_orderformbundle_orderinfotype_patient_0_procedure_0_accession_0_part_0_diffDiagnoses_1_name
    //inputGroupId_patient_0_procedure_0_accession_0_part_0_diffDiagnoses_4_diffDiagnoses
    var delId = partialId + diffdiag + '_' + name;
    //console.log("inputGroupId delId="+delId);

    //oleg_orderformbundle_orderinfotype_patient_0_procedure_0_accession_0_part_0_diffDiagnoses_1_name
    ...
    if( remove == true ) {
        ...
        if( $("#"+lastAddBtnId).length > 0 ) {
            ...
            var addBtn = getAddBtn(name, type, patient, procedure, accession, part, block, slide, currFiledCollId);
...
function remDelBtnDiffDiag_TODEL(ident, type, patient, procedure, accession, part, collInt) { //TODO: delete this function

    //remove - button for the last field
    //console.log("last field!!!! del collInt="+collInt);
    //if( collInt == 0 ) {
    //remove - button
    var delbtnId = 'delbtn_patient_'+patient+'_procedure_'+procedure+'_accession_'+accession+'_part_'+part+'_'+ident+'_'+collInt+'_'+ident;
    //console.log("delbtnId="+delbtnId);
    $('#'+delbtnId).remove();
    //}
}

function getAddBtn(ident, type, patient, procedure, accession, part, block, slide, collInt) {
    ...
    var btn = '<span id="'+addbtnId+'" onClick="addDiffdiagField(\''+ident+'\',\'' + type + '\',' + patient + ',' +procedure+','+accession+','+part+','+block+','+slide+')"'+
        'class="input-group-addon btn" data-toggle="datepicker" type="button"><i class="glyphicon glyphicon-plus-sign"></i></span>';
    return btn;
}

function getDelBtn(ident, type, patient, procedure, accession, part, block, slide, collInt) {
    var addbtnId = 'delbtn_patient_'+patient+'_procedure_'+procedure+'_accession_'+accession+'_part_'+part+'_block_'+block+'_slide_'+slide+'_'+ident+'_'+collInt+'_'+ident;
