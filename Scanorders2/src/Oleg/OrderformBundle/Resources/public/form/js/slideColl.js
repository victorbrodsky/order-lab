...
function addDiffdiagField( name, type, patient, procedure, accession, part, block, slide ) {
    ...
    //console.log("partialId="+partialId);
    //inputGroupId_patient_0_procedure_0_accession_0_part_1_block_0_slide_0_diffDisident
    //inputGroupId_patient_0_procedure_0_accession_0_part_0_block_1_slide_0_diffDisident_0_diffDisident
    ...
    if( diffdiagInt == 1 ) {
        //id of the input field: oleg_orderformbundle_orderinfotype_patient_0_procedure_0_accession_0_part_0_diffDisident_4_name
    ...
    //delbtn_patient_0_procedure_0_accession_0_part_0_diffDisident_3_diffDisident
...
function getDiffdiagField( name, type, patient, procedure, accession, part, block, slide, diffdiag, noDelBtn ) {
    ...
    if( name == "diffDisident" ) {
        ...
        newForm = newForm.replace(/__accession__/g, accession);
        newForm = newForm.replace(/__part__/g, part);
        newForm = newForm.replace(/__diffDisident__/g, diffdiag);
    }
...
function delDiffdiagField( name, type, patient, procedure, accession, part, block, slide, diffdiag ) {
    ...
    //delete without asking confirmation if the input field is empty
    //remove id: oleg_orderformbundle_orderinfotype_patient_0_procedure_0_accession_0_part_0_diffDisident_1_name
    //inputGroupId_patient_0_procedure_0_accession_0_part_0_diffDisident_4_diffDisident
    var delId = partialId + diffdiag + '_' + name;
    //console.log("inputGroupId delId="+delId);

    //oleg_orderformbundle_orderinfotype_patient_0_procedure_0_accession_0_part_0_diffDisident_1_name
    var textId = fieldPrefix + "_" + typeuid + name + "_" + diffdiag + "_field";
    var text = $('#'+textId).val();
    ...
    if( remove == true ) {
        ...
        if( $("#"+lastAddBtnId).length > 0 ) {
            ...
            //add + button
            if( diffdiagInt == 1 ) {
                var attToId = fieldPrefix + "_" + typeuid + name + "_" + currFiledCollId + "_field";
            } else {
