...
class appProdProjectContaine_ extends Container
{
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy(1503499315, '%s?%s');
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8QP0oCpfxe', 0, (__DIR__.'/pools'));
    ...
    protected function getDoctrine_Dbal_AperioConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'loadClassMetadata'), ${($_ = isset($this->services['doctrine.orm.aperio_listeners.attach_entity_listeners']) ? $this->services['doctrine.orm.aperio_listeners.attach_entity_listeners'] : $this->get('doctrine.orm.aperio_listeners.attach_entity_listeners')) && false ?: '_'});

        return $this->services['doctrine.dbal.aperio_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_sqlsrv', 'host' => 'c.med.cornell.edu', 'port' => NULL, 'dbname' => 'Aperio', 'user' => 'symfony2_aperio', 'password' => 'Symfony!2', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->addEventSubscriber(${($_ = isset($this->services['fos_user.user_listener']) ? $this->services['fos_user.user_listener'] : $this->getFosUser_UserListenerService()) && false ?: '_'});
        $b->addEventSubscriber($a);
        $b->addEventListener(array(0 => 'postPersist', 1 => 'preUpdate'), ${($_ = isset($this->services['doctrine.listener']) ? $this->services['doctrine.listener'] : $this->get('doctrine.listener')) && false ?: '_'});
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_AperioMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_aperio_47a5ad50a02782b2267d6d5a128c93f6519684efc53c5f11a175e5a7fa40c0db');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_47a5ad50a02782b2267d6d5a128c93f6519684efc53c5f11a175e5a7fa40c0db');
    ...
    {
        $this->services['monolog.handler.file'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'\\logs/prod.log'), 250, true, NULL);
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.aperio_ldap_firewall' => function () {
        ...
        }, 7)), ${($_ = isset($this->services['event_dispatcher']) ? $this->services['event_dispatcher'] : $this->get('event_dispatcher')) && false ?: '_'}, ${($_ = isset($this->services['security.logout_url_generator']) ? $this->services['security.logout_url_generator'] : $this->getSecurity_LogoutUrlGeneratorService()) && false ?: '_'});
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AperioLdapFirewallService()
    {
        ...
        $i = ${($_ = isset($this->services['event_dispatcher']) ? $this->services['event_dispatcher'] : $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'};
    ...
    protected function getTemplatingService()
    {
        ...
        $c = ${($_ = isset($this->services['templating.locator']) ? $this->services['templating.locator'] : $this->getTemplating_LocatorService()) && false ?: '_'};

        $d = new \Symfony\Bundle\TwigBundle\TwigEngine($a, $b, $c);

        $this->services['templating'] = $instance = new \Symfony\Bundle\FrameworkBundle\Templating\DelegatingEngine($this, array());

        $instance->addEngine($d);
        $instance->addEngine($d);
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->get('twig.loader')) && false ?: '_'}, array('form_themes' => array(0 => 'form_div_layout.html.twig'), 'debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pt0vXZrj5J', 0, 'BB+DzNPzhRjcLdElvBOIhv', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('HWwIe0E+ZL', NULL, 'BB+DzNPzhRjcLdElvBOIhv', ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9gzBFltzqi', 0, 'BB+DzNPzhRjcLdElvBOIhv', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.aperio_ldap_firewall'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('599d9433a519d4.68359054');
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.ldap_calllog_firewall'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('599d9433a519d4.68359054');
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.ldap_deidentifier_firewall'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('599d9433a519d4.68359054');
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.ldap_employees_firewall'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('599d9433a519d4.68359054');
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.ldap_fellapp_firewall'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('599d9433a519d4.68359054');
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.ldap_translationalresearch_firewall'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('599d9433a519d4.68359054');
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.ldap_vacreq_firewall'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('599d9433a519d4.68359054');
    }
