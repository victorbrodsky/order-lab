...
namespace Proxies\__CG__\Oleg\CallLogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class PathologyCallComplexPatients extends \Oleg\CallLogBundle\Entity\PathologyCallComplexPatients implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PathologyCallComplexPatients $proxy) {
