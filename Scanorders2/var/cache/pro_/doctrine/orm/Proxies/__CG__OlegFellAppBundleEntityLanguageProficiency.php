 ...
 */
class LanguageProficiency extends \Oleg\FellAppBundle\Entity\LanguageProficiency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LanguageProficiency $proxy) {
