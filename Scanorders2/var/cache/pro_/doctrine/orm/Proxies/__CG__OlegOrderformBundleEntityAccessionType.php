 ...
 */
class AccessionType extends \Oleg\OrderformBundle\Entity\AccessionType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', 'accessionaccession', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccessionType $proxy) {
    ...
    public function addAccessionaccession(\Oleg\OrderformBundle\Entity\AccessionAccession $accessionaccession)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAccessionaccession', [$accessionaccession]);

        return parent::addAccessionaccession($accessionaccession);
    }
    ...
    public function removeAccessionaccession(\Oleg\OrderformBundle\Entity\AccessionAccession $accessionaccession)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAccessionaccession', [$accessionaccession]);

        return parent::removeAccessionaccession($accessionaccession);
    }
    ...
    public function getAccessionaccession()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAccessionaccession', []);

        return parent::getAccessionaccession();
    }
