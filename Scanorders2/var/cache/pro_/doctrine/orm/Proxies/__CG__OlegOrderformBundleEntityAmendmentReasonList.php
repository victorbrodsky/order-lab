 ...
 */
class AmendmentReasonList extends \Oleg\OrderformBundle\Entity\AmendmentReasonList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AmendmentReasonList $proxy) {
