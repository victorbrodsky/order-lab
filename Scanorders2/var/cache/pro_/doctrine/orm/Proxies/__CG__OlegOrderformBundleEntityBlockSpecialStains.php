 ...
 */
class BlockSpecialStains extends \Oleg\OrderformBundle\Entity\BlockSpecialStains implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'block', 'field', 'staintype', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BlockSpecialStains $proxy) {
    ...
    public function setStaintype($staintype)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStaintype', [$staintype]);

        return parent::setStaintype($staintype);
    }
    ...
    public function getStaintype()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStaintype', []);

        return parent::getStaintype();
    }
