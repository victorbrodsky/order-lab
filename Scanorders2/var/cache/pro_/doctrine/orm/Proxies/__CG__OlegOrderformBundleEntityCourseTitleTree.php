 ...
 */
class CourseTitleTree extends \Oleg\OrderformBundle\Entity\CourseTitleTree implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'parent', 'children', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\CourseTitleTree' . "\0" . 'organizationalGroupType', 'synonyms', 'original', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\CourseTitleTree' . "\0" . 'educationals', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\CourseTitleTree' . "\0" . 'userWrappers', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CourseTitleTree $proxy) {
    ...
    public function getEducationals()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEducationals', []);

        return parent::getEducationals();
    }
    ...
    public function addEducational($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEducational', [$item]);

        return parent::addEducational($item);
    }
    ...
    public function removeEducational($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeEducational', [$item]);

        return parent::removeEducational($item);
    }
