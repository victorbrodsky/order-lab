 ...
 */
class EncounterInfoType extends \Oleg\OrderformBundle\Entity\EncounterInfoType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterInfoType $proxy) {
