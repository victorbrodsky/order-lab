 ...
 */
class EncounterInpatientinfo extends \Oleg\OrderformBundle\Entity\EncounterInpatientinfo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'encounter', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\EncounterInpatientinfo' . "\0" . 'admissiondate', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\EncounterInpatientinfo' . "\0" . 'admissiontime', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\EncounterInpatientinfo' . "\0" . 'admissiondiagnosis', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\EncounterInpatientinfo' . "\0" . 'dischargedate', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\EncounterInpatientinfo' . "\0" . 'dischargetime', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\EncounterInpatientinfo' . "\0" . 'dischargediagnosis', 'field', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterInpatientinfo $proxy) {
    ...
    public function setAdmissiondiagnosis($admissiondiagnosis)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdmissiondiagnosis', [$admissiondiagnosis]);

        return parent::setAdmissiondiagnosis($admissiondiagnosis);
    }
    ...
    public function getAdmissiondiagnosis()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdmissiondiagnosis', []);

        return parent::getAdmissiondiagnosis();
    }
    ...
    public function setAdmissiontime($admissiontime)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdmissiontime', [$admissiontime]);

        return parent::setAdmissiontime($admissiontime);
    }
    ...
    public function getAdmissiontime()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdmissiontime', []);

        return parent::getAdmissiontime();
    }
    ...
    public function setDischargediagnosis($dischargediagnosis)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDischargediagnosis', [$dischargediagnosis]);

        return parent::setDischargediagnosis($dischargediagnosis);
    }
    ...
    public function getDischargediagnosis()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDischargediagnosis', []);

        return parent::getDischargediagnosis();
    }
    ...
    public function setDischargetime($dischargetime)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDischargetime', [$dischargetime]);

        return parent::setDischargetime($dischargetime);
    }
    ...
    public function getDischargetime()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDischargetime', []);

        return parent::getDischargetime();
    }
