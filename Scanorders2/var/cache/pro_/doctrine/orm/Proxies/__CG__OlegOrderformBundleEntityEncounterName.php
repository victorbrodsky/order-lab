 ...
 */
class EncounterName extends \Oleg\OrderformBundle\Entity\EncounterName implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterName $proxy) {
