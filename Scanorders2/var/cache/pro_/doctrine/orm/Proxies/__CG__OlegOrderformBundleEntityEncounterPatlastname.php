 ...
 */
class EncounterPatlastname extends \Oleg\OrderformBundle\Entity\EncounterPatlastname implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'encounter', 'field', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\EncounterPatlastname' . "\0" . 'alias', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterPatlastname $proxy) {
