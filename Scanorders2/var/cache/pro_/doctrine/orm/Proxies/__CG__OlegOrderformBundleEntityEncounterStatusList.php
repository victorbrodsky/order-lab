 ...
 */
class EncounterStatusList extends \Oleg\OrderformBundle\Entity\EncounterStatusList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterStatusList $proxy) {
