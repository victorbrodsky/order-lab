 ...
 */
class ImageAnalysisAlgorithmList extends \Oleg\OrderformBundle\Entity\ImageAnalysisAlgorithmList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImageAnalysisAlgorithmList $proxy) {
