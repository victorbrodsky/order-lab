 ...
 */
class PartPartname extends \Oleg\OrderformBundle\Entity\PartPartname implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PartPartname $proxy) {
