 ...
 */
class PartParttitle extends \Oleg\OrderformBundle\Entity\PartParttitle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PartParttitle $proxy) {
