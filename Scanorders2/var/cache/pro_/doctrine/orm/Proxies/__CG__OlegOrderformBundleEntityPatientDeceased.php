 ...
 */
class PatientDeceased extends \Oleg\OrderformBundle\Entity\PatientDeceased implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'patient', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\PatientDeceased' . "\0" . 'deceased', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\PatientDeceased' . "\0" . 'deathdate', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\PatientDeceased' . "\0" . 'deathtime', 'field', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PatientDeceased $proxy) {
    ...
    public function setDeathtime($deathtime)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeathtime', [$deathtime]);

        return parent::setDeathtime($deathtime);
    }
    ...
    public function getDeathtime()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDeathtime', []);

        return parent::getDeathtime();
    }
    ...
    public function setDeceased($deceased)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeceased', [$deceased]);

        return parent::setDeceased($deceased);
    }
