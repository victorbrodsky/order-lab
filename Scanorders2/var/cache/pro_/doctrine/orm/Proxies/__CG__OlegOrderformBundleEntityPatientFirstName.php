 ...
 */
class PatientFirstName extends \Oleg\OrderformBundle\Entity\PatientFirstName implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PatientFirstName $proxy) {
