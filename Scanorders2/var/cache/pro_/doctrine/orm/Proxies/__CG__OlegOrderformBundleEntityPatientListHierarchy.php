 ...
 */
class PatientListHierarchy extends \Oleg\OrderformBundle\Entity\PatientListHierarchy implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'parent', 'children', 'synonyms', 'original', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\PatientListHierarchy' . "\0" . 'organizationalGroupType', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\PatientListHierarchy' . "\0" . 'calllogEntryMessages', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\PatientListHierarchy' . "\0" . 'patient', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PatientListHierarchy $proxy) {
    ...
    public function addCalllogEntryMessage($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCalllogEntryMessage', [$item]);

        return parent::addCalllogEntryMessage($item);
    }
    ...
    public function removeCalllogEntryMessage($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCalllogEntryMessage', [$item]);

        return parent::removeCalllogEntryMessage($item);
    }
    ...
    public function getCalllogEntryMessages()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCalllogEntryMessages', []);

        return parent::getCalllogEntryMessages();
    }
