 ...
 */
class PatientMrn extends \Oleg\OrderformBundle\Entity\PatientMrn implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'patient', 'field', 'original', 'keytype', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PatientMrn $proxy) {
    ...
    public function obtainOptimalName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'obtainOptimalName', []);

        return parent::obtainOptimalName();
    }
    ...
    public function obtainExtraKey()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'obtainExtraKey', []);

        return parent::obtainExtraKey();
    }
    ...
    public function setExtra($extraEntity)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setExtra', [$extraEntity]);

        return parent::setExtra($extraEntity);
    }
