 ...
 */
class PatientSuffix extends \Oleg\OrderformBundle\Entity\PatientSuffix implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PatientSuffix $proxy) {
