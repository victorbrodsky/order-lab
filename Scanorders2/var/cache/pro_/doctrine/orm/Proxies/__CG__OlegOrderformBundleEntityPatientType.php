 ...
 */
class PatientType extends \Oleg\OrderformBundle\Entity\PatientType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'patient', 'field', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\PatientType' . "\0" . 'sources', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PatientType $proxy) {
