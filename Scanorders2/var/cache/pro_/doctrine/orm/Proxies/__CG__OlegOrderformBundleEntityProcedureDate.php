 ...
 */
class ProcedureDate extends \Oleg\OrderformBundle\Entity\ProcedureDate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'procedure', 'field', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\ProcedureDate' . "\0" . 'time', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProcedureDate $proxy) {
