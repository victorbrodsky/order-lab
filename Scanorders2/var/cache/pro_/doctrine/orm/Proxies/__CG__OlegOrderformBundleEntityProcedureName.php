 ...
 */
class ProcedureName extends \Oleg\OrderformBundle\Entity\ProcedureName implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProcedureName $proxy) {
