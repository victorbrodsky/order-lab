 ...
 */
class ProcessorComments extends \Oleg\OrderformBundle\Entity\ProcessorComments implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProcessorComments $proxy) {
