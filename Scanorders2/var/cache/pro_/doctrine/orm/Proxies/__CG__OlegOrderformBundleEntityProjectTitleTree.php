 ...
 */
class ProjectTitleTree extends \Oleg\OrderformBundle\Entity\ProjectTitleTree implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'parent', 'children', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\ProjectTitleTree' . "\0" . 'organizationalGroupType', 'synonyms', 'original', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\ProjectTitleTree' . "\0" . 'researches', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\ProjectTitleTree' . "\0" . 'userWrappers', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectTitleTree $proxy) {
    ...
    public function addResearch($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addResearch', [$item]);

        return parent::addResearch($item);
    }
    ...
    public function removeResearch($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeResearch', [$item]);

        return parent::removeResearch($item);
    }
