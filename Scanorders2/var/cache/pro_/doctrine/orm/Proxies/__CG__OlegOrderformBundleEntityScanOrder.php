 ...
 */
class ScanOrder extends \Oleg\OrderformBundle\Entity\ScanOrder implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'message', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\ScanOrder' . "\0" . 'scanOrderInstitutionScope', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\ScanOrder' . "\0" . 'delivery', 'id', 'instruction', 'processedDate', 'processedByUser'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ScanOrder $proxy) {
    ...
    public function setScanOrderInstitutionScope($scanOrderInstitutionScope)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setScanOrderInstitutionScope', [$scanOrderInstitutionScope]);

        return parent::setScanOrderInstitutionScope($scanOrderInstitutionScope);
    }
