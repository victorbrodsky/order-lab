 ...
 */
class Stain extends \Oleg\OrderformBundle\Entity\Stain implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'slide', 'field', 'stainer', 'date', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Stain $proxy) {
    ...
    public function setStainer($stainer)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStainer', [$stainer]);

        return parent::setStainer($stainer);
    }
    ...
    public function getStainer()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStainer', []);

        return parent::getStainer();
    }
