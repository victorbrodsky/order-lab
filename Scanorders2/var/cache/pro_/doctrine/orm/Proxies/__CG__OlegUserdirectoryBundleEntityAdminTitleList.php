 ...
 */
class AdminTitleList extends \Oleg\UserdirectoryBundle\Entity\AdminTitleList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdminTitleList $proxy) {
