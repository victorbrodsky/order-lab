 ...
 */
class AdministrativeTitle extends \Oleg\UserdirectoryBundle\Entity\AdministrativeTitle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'user', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\AdministrativeTitle' . "\0" . 'boss', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\AdministrativeTitle' . "\0" . 'userPositions', 'institution', 'priority', 'startDate', 'endDate', 'effort', 'pgystart', 'pgylevel', 'id', 'author', 'updateAuthor', 'updateAuthorRoles', 'type', 'status', 'createdate', 'updatedate', 'orderinlist'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdministrativeTitle $proxy) {
    ...
    public function addBoss($boss)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBoss', [$boss]);

        return parent::addBoss($boss);
    }
    ...
    public function addBos($boss)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBos', [$boss]);

        return parent::addBos($boss);
    }
    ...
    public function removeBoss($boss)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBoss', [$boss]);

        return parent::removeBoss($boss);
    }
    ...
    public function removeBos($boss)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBos', [$boss]);

        return parent::removeBos($boss);
    }
    ...
    public function getBoss()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBoss', []);

        return parent::getBoss();
    }
