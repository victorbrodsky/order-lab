 ...
 */
class BoardCertifiedSpecialties extends \Oleg\UserdirectoryBundle\Entity\BoardCertifiedSpecialties implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BoardCertifiedSpecialties $proxy) {
