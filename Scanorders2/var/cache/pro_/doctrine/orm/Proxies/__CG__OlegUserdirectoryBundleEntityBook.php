 ...
 */
class Book extends \Oleg\UserdirectoryBundle\Entity\Book implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Book' . "\0" . 'users', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Book' . "\0" . 'citation', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Book' . "\0" . 'isbn', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Book' . "\0" . 'link', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Book' . "\0" . 'publicationDate', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Book' . "\0" . 'comment', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Book' . "\0" . 'authorshipRole', 'id', 'author', 'updateAuthor', 'updateAuthorRoles', 'type', 'status', 'createdate', 'updatedate', 'orderinlist'];
        }
    ...
    public function setAuthorshipRole($authorshipRole)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAuthorshipRole', [$authorshipRole]);

        return parent::setAuthorshipRole($authorshipRole);
    }
    ...
    public function getAuthorshipRole()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAuthorshipRole', []);

        return parent::getAuthorshipRole();
    }
