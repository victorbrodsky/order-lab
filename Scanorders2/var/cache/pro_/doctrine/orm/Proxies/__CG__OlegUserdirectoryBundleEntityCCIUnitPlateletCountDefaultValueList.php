 ...
 */
class CCIUnitPlateletCountDefaultValueList extends \Oleg\UserdirectoryBundle\Entity\CCIUnitPlateletCountDefaultValueList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CCIUnitPlateletCountDefaultValueList $proxy) {
