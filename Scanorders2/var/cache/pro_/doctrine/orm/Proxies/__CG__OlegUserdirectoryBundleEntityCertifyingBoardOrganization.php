 ...
 */
class CertifyingBoardOrganization extends \Oleg\UserdirectoryBundle\Entity\CertifyingBoardOrganization implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CertifyingBoardOrganization $proxy) {
