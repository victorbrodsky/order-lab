 ...
 */
class CodeNYPH extends \Oleg\UserdirectoryBundle\Entity\CodeNYPH implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\CodeNYPH' . "\0" . 'id', 'field', 'startDate', 'endDate', 'credentials'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CodeNYPH $proxy) {
