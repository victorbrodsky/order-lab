 ...
 */
class CommentTypeList extends \Oleg\UserdirectoryBundle\Entity\CommentTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', 'parent', 'children', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\CommentTypeList' . "\0" . 'organizationalGroupType', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CommentTypeList $proxy) {
