 ...
 */
class EmploymentTerminationType extends \Oleg\UserdirectoryBundle\Entity\EmploymentTerminationType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmploymentTerminationType $proxy) {
