 ...
 */
class FellowshipTitleList extends \Oleg\UserdirectoryBundle\Entity\FellowshipTitleList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FellowshipTitleList $proxy) {
