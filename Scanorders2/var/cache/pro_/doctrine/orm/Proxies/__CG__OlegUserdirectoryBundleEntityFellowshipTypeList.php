 ...
 */
class FellowshipTypeList extends \Oleg\UserdirectoryBundle\Entity\FellowshipTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FellowshipTypeList $proxy) {
