 ...
 */
class GeneralEntity extends \Oleg\UserdirectoryBundle\Entity\GeneralEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\GeneralEntity' . "\0" . 'id', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\GeneralEntity' . "\0" . 'entityNamespace', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\GeneralEntity' . "\0" . 'entityName', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\GeneralEntity' . "\0" . 'entityId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GeneralEntity $proxy) {
