 ...
 */
class LabResultFlagList extends \Oleg\UserdirectoryBundle\Entity\LabResultFlagList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LabResultFlagList $proxy) {
