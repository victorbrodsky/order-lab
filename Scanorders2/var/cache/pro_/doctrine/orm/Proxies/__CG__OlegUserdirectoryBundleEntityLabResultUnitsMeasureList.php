 ...
 */
class LabResultUnitsMeasureList extends \Oleg\UserdirectoryBundle\Entity\LabResultUnitsMeasureList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LabResultUnitsMeasureList $proxy) {
