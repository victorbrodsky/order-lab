 ...
 */
class LanguageList extends \Oleg\UserdirectoryBundle\Entity\LanguageList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', 'userpreferences', 'nativeName', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LanguageList $proxy) {
    ...
    public function addUserpreference($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addUserpreference', [$item]);

        return parent::addUserpreference($item);
    }
    ...
    public function removeUserpreference($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeUserpreference', [$item]);

        return parent::removeUserpreference($item);
    }
