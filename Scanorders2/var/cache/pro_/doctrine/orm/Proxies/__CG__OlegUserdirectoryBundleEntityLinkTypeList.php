 ...
 */
class LinkTypeList extends \Oleg\UserdirectoryBundle\Entity\LinkTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LinkTypeList $proxy) {
