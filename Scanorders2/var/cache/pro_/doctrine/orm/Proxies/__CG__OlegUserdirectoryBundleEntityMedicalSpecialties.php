 ...
 */
class MedicalSpecialties extends \Oleg\UserdirectoryBundle\Entity\MedicalSpecialties implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MedicalSpecialties $proxy) {
