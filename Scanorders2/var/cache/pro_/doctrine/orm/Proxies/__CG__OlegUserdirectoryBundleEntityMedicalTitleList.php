 ...
 */
class MedicalTitleList extends \Oleg\UserdirectoryBundle\Entity\MedicalTitleList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MedicalTitleList $proxy) {
