 ...
 */
class ObjectTypeCheckbox extends \Oleg\UserdirectoryBundle\Entity\ObjectTypeCheckbox implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ObjectTypeCheckbox $proxy) {
