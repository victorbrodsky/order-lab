 ...
 */
class PathologyResultSignatoriesList extends \Oleg\UserdirectoryBundle\Entity\PathologyResultSignatoriesList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PathologyResultSignatoriesList $proxy) {
    ...
    public function getUserWrapper()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserWrapper', []);

        return parent::getUserWrapper();
    }
    ...
    public function setUserWrapper($userWrapper)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserWrapper', [$userWrapper]);

        return parent::setUserWrapper($userWrapper);
    }
