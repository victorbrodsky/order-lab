 ...
 */
class PermissionActionList extends \Oleg\UserdirectoryBundle\Entity\PermissionActionList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PermissionActionList $proxy) {
