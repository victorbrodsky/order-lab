 ...
 */
class PermissionList extends \Oleg\UserdirectoryBundle\Entity\PermissionList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\PermissionList' . "\0" . 'permissionObjectList', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\PermissionList' . "\0" . 'permissionActionList', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PermissionList $proxy) {
    ...
    public function setPermissionActionList($permissionActionList)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPermissionActionList', [$permissionActionList]);

        return parent::setPermissionActionList($permissionActionList);
    }
    ...
    public function getPermissionActionList()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPermissionActionList', []);

        return parent::getPermissionActionList();
    }
    ...
    public function setPermissionObjectList($permissionObjectList)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPermissionObjectList', [$permissionObjectList]);

        return parent::setPermissionObjectList($permissionObjectList);
    }
    ...
    public function getPermissionObjectList()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPermissionObjectList', []);

        return parent::getPermissionObjectList();
    }
