 ...
 */
class PlateletTransfusionProductReceivingList extends \Oleg\UserdirectoryBundle\Entity\PlateletTransfusionProductReceivingList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PlateletTransfusionProductReceivingList $proxy) {
