 ...
 */
class PrivateComment extends \Oleg\UserdirectoryBundle\Entity\PrivateComment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PrivateComment $proxy) {
