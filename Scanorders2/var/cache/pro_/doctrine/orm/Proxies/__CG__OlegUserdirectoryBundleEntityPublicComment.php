 ...
 */
class PublicComment extends \Oleg\UserdirectoryBundle\Entity\PublicComment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PublicComment $proxy) {
