 ...
 */
class ResidencySpecialty extends \Oleg\UserdirectoryBundle\Entity\ResidencySpecialty implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\ResidencySpecialty' . "\0" . 'children', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\ResidencySpecialty' . "\0" . 'boardCertificateAvailable', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResidencySpecialty $proxy) {
    ...
    public function addFellowshipSubspecialty($child)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addFellowshipSubspecialty', [$child]);

        return parent::addFellowshipSubspecialty($child);
    }
    ...
    public function removeFellowshipSubspecialty($child)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeFellowshipSubspecialty', [$child]);

        return parent::removeFellowshipSubspecialty($child);
    }
    ...
    public function getTreeName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTreeName', []);
