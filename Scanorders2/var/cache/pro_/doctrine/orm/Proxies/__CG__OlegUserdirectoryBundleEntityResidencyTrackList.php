 ...
 */
class ResidencyTrackList extends \Oleg\UserdirectoryBundle\Entity\ResidencyTrackList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResidencyTrackList $proxy) {
