 ...
 */
class RoleAttributeList extends \Oleg\UserdirectoryBundle\Entity\RoleAttributeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\RoleAttributeList' . "\0" . 'value', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\RoleAttributeList' . "\0" . 'roles', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RoleAttributeList $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addRole(\Oleg\UserdirectoryBundle\Entity\Roles $role)
    {
     ...
     * {@inheritDoc}
     */
    public function removeRole(\Oleg\UserdirectoryBundle\Entity\Roles $role)
    {
