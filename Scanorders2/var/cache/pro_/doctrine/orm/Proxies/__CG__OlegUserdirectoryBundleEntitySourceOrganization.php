 ...
 */
class SourceOrganization extends \Oleg\UserdirectoryBundle\Entity\SourceOrganization implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SourceOrganization $proxy) {
