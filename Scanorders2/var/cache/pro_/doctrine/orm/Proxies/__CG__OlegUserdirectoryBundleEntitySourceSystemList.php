 ...
 */
class SourceSystemList extends \Oleg\UserdirectoryBundle\Entity\SourceSystemList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SourceSystemList $proxy) {
