 ...
 */
class SuiteList extends \Oleg\UserdirectoryBundle\Entity\SuiteList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\SuiteList' . "\0" . 'rooms', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\SuiteList' . "\0" . 'floors', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\SuiteList' . "\0" . 'buildings', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SuiteList $proxy) {
