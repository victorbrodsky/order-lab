 ...
 */
class TitlePositionType extends \Oleg\UserdirectoryBundle\Entity\TitlePositionType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TitlePositionType $proxy) {
