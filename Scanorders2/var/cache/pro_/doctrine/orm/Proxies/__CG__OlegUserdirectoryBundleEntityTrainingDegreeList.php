 ...
 */
class TrainingDegreeList extends \Oleg\UserdirectoryBundle\Entity\TrainingDegreeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrainingDegreeList $proxy) {
