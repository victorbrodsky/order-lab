 ...
 */
class TransfusionAntibodyScreenResultsList extends \Oleg\UserdirectoryBundle\Entity\TransfusionAntibodyScreenResultsList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransfusionAntibodyScreenResultsList $proxy) {
