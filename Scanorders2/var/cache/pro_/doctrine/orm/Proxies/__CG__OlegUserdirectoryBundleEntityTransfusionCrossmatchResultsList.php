 ...
 */
class TransfusionCrossmatchResultsList extends \Oleg\UserdirectoryBundle\Entity\TransfusionCrossmatchResultsList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransfusionCrossmatchResultsList $proxy) {
