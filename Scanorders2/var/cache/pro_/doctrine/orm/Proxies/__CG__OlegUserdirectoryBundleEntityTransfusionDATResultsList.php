 ...
 */
class TransfusionDATResultsList extends \Oleg\UserdirectoryBundle\Entity\TransfusionDATResultsList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransfusionDATResultsList $proxy) {
