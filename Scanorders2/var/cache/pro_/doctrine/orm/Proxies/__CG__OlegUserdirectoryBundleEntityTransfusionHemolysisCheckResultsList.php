 ...
 */
class TransfusionHemolysisCheckResultsList extends \Oleg\UserdirectoryBundle\Entity\TransfusionHemolysisCheckResultsList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransfusionHemolysisCheckResultsList $proxy) {
