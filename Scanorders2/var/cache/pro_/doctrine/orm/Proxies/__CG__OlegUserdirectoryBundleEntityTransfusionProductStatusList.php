 ...
 */
class TransfusionProductStatusList extends \Oleg\UserdirectoryBundle\Entity\TransfusionProductStatusList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransfusionProductStatusList $proxy) {
