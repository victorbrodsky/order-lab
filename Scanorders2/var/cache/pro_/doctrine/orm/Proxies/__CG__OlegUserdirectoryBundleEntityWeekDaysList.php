 ...
 */
class WeekDaysList extends \Oleg\UserdirectoryBundle\Entity\WeekDaysList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WeekDaysList $proxy) {
