 ...
 */
class DataFile extends \Oleg\FellAppBundle\Entity\DataFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Oleg\\FellAppBundle\\Entity\\DataFile' . "\0" . 'id', '' . "\0" . 'Oleg\\FellAppBundle\\Entity\\DataFile' . "\0" . 'creationdate', '' . "\0" . 'Oleg\\FellAppBundle\\Entity\\DataFile' . "\0" . 'updatedate', '' . "\0" . 'Oleg\\FellAppBundle\\Entity\\DataFile' . "\0" . 'status', '' . "\0" . 'Oleg\\FellAppBundle\\Entity\\DataFile' . "\0" . 'document', '' . "\0" . 'Oleg\\FellAppBundle\\Entity\\DataFile' . "\0" . 'fellapp'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DataFile $proxy) {
