...
class Accession extends \Oleg\OrderformBundle\Entity\Accession implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'accession', 'accessionDate', 'procedure', 'part', 'message', 'id', 'status', 'creationdate', 'provider', 'source', 'institution', 'attachmentContainer', 'tracker', 'changeObjectArr', 'tempSource', 'tempUser'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Accession $proxy) {
    ...
    public function clearPart()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'clearPart', []);

        return parent::clearPart();
    }
    ...
    public function setAccessionDate($accessionDate)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAccessionDate', [$accessionDate]);

        return parent::setAccessionDate($accessionDate);
    }
    ...
    public function getAccessionDate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAccessionDate', []);

        return parent::getAccessionDate();
    }
    ...
    public function addAccessionDate($accessionDate)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAccessionDate', [$accessionDate]);

        return parent::addAccessionDate($accessionDate);
    }
    ...
    public function removeAccessionDate($accessionDate)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAccessionDate', [$accessionDate]);

        return parent::removeAccessionDate($accessionDate);
    }
