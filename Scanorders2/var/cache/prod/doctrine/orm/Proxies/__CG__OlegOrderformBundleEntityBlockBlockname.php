 ...
 */
class BlockBlockname extends \Oleg\OrderformBundle\Entity\BlockBlockname implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BlockBlockname $proxy) {
