 ...
 */
class DiseaseOriginList extends \Oleg\OrderformBundle\Entity\DiseaseOriginList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DiseaseOriginList $proxy) {
