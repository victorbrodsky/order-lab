 ...
 */
class DiseaseTypeList extends \Oleg\OrderformBundle\Entity\DiseaseTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DiseaseTypeList $proxy) {
