 ...
 */
class EncounterDate extends \Oleg\OrderformBundle\Entity\EncounterDate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'encounter', 'field', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\EncounterDate' . "\0" . 'time', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\EncounterDate' . "\0" . 'timezone', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterDate $proxy) {
