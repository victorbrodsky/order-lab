 ...
 */
class EncounterInfoTypeList extends \Oleg\OrderformBundle\Entity\EncounterInfoTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterInfoTypeList $proxy) {
