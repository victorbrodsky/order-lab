 ...
 */
class EncounterPatage extends \Oleg\OrderformBundle\Entity\EncounterPatage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterPatage $proxy) {
