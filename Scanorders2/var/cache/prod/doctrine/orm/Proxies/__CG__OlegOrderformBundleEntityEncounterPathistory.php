 ...
 */
class EncounterPathistory extends \Oleg\OrderformBundle\Entity\EncounterPathistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterPathistory $proxy) {
