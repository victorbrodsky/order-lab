 ...
 */
class EncounterPatmiddlename extends \Oleg\OrderformBundle\Entity\EncounterPatmiddlename implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'encounter', 'field', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\EncounterPatmiddlename' . "\0" . 'alias', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterPatmiddlename $proxy) {
