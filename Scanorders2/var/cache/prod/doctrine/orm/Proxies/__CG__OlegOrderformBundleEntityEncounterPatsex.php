 ...
 */
class EncounterPatsex extends \Oleg\OrderformBundle\Entity\EncounterPatsex implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EncounterPatsex $proxy) {
