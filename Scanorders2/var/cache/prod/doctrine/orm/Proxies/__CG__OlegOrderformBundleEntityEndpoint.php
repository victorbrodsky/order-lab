 ...
 */
class Endpoint extends \Oleg\OrderformBundle\Entity\Endpoint implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\Endpoint' . "\0" . 'id', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\Endpoint' . "\0" . 'system', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\Endpoint' . "\0" . 'location', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\Endpoint' . "\0" . 'comment'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Endpoint $proxy) {
