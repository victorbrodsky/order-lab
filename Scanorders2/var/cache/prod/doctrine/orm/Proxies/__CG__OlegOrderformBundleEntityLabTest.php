 ...
 */
class LabTest extends \Oleg\OrderformBundle\Entity\LabTest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\LabTest' . "\0" . 'labTestType', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\LabTest' . "\0" . 'labTestId', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LabTest $proxy) {
    ...
    public function setLabTestId($labTestId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLabTestId', [$labTestId]);

        return parent::setLabTestId($labTestId);
    }
    ...
    public function getLabTestId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLabTestId', []);

        return parent::getLabTestId();
    }
    ...
    public function setLabTestType($labTestType)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLabTestType', [$labTestType]);

        return parent::setLabTestType($labTestType);
    }
    ...
    public function getLabTestType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLabTestType', []);

        return parent::getLabTestType();
    }
