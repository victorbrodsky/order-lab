 ...
 */
class MessageCategory extends \Oleg\OrderformBundle\Entity\MessageCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'parent', 'children', 'synonyms', 'original', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\MessageCategory' . "\0" . 'organizationalGroupType', '' . "\0" . 'Oleg\\OrderformBundle\\Entity\\MessageCategory' . "\0" . 'formNodes', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageCategory $proxy) {
    ...
    public function getFormNodes()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFormNodes', []);

        return parent::getFormNodes();
    }
    ...
    public function addFormNode($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addFormNode', [$item]);

        return parent::addFormNode($item);
    }
    ...
    public function removeFormNode($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeFormNode', [$item]);

        return parent::removeFormNode($item);
    }
    ...
    public function clearFormNodes()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'clearFormNodes', []);

        return parent::clearFormNodes();
    }
    ...
    public function getNodeNameWithParents($separator = ': ', $untilParentName = 'Pathology Call Log Entry')
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNodeNameWithParents', [$separator, $untilParentName]);

        return parent::getNodeNameWithParents($separator, $untilParentName);
    }
    ...
    public function printTreeSelectListIncludingThis($asLabelValue = true)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'printTreeSelectListIncludingThis', [$asLabelValue]);

        return parent::printTreeSelectListIncludingThis($asLabelValue);
    }
    ...
    public function getNodeNameWithParentsUntilThisParent()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNodeNameWithParentsUntilThisParent', []);

        return parent::getNodeNameWithParentsUntilThisParent();
    }
