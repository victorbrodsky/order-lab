 ...
 */
class MessageStatusList extends \Oleg\OrderformBundle\Entity\MessageStatusList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageStatusList $proxy) {
