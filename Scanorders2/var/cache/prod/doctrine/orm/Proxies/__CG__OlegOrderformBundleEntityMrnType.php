 ...
 */
class MrnType extends \Oleg\OrderformBundle\Entity\MrnType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', 'patientmrn', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MrnType $proxy) {
    ...
    public function addPatientmrn(\Oleg\OrderformBundle\Entity\PatientMrn $patientmrn)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPatientmrn', [$patientmrn]);

        return parent::addPatientmrn($patientmrn);
    }
    ...
    public function removePatientmrn(\Oleg\OrderformBundle\Entity\PatientMrn $patientmrn)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePatientmrn', [$patientmrn]);

        return parent::removePatientmrn($patientmrn);
    }
    ...
    public function getPatientmrn()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPatientmrn', []);

        return parent::getPatientmrn();
    }
