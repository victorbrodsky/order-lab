 ...
 */
class PartDescription extends \Oleg\OrderformBundle\Entity\PartDescription implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PartDescription $proxy) {
