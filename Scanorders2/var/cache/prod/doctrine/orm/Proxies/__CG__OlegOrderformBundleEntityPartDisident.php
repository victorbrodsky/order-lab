 ...
 */
class PartDisident extends \Oleg\OrderformBundle\Entity\PartDisident implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PartDisident $proxy) {
