 ...
 */
class ParttitleList extends \Oleg\OrderformBundle\Entity\ParttitleList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', 'part', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ParttitleList $proxy) {
    ...
    public function addPart($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPart', [$item]);

        return parent::addPart($item);
    }
    ...
    public function removePart($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePart', [$item]);

        return parent::removePart($item);
    }
