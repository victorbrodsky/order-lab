 ...
 */
class PatientClinicalHistory extends \Oleg\OrderformBundle\Entity\PatientClinicalHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PatientClinicalHistory $proxy) {
