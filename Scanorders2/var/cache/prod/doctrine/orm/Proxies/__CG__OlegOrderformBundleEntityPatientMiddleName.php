 ...
 */
class PatientMiddleName extends \Oleg\OrderformBundle\Entity\PatientMiddleName implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'patient', 'field', 'fieldMetaphone', 'id', 'provider', 'status', 'source', 'creationdate', 'message', 'updateDate', 'updateSource', 'updateAuthor', 'dqeventlog', 'changeFieldArr'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PatientMiddleName $proxy) {
    ...
    public function getFieldMetaphone()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFieldMetaphone', []);

        return parent::getFieldMetaphone();
    }
    ...
    public function setFieldMetaphone($fieldMetaphone)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFieldMetaphone', [$fieldMetaphone]);

        return parent::setFieldMetaphone($fieldMetaphone);
    }
