 ...
 */
class PatientRecordStatusList extends \Oleg\OrderformBundle\Entity\PatientRecordStatusList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PatientRecordStatusList $proxy) {
