 ...
 */
class RegionToScan extends \Oleg\OrderformBundle\Entity\RegionToScan implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegionToScan $proxy) {
