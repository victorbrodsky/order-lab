 ...
 */
class SuggestedMessageCategoriesList extends \Oleg\OrderformBundle\Entity\SuggestedMessageCategoriesList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SuggestedMessageCategoriesList $proxy) {
