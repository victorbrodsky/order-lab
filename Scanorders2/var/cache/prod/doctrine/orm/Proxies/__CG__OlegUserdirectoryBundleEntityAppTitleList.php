 ...
 */
class AppTitleList extends \Oleg\UserdirectoryBundle\Entity\AppTitleList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AppTitleList $proxy) {
