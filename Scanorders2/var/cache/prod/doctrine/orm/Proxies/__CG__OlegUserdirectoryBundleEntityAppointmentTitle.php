 ...
 */
class AppointmentTitle extends \Oleg\UserdirectoryBundle\Entity\AppointmentTitle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'user', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\AppointmentTitle' . "\0" . 'positions', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\AppointmentTitle' . "\0" . 'residencyTrack', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\AppointmentTitle' . "\0" . 'fellowshipType', 'priority', 'startDate', 'endDate', 'effort', 'institution', 'pgystart', 'pgylevel', 'id', 'author', 'updateAuthor', 'updateAuthorRoles', 'type', 'status', 'createdate', 'updatedate', 'orderinlist'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AppointmentTitle $proxy) {
    ...
    public function setFellowshipType($fellowshipType)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFellowshipType', [$fellowshipType]);

        return parent::setFellowshipType($fellowshipType);
    }
    ...
    public function getFellowshipType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFellowshipType', []);

        return parent::getFellowshipType();
    }
    ...
    public function setResidencyTrack($residencyTrack)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setResidencyTrack', [$residencyTrack]);

        return parent::setResidencyTrack($residencyTrack);
    }
    ...
    public function getResidencyTrack()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getResidencyTrack', []);

        return parent::getResidencyTrack();
    }
    ...
    public function addPosition($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPosition', [$item]);

        return parent::addPosition($item);
    }
    ...
    public function removePosition($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePosition', [$item]);

        return parent::removePosition($item);
    }
