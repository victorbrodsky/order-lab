 ...
 */
class BloodTypeList extends \Oleg\UserdirectoryBundle\Entity\BloodTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BloodTypeList $proxy) {
