 ...
 */
class CCIPlateletTypeTransfusedList extends \Oleg\UserdirectoryBundle\Entity\CCIPlateletTypeTransfusedList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CCIPlateletTypeTransfusedList $proxy) {
