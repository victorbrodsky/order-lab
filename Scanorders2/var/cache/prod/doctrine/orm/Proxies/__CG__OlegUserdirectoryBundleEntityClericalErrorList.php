 ...
 */
class ClericalErrorList extends \Oleg\UserdirectoryBundle\Entity\ClericalErrorList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClericalErrorList $proxy) {
