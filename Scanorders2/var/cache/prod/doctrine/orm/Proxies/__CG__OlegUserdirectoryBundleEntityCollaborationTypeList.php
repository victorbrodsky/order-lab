 ...
 */
class CollaborationTypeList extends \Oleg\UserdirectoryBundle\Entity\CollaborationTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CollaborationTypeList $proxy) {
