 ...
 */
class CompletionReasonList extends \Oleg\UserdirectoryBundle\Entity\CompletionReasonList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompletionReasonList $proxy) {
