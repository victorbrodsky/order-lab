 ...
 */
class ComplexPlateletSummaryAntibodiesList extends \Oleg\UserdirectoryBundle\Entity\ComplexPlateletSummaryAntibodiesList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ComplexPlateletSummaryAntibodiesList $proxy) {
