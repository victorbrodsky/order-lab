 ...
 */
class DocumentComment extends \Oleg\UserdirectoryBundle\Entity\DocumentComment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\DocumentComment' . "\0" . 'documentContainer', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\DocumentComment' . "\0" . 'comment', 'id', 'author', 'updateAuthor', 'updateAuthorRoles', 'type', 'status', 'createdate', 'updatedate', 'orderinlist'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DocumentComment $proxy) {
