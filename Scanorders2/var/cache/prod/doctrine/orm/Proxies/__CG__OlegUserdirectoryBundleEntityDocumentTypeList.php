 ...
 */
class DocumentTypeList extends \Oleg\UserdirectoryBundle\Entity\DocumentTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DocumentTypeList $proxy) {
