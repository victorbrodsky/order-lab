 ...
 */
class EmploymentType extends \Oleg\UserdirectoryBundle\Entity\EmploymentType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmploymentType $proxy) {
