 ...
 */
class EventObjectTypeList extends \Oleg\UserdirectoryBundle\Entity\EventObjectTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventObjectTypeList $proxy) {
    ...
    public function getExclusivelySites()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getExclusivelySites', []);

        return parent::getExclusivelySites();
    }
    ...
    public function addExclusivelySite($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addExclusivelySite', [$item]);

        return parent::addExclusivelySite($item);
    }
    ...
    public function removeExclusivelySite($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeExclusivelySite', [$item]);

        return parent::removeExclusivelySite($item);
    }
