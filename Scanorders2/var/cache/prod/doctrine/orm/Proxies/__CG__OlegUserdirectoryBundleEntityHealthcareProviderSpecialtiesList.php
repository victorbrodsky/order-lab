 ...
 */
class HealthcareProviderSpecialtiesList extends \Oleg\UserdirectoryBundle\Entity\HealthcareProviderSpecialtiesList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HealthcareProviderSpecialtiesList $proxy) {
