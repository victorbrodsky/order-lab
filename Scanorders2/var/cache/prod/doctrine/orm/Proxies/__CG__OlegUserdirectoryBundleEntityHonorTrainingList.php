 ...
 */
class HonorTrainingList extends \Oleg\UserdirectoryBundle\Entity\HonorTrainingList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HonorTrainingList $proxy) {
