 ...
 */
class IdentifierTypeList extends \Oleg\UserdirectoryBundle\Entity\IdentifierTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IdentifierTypeList $proxy) {
