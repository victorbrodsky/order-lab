 ...
 */
class ImportanceList extends \Oleg\UserdirectoryBundle\Entity\ImportanceList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImportanceList $proxy) {
