 ...
 */
class JobTitleList extends \Oleg\UserdirectoryBundle\Entity\JobTitleList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (JobTitleList $proxy) {
