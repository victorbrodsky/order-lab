 ...
 */
class LabResultNameList extends \Oleg\UserdirectoryBundle\Entity\LabResultNameList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LabResultNameList $proxy) {
