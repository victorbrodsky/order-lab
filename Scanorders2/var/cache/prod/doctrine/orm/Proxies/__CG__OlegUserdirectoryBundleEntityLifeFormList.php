 ...
 */
class LifeFormList extends \Oleg\UserdirectoryBundle\Entity\LifeFormList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LifeFormList $proxy) {
