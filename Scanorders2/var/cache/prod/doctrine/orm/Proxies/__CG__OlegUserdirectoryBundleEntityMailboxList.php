 ...
 */
class MailboxList extends \Oleg\UserdirectoryBundle\Entity\MailboxList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MailboxList $proxy) {
