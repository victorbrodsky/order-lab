 ...
 */
class MajorTrainingList extends \Oleg\UserdirectoryBundle\Entity\MajorTrainingList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MajorTrainingList $proxy) {
