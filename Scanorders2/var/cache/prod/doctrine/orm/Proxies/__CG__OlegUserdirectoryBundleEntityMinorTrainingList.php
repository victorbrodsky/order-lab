 ...
 */
class MinorTrainingList extends \Oleg\UserdirectoryBundle\Entity\MinorTrainingList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MinorTrainingList $proxy) {
