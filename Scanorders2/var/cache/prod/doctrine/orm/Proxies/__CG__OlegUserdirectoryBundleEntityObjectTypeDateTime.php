 ...
 */
class ObjectTypeDateTime extends \Oleg\UserdirectoryBundle\Entity\ObjectTypeDateTime implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', 'formNode', 'value', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\ObjectTypeDateTime' . "\0" . 'datetimeValue', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\ObjectTypeDateTime' . "\0" . 'dateValue', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\ObjectTypeDateTime' . "\0" . 'timeValue', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\ObjectTypeDateTime' . "\0" . 'timezone', 'arraySectionIndex', 'arraySectionId', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ObjectTypeDateTime $proxy) {
    ...
    public function getTimeValue()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTimeValue', []);

        return parent::getTimeValue();
    }
    ...
    public function setTimeValue($timeValue)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTimeValue', [$timeValue]);

        return parent::setTimeValue($timeValue);
    }
    ...
    public function setTimeValueHourMinute($hour, $minute, $second = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTimeValueHourMinute', [$hour, $minute, $second]);

        return parent::setTimeValueHourMinute($hour, $minute, $second);
    }
    ...
    public function setDateTimeValueDateHourMinute($timezone, $date, $hour, $minute, $second = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateTimeValueDateHourMinute', [$timezone, $date, $hour, $minute, $second]);

        return parent::setDateTimeValueDateHourMinute($timezone, $date, $hour, $minute, $second);
    }
