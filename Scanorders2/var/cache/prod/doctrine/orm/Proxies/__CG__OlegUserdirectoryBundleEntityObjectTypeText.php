 ...
 */
class ObjectTypeText extends \Oleg\UserdirectoryBundle\Entity\ObjectTypeText implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ObjectTypeText $proxy) {
