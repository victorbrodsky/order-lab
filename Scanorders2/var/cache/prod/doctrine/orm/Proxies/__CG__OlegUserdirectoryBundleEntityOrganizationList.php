 ...
 */
class OrganizationList extends \Oleg\UserdirectoryBundle\Entity\OrganizationList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrganizationList $proxy) {
