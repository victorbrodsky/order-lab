 ...
 */
class PermissionObjectList extends \Oleg\UserdirectoryBundle\Entity\PermissionObjectList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\PermissionObjectList' . "\0" . 'sites', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PermissionObjectList $proxy) {
    ...
    public function addSite($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addSite', [$item]);

        return parent::addSite($item);
    }
    ...
    public function removeSite($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeSite', [$item]);

        return parent::removeSite($item);
    }
    ...
    public function hasSite($sitename)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasSite', [$sitename]);

        return parent::hasSite($sitename);
    }
