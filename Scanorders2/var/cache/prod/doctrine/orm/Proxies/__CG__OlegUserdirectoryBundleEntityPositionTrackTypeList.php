 ...
 */
class PositionTrackTypeList extends \Oleg\UserdirectoryBundle\Entity\PositionTrackTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'synonyms', 'original', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\PositionTrackTypeList' . "\0" . 'appointmentTitles', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PositionTrackTypeList $proxy) {
    ...
    public function addAppointmentTitle($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAppointmentTitle', [$item]);

        return parent::addAppointmentTitle($item);
    }
    ...
    public function removeAppointmentTitle($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAppointmentTitle', [$item]);

        return parent::removeAppointmentTitle($item);
    }
