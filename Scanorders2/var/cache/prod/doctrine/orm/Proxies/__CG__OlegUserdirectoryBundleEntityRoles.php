 ...
 */
class Roles extends \Oleg\UserdirectoryBundle\Entity\Roles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Roles' . "\0" . 'alias', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Roles' . "\0" . 'attributes', 'synonyms', 'original', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Roles' . "\0" . 'institution', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Roles' . "\0" . 'fellowshipSubspecialty', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Roles' . "\0" . 'permissions', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Roles' . "\0" . 'sites', '' . "\0" . 'Oleg\\UserdirectoryBundle\\Entity\\Roles' . "\0" . 'level', 'id', 'name', 'abbreviation', 'shortname', 'description', 'type', 'creator', 'createdate', 'updatedby', 'updatedon', 'orderinlist', 'updateAuthorRoles', 'fulltitle', 'linkToListId', 'objectType', 'entityId', 'entityNamespace', 'entityName', 'version'];
        }
     ...
     * {@inheritDoc}
     */
    public function addAttribute(\Oleg\UserdirectoryBundle\Entity\RoleAttributeList $attribute)
    {
     ...
     * {@inheritDoc}
     */
    public function removeAttribute(\Oleg\UserdirectoryBundle\Entity\RoleAttributeList $attribute)
    {
