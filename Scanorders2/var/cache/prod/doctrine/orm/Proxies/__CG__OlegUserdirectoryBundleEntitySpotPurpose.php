 ...
 */
class SpotPurpose extends \Oleg\UserdirectoryBundle\Entity\SpotPurpose implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SpotPurpose $proxy) {
