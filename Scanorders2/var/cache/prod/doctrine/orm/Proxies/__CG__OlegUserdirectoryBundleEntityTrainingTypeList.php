 ...
 */
class TrainingTypeList extends \Oleg\UserdirectoryBundle\Entity\TrainingTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TrainingTypeList $proxy) {
