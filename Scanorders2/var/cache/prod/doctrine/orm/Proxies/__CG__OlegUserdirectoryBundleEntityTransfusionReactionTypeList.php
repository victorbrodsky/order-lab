 ...
 */
class TransfusionReactionTypeList extends \Oleg\UserdirectoryBundle\Entity\TransfusionReactionTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransfusionReactionTypeList $proxy) {
