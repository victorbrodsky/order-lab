 ...
 */
class VacReqRequestTypeList extends \Oleg\VacReqBundle\Entity\VacReqRequestTypeList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VacReqRequestTypeList $proxy) {
