...
user in an INI file next to PDFTKBuilderPortable.exe called PDFTKBuilderPortable.ini.
...
copy AppNamePortable.ini from this directory to PDFTKBuilderPortable.ini next to
PDFTKBuilderPortable.exe. The options in the INI file are as follows:
