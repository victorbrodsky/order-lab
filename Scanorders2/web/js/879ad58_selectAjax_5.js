...
function getSetTitle() {
    ...
    var idInArr = getParentSelectId(".combobox-research-projectTitle",_projectTitle,targetid);
    if( idInArr < 0 ) {
        return;
    }
...
function getParentSelectId( ptarget, pArr, target ) {
    ...
    if( parentVal == '' ) {
        //console.log('not in array');
        populateSelectCombobox( target, null, "Choose an option", false );
