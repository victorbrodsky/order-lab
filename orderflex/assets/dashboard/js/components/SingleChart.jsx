...
class SingleChart extends Component {
    ...
    addErrorLine(msg, type) {
        let error
        if (type == 'error') {
            error = <div id="dashboard-alert-msg"
                         className={'alert alert-danger dashboard-alert-msg added-by-singlechart-js'}>{msg}</div>
        }
        if (type == 'warning') {
            error = <div id="dashboard-alert-msg"
                         className={'alert alert-warning dashboard-alert-msg added-by-singlechart-js'}>{msg}</div>
        }
    ...
    render() {
        ...
        const chartDiv = this.state.chartDiv;
