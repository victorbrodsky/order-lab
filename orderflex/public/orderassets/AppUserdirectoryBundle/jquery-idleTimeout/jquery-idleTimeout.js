...
(function ($) {
  ...
  $.fn.idleTimeout = function (userRuntimeConfig) {
    ...
    openWarningDialog = function () {
      ...
      var dialogContent = "<div id='idletimer_warning_dialog'><p>" +
          currentConfig.dialogText + "</p>"+
          "<p>"+currentConfig.dialogText2+"</p>"+
          "<p style='display:inline'>" +
          currentConfig.dialogTimeRemaining + ": <div style='display:inline' id='countdownDisplay'></div></p></div>";
    ...
    countdownDisplay = function () {
      ...
      remainingTimer = setInterval(function () {
        ...
        //https://github.com/JillElaine/jquery-idleTimeout/issues/33
        //added by Oleg
        if(dialogDisplaySeconds <= 0) dialogDisplaySeconds = 0; //get rid of NaN display on the line after dialogDisplaySeconds -= 1;
      }, 1000);
    };
