...
class CallLogAccessRequestController extends AccessRequestController
{
    ...
    #[Route(path: '/access-requests/new/create', name: 'calllog_access_request_new_plain', methods: ['GET'])]
    ...
    #[Route(path: '/access-requests/new', name: 'calllog_access_request_new', methods: ['GET'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request.html.twig')]
    ...
    #[Route(path: '/access-requests/new/pending', name: 'calllog_access_request_create', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request.html.twig')]
     ...
     */
    #[Route(path: '/access-requests', name: 'calllog_accessrequest_list', methods: ['GET'])]
    ...
    #[Route(path: '/access-requests/{id}', name: 'calllog_accessrequest_management', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    #[Route(path: '/access-requests/submit/{id}', name: 'calllog_accessrequest_management_submit', methods: ['POST'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/authorized-users/', name: 'calllog_authorized_users', methods: ['GET'])]
    ...
    #[Route(path: '/authorization-user-manager/{id}', name: 'calllog_authorization_user_management', methods: ['GET'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/authorization-user-manager/submit/{id}', name: 'calllog_authorization_user_management_submit', methods: ['POST'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/add-authorized-user/', name: 'calllog_add_authorized_user', methods: ['GET'])]
