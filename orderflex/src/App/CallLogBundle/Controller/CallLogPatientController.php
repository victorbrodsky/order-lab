...
//        $patientForm = $this->createPatientForm($newPatient);
    ...
    public function addPatientToListAction(Request $request, $patientListId, $patientId) {
        ...
        //return OK
        if( $request->attributes->get('_route') == "calllog_add_patient_to_list_ajax" ) {
            $res = "OK";
...
//        }
        ...
        $repository = $em->getRepository(CalllogTask::class);
...
//        }
    ...
    public function createCalllogPatientsExcelSpout($patients,$fileName,$user,$ext) {
        ...
        $myLimit = 2;
        //process.py script: replaced namespace by ::class: ['AppOrderformBundle:MrnType'] by [MrnType::class]
        $keytypemrns = $em->getRepository(MrnType::class)->findBy(
            array(),                        //All
