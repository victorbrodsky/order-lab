...
class CallLogUserRequestController extends UserRequestController
{
     ...
     */
    #[Route(path: '/account-requests/new', name: 'calllog_accountrequest_new', methods: ['GET'])]
     ...
     */
    #[Route(path: '/account-requests/new', name: 'calllog_accountrequest_create', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/UserRequest/account_request.html.twig')]
     ...
     */
    #[Route(path: '/account-requests', name: 'calllog_accountrequest', methods: ['GET'])]
    ...
    #[Route(path: '/account-requests/{id}/{status}/status', name: 'calllog_accountrequest_status', methods: ['GET'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/UserRequest/index.html.twig')]
     ...
     */
    #[Route(path: '/account-requests-approve', name: 'calllog_accountrequest_approve', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/UserRequest/index.html.twig')]
