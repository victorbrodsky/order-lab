...
class CallLogUserRequestController extends UserRequestController
{
     ...
     *
     * @Route("/account-requests/new", name="calllog_accountrequest_new", methods={"GET"})
     ...
     *
     * @Route("/account-requests/new", name="calllog_accountrequest_create", methods={"POST"})
     * @Template("AppUserdirectoryBundle/UserRequest/account_request.html.twig")
     */
     ...
     *
     * @Route("/account-requests", name="calllog_accountrequest", methods={"GET"})
    ...
    /**
     * @Route("/account-requests/{id}/{status}/status", name="calllog_accountrequest_status", methods={"GET"}, requirements={"id" = "\d+"})
     * @Template("AppUserdirectoryBundle/UserRequest/index.html.twig")
     */
     ...
     *
     * @Route("/account-requests-approve", name="calllog_accountrequest_approve", methods={"POST"})
     * @Template("AppUserdirectoryBundle/UserRequest/index.html.twig")
     */
