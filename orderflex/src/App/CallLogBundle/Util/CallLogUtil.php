...
//        }
    ...
    public function convertAutoGeneratedAccessiontype( $accessiontypeId, $asObject=false ) {
        ...
        if( strval($accessiontypeId) != strval(intval($accessiontypeId)) ) {
            //exit("not integer");

            $mrntypeTransformer = new MrnTypeTransformer($this->em,$this->container->get('security.token_storage')->getToken()->getUser());
            $mrntypeNew = $mrntypeTransformer->reverseTransform($accessiontypeId,false);
...
//                }
    ...
    public function getDefaultMessageCategory() {
        ...
        if( !$messageCategory ) {
            $messageCategory = $this->em->getRepository('AppOrderformBundle:MessageCategory')->findOneByName("Pathology Call Log Entry");
        }
