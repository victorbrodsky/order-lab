...
class CrnSignUpController extends SignUpController
{


    public function __construct() {
        $this->siteName = 'crn'; //controller is not setup yet, so we can't use $this->getParameter('employees.sitename');
        $this->siteNameShowuser = 'employees';
        $this->siteNameStr = 'Critical Result Notification';
        $this->pathHome = 'crn_home';
     ...
     */
    #[Route(path: '/signup-list', name: 'crn_signup_index', methods: ['GET'])]
     ...
     */
    #[Route(path: '/sign-up', name: 'crn_signup_new', methods: ['GET', 'POST'])]
    public function newSignUpAction(Request $request)
    {
        return parent::newSignUpAction($request);
    }

    #[Route(path: '/activate-account/{registrationLinkID}', name: 'crn_activate_account', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/signup-show/{id}', name: 'crn_signup_show', methods: ['GET'])]
     ...
     */
    #[Route(path: '/signup-edit/{id}', name: 'crn_signup_edit', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/signup-delete/{id}', name: 'crn_signup_delete', methods: ['DELETE'])]
    public function deleteAction(Request $request, SignUp $signUp)
    {
        return parent::deleteAction($request,$signUp);
    }

    #[Route(path: '/forgot-password', name: 'crn_forgot_password', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/reset-password/{resetPasswordLinkID}', name: 'crn_reset_password', methods: ['GET', 'POST'])]
