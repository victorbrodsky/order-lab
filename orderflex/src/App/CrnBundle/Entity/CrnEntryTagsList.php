...
class CrnEntryTagsList extends ListAbstract {
    ...
    public function __construct() {
        ...
        $this->crnEntryMessages = new ArrayCollection();
    }




    public function addCrnEntryMessage($item)
    {
        if( $item && !$this->crnEntryMessages->contains($item) ) {
            $this->crnEntryMessages->add($item);
        }
        return $this;
    }
    public function removeCrnEntryMessage($item)
    {
        $this->crnEntryMessages->removeElement($item);
    }
