...
class CrnEncounterType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('date', CollectionType::class, array(
            'entry_type' => CrnEncounterDateType::class,
            'entry_options' => array(
...
//        ));
        ...
        $builder->add('number', CollectionType::class, array(
            'entry_type' => CrnEncounterNumberType::class,
            'entry_options' => array(
                'form_custom_value' => $this->params
            ),
            'allow_add' => true,
...
//        }
        ...
        //Referring Provider for crn new entry
...
//            ));
        ...
        $builder->add('tracker', CrnTrackerType::class, array(
            'form_custom_value' => $this->params,
...
//            'entry_type' => CrnProcedureType::class,
//            'entry_options' => array(
//                'form_custom_value' => $this->params,
