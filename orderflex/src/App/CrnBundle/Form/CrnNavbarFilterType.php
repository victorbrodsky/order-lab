...
class CrnNavbarFilterType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if( array_key_exists('crnsearchtype',$this->params) && $this->params['crnsearchtype'] ) {
            $searchTypeArray['data'] = $this->params['crnsearchtype'];
        }
        ...
        if( array_key_exists('crnsearch',$this->params) && $this->params['crnsearch'] ) {
            $searchArray['data'] = $this->params['crnsearch'];
        }
