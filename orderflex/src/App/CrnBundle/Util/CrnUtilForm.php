...
//        }
        ...
        if( $crnEntryMessage && $crnEntryMessage->getAddPatientToList() ) {
            $patientLists = $crnEntryMessage->getPatientLists();
...
//        return $html;
    ...
    public function getEntryTagsHtml( $message, $status ) {
        ...
        $html .= $this->getTrField("Critical Result Notification Entry Tag(s) ", implode("; ",$entryTagsArr));

        $timeSpentMinutes = $crnEntryMessage->getTimeSpentMinutes();
