...
class CtpLoggerController extends LoggerController
{

    /**
     * Lists all Logger entities.
     */
    #[Route(path: '/', name: 'ctp_logger', methods: ['GET'])]
    ...
    public function indexAction(Request $request)
    {
		...
		$params = array('sitename'=>$this->getParameter('ctp.sitename'));
    ...
    #[Route(path: '/user/{id}/all', name: 'ctp_logger_user_all', methods: ['GET'])]
    #[Template('AppCtpBundle/Logger/index.html.twig')]
