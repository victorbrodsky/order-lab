...
class CtpSecurityController extends SecurityController
{

    #[Route(path: '/login', name: 'ctp_login')]
    ...
    {
        //exit('ctp: setAjaxLoginVisit');
        return parent::setAjaxLoginVisit($request);
    }


    #[Route(path: '/no-permission', name: 'ctp-nopermission', methods: ['GET'])]
    ...
    #[Route(path: '/idle-log-out', name: 'ctp_idlelogout')]
    #[Route(path: '/idle-log-out/{flag}', name: 'ctp_idlelogout-saveorder')]
    public function idlelogoutAction( Request $request, $flag = null )
    {
        //exit('ctp: idlelogoutAction');
