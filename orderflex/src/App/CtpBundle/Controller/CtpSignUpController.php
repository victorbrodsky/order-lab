...
class CtpSignUpController extends SignUpController
{


    public function __construct() {
        $this->siteName = 'ctp'; //controller is not setup yet, so we can't use $this->getParameter('employees.sitename');
        $this->siteNameShowuser = 'employees';
        $this->siteNameStr = 'Center for Translational Pathology';
        $this->pathHome = 'ctp_home';
     ...
     */
    #[Route(path: '/signup-list', name: 'ctp_signup_index', methods: ['GET'])]
     ...
     */
    #[Route(path: '/sign-up', name: 'ctp_signup_new', methods: ['GET', 'POST'])]
    public function newSignUpAction(Request $request)
    {
        return parent::newSignUpAction($request);
    }

    #[Route(path: '/activate-account/{registrationLinkID}', name: 'ctp_activate_account', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/signup-show/{id}', name: 'ctp_signup_show', methods: ['GET'])]
     ...
     */
    #[Route(path: '/signup-edit/{id}', name: 'ctp_signup_edit', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/signup-delete/{id}', name: 'ctp_signup_delete', methods: ['DELETE'])]
    public function deleteAction(Request $request, SignUp $signUp)
    {
        return parent::deleteAction($request,$signUp);
    }

    #[Route(path: '/forgot-password', name: 'ctp_forgot_password', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/reset-password/{resetPasswordLinkID}', name: 'ctp_reset_password', methods: ['GET', 'POST'])]
