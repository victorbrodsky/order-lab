...
class CtpUserRequestController extends UserRequestController
{
     ...
     */
    #[Route(path: '/account-requests/new', name: 'ctp_accountrequest_new', methods: ['GET'])]
     ...
     */
    #[Route(path: '/account-requests/new', name: 'ctp_accountrequest_create', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/UserRequest/account_request.html.twig')]
    ...
    #[Route(path: '/account-requests/{id}/{status}/status', name: 'ctp_accountrequest_status', methods: ['GET'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/UserRequest/index.html.twig')]
     ...
     */
    #[Route(path: '/account-requests-approve', name: 'ctp_accountrequest_approve', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/UserRequest/index.html.twig')]
