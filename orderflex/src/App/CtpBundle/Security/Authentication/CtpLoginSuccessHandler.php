...
namespace App\CtpBundle\Security\Authentication;
...
class CtpLoginSuccessHandler extends LoginSuccessHandler {
    ...
    public function __construct( ContainerInterface $container, EntityManagerInterface $em, Security $security )
    {
        ...
        $this->siteName = $container->getParameter('ctp.sitename');
        ...
        $this->firewallName = 'ldap_ctp_firewall';
    }
