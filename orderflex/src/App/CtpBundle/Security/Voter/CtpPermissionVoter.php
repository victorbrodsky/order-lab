...
namespace App\CtpBundle\Security\Voter;
...
class CtpPermissionVoter extends BasePermissionVoter //BasePermissionVoter   //PatientHierarchyVoter
{
    ...
    {
        return 'ctp';  //Site abbreviation i.e. fellapp, not fellowship-applications
    }
