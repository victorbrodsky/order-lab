...
class RegulatorytAccessRequestController extends AccessRequestController
{
    ...
    #[Route(path: '/access-requests/new/create', name: 'ctpregulatoryt_access_request_new_plain', methods: ['GET'])]
    ...
    #[Route(path: '/access-requests/new', name: 'ctpregulatoryt_access_request_new', methods: ['GET'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request.html.twig')]
    ...
    #[Route(path: '/access-requests/new/pending', name: 'ctpregulatoryt_access_request_create', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request.html.twig')]
    ...
    #[Route(path: '/access-requests', name: 'ctpregulatoryt_accessrequest_list', methods: ['GET'])]
    ...
    #[Route(path: '/access-requests/change-status/{id}/{status}', name: 'ctpregulatoryt_accessrequest_change', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    #[Route(path: '/access-requests/{id}', name: 'ctpregulatoryt_accessrequest_management', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    #[Route(path: '/access-requests/submit/{id}', name: 'ctpregulatoryt_accessrequest_management_submit', methods: ['POST'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/deny-access-request/{userId}', name: 'ctpregulatoryt_accessrequest_remove', methods: ['GET'], requirements: ['userId' => '\d+'])]
    public function accessRequestRemoveAction(Request $request, $userId )
    {
        return parent::accessRequestRemoveAction($request,$userId);
    }

    #[Route(path: '/authorized-users/', name: 'ctpregulatoryt_authorized_users', methods: ['GET'])]
    ...
    #[Route(path: '/authorization-user-manager/{id}', name: 'ctpregulatoryt_authorization_user_management', methods: ['GET'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/authorization-user-manager/submit/{id}', name: 'ctpregulatoryt_authorization_user_management_submit', methods: ['POST'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/revoke-access-authorization/{userId}', name: 'ctpregulatoryt_authorization_remove', methods: ['GET'], requirements: ['userId' => '\d+'])]
    public function authorizationRemoveAction(Request $request, $userId)
    {
        return parent::authorizationRemoveAction($request,$userId);
    }

    #[Route(path: '/add-authorized-user/', name: 'ctpregulatoryt_add_authorized_user', methods: ['GET'])]
