 ...
 * tma
 */
class TmaAccessRequestController extends AccessRequestController
{
    ...
    public function __construct() {
        ...
        $this->roleBanned = 'ROLE_TMA_BANNED';
        $this->roleUser = 'ROLE_TMA_USER';
        $this->roleUnapproved = 'ROLE_TMA_UNAPPROVED';
        $this->roleEditor = 'ROLE_TMA_ADMIN';
    }

    #[Route(path: '/access-requests/new/create', name: 'ctptma_access_request_new_plain', methods: ['GET'])]
    ...
    #[Route(path: '/access-requests/new', name: 'ctptma_access_request_new', methods: ['GET'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request.html.twig')]
    ...
    #[Route(path: '/access-requests/new/pending', name: 'ctptma_access_request_create', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request.html.twig')]
     ...
     */
    #[Route(path: '/access-requests', name: 'ctptma_accessrequest_list', methods: ['GET'])]
    ...
    #[Route(path: '/access-requests/change-status/{id}/{status}', name: 'ctptma_accessrequest_change', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    #[Route(path: '/access-requests/{id}', name: 'ctptma_accessrequest_management', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    #[Route(path: '/access-requests/submit/{id}', name: 'ctptma_accessrequest_management_submit', methods: ['POST'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/deny-access-request/{userId}', name: 'ctptma_accessrequest_remove', methods: ['GET'], requirements: ['userId' => '\d+'])]
    public function accessRequestRemoveAction(Request $request, $userId )
    {
        return parent::accessRequestRemoveAction($request,$userId);
    }

    #[Route(path: '/authorized-users/', name: 'ctptma_authorized_users', methods: ['GET'])]
    ...
    #[Route(path: '/authorization-user-manager/{id}', name: 'ctptma_authorization_user_management', methods: ['GET'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/authorization-user-manager/submit/{id}', name: 'ctptma_authorization_user_management_submit', methods: ['POST'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/revoke-access-authorization/{userId}', name: 'ctptma_authorization_remove', methods: ['GET'], requirements: ['userId' => '\d+'])]
    ...
    #[Route(path: '/add-authorized-user/', name: 'ctptma_add_authorized_user', methods: ['GET'])]
