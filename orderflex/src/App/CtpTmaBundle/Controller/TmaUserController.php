...
class TmaUserController extends UserController
{
    ...
    public function editUserAction(Request $request, $id)
    {
        ...
        $editUser = $this->editUser($request,$id, $this->getParameter('tma.sitename'));
    ...
    public function updateUserAction(Request $request, $id)
    {
        ...
        return $this->updateUser( $request, $id, $this->getParameter('tma.sitename') );
    }
