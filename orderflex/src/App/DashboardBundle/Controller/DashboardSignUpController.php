...
class DashboardSignUpController extends SignUpController
{


    public function __construct() {
        $this->siteName = 'dashboard'; //controller is not setup yet, so we can't use $this->getParameter('employees.sitename');
        $this->siteNameShowuser = 'employees';
        $this->siteNameStr = 'Dashboard';
        $this->pathHome = 'dashboard_home';
     ...
     */
    #[Route(path: '/signup-list', name: 'dashboard_signup_index', methods: ['GET'])]
     ...
     */
    #[Route(path: '/sign-up', name: 'dashboard_signup_new', methods: ['GET', 'POST'])]
    public function newSignUpAction(Request $request)
    {
        return parent::newSignUpAction($request);
    }

    #[Route(path: '/activate-account/{registrationLinkID}', name: 'dashboard_activate_account', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/signup-show/{id}', name: 'dashboard_signup_show', methods: ['GET'])]
     ...
     */
    #[Route(path: '/signup-edit/{id}', name: 'dashboard_signup_edit', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/signup-delete/{id}', name: 'dashboard_signup_delete', methods: ['DELETE'])]
    public function deleteAction(Request $request, SignUp $signUp)
    {
        return parent::deleteAction($request,$signUp);
    }

    #[Route(path: '/forgot-password', name: 'dashboard_forgot_password', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/reset-password/{resetPasswordLinkID}', name: 'dashboard_reset_password', methods: ['GET', 'POST'])]
