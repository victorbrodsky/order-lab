...
class DashboardUploadController extends UploadController {
    ...
    #[Route(path: '/file-delete', name: 'dashboard_file_delete', methods: ['GET', 'POST', 'DELETE'])]
     ...
     * $id - document id
     */
    #[Route(path: '/file-download/{id}/{eventtype}', name: 'dashboard_file_download', methods: ['GET'], requirements: ['id' => '\d+'])]
     ...
     * $id - document id
     */
    #[Route(path: '/file-view/{id}/{viewType}/{eventtype}', name: 'dashboard_file_view', methods: ['GET'], requirements: ['id' => '\d+'])]
