...
//        exit('111');
        ...
        //$em = $this->getDoctrine()->getManager();
        //$dashboardUtil = $this->container->get('dashboard_util');
        //$topics = $dashboardUtil->printTreeSelectList();
        //$topics = $dashboardUtil->getFilterTopics();
        //$topics = $dashboardUtil->printTreeSelectList();
        //$root = $em->getRepository('AppDashboardBundle:TopicList')->findOneByName("All Charts");
        //$topics = $root->printTree("<br>");
        //$topics = $root->getFullTreeAsEntity();
        //$topics = $root->getFlatTree();
        //dump($topics);
        //print_r($topics);
        //exit('111');
