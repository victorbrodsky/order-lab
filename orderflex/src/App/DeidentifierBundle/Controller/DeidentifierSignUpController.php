...
class DeidentifierSignUpController extends SignUpController
{


    public function __construct() {
        $this->siteName = 'deidentifier'; //controller is not setup yet, so we can't use $this->getParameter('employees.sitename');
        $this->siteNameShowuser = 'deidentifier';
        $this->siteNameStr = 'Deidentifier';
        $this->pathHome = 'deidentifier_home';
        $this->minimumRoles = array('ROLE_DEIDENTIFICATOR_USER');
        $this->roleAdmins = array('ROLE_DEIDENTIFICATOR_ADMIN');
    }

    /**
     * Lists all signUp entities.
     */
    #[Route(path: '/signup-list', name: 'deidentifier_signup_index', methods: ['GET'])]
     ...
     */
    #[Route(path: '/sign-up', name: 'deidentifier_signup_new', methods: ['GET', 'POST'])]
    public function newSignUpAction(Request $request)
    {
        return parent::newSignUpAction($request);
    }

    #[Route(path: '/activate-account/{registrationLinkID}', name: 'deidentifier_activate_account', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/signup-show/{id}', name: 'deidentifier_signup_show', methods: ['GET'])]
     ...
     */
    #[Route(path: '/signup-edit/{id}', name: 'deidentifier_signup_edit', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/signup-delete/{id}', name: 'deidentifier_signup_delete', methods: ['DELETE'])]
    public function deleteAction(Request $request, SignUp $signUp)
    {
        return parent::deleteAction($request,$signUp);
    }

    #[Route(path: '/forgot-password', name: 'deidentifier_forgot_password', methods: ['GET', 'POST'])]
     ...
     */
    #[Route(path: '/reset-password/{resetPasswordLinkID}', name: 'deidentifier_reset_password', methods: ['GET', 'POST'])]
