...
class FellAppAccessRequestController extends AccessRequestController
{
    ...
    /**
     * @Route("/access-requests/new/create", name="fellapp_access_request_new_plain", methods={"GET"})
    ...
    /**
     * @Route("/access-requests/new/pending", name="fellapp_access_request_create", methods={"POST"})
     * @Template("AppUserdirectoryBundle/AccessRequest/access_request.html.twig")
     */
     ...
     *
     * @Route("/access-requests", name="fellapp_accessrequest_list", methods={"GET"})
    ...
    /**
     * @Route("/access-requests/change-status/{id}/{status}", name="fellapp_accessrequest_change", methods={"GET"}, requirements={"id" = "\d+"})
     * @Template()
     */
    ...
    /**
     * @Route("/access-requests/{id}", name="fellapp_accessrequest_management", methods={"GET"}, requirements={"id" = "\d+"})
    ...
    /**
     * @Route("/access-requests/submit/{id}", name="fellapp_accessrequest_management_submit", methods={"POST"}, requirements={"id" = "\d+"})
     * @Template("AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig")
     */
    ...
    /**
     * @Route("/deny-access-request/{userId}", name="fellapp_accessrequest_remove", methods={"GET"}, requirements={"userId" = "\d+"})
     * @Template()
     */
    ...
    /**
     * @Route("/authorized-users/", name="fellapp_authorized_users", methods={"GET"})
    ...
    /**
     * @Route("/authorization-user-manager/{id}", name="fellapp_authorization_user_management", methods={"GET"}, requirements={"id" = "\d+"})
     * @Template("AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig")
     */
    ...
    /**
     * @Route("/authorization-user-manager/submit/{id}", name="fellapp_authorization_user_management_submit", methods={"POST"}, requirements={"id" = "\d+"})
     * @Template("AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig")
     */
    ...
    /**
     * @Route("/revoke-access-authorization/{userId}", name="fellapp_authorization_remove", methods={"GET"}, requirements={"userId" = "\d+"})
     * @Template()
     */
    ...
    /**
     * @Route("/add-authorized-user/", name="fellapp_add_authorized_user", methods={"GET"})
