...
class FellAppUserRequestController extends UserRequestController
{
     ...
     */
    #[Route(path: '/account-requests/new', name: 'fellapp_accountrequest_new', methods: ['GET'])]
     ...
     */
    #[Route(path: '/account-requests/new', name: 'fellapp_accountrequest_create', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/UserRequest/account_request.html.twig')]
     ...
     */
    #[Route(path: '/account-requests', name: 'fellapp_accountrequest', methods: ['GET'])]
    ...
    #[Route(path: '/account-requests/{id}/{status}/status', name: 'fellapp_accountrequest_status', methods: ['GET'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/UserRequest/index.html.twig')]
     ...
     */
    #[Route(path: '/account-requests-approve', name: 'fellapp_accountrequest_approve', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/UserRequest/index.html.twig')]
