...
class ScanUserRequestController extends UserRequestController
{
     ...
     *
     * @Route("/account-requests/new", name="scan_accountrequest_new", methods={"GET"})
     ...
     *
     * @Route("/account-requests/new", name="scan_accountrequest_create", methods={"POST"})
     * @Template("AppUserdirectoryBundle/UserRequest/account_request.html.twig")
     */
     ...
     *
     * @Route("/account-requests", name="scan_accountrequest", methods={"GET"})
    ...
    /**
     * @Route("/account-requests/{id}/{status}/status", name="scan_accountrequest_status", methods={"GET"}, requirements={"id" = "\d+"})
     * @Template("AppUserdirectoryBundle/UserRequest/index.html.twig")
     */
     ...
     *
     * @Route("/account-requests-approve", name="scan_accountrequest_approve", methods={"POST"})
     * @Template("AppUserdirectoryBundle/UserRequest/index.html.twig")
     */
