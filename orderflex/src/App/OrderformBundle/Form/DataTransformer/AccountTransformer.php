...
class AccountTransformer implements DataTransformerInterface
{
    ...
    public function reverseTransform($text): mixed
    {
        ...
        //process.py script: replaced namespace by ::class: ['AppOrderformBundle:Account'] by [Account::class]
            $entity = $this->em->getRepository(Account::class)->findOneById($text);
    ...
    public function createNew($name) {
        ...
        //process.py script: replaced namespace by ::class: ['AppOrderformBundle:Account'] by [Account::class]
        $entity = $this->em->getRepository(Account::class)->findOneByName($name);
        ...
        if( null === $entity ) {
            ...
            $query = $this->em->createQuery('SELECT MAX(c.orderinlist) as maxorderinlist FROM App\\OrderformBundle\\Entity\\Account c');
