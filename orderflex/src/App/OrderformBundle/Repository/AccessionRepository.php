...
class AccessionRepository extends ArrayFieldAbstractRepository {
    ...
    public function changeKeytype($entity) {
        ...
        //process.py script: replaced namespace by ::class: ['AppOrderformBundle:AccessionType'] by [AccessionType::class]
            $keytype = $em->getRepository(AccessionType::class)->findOneByName("Auto-generated Accession Number");
        ...
        //process.py script: replaced namespace by ::class: ['AppOrderformBundle:AccessionType'] by [AccessionType::class]
            $newkeytypeEntity = $em->getRepository(AccessionType::class)->findOneByName("Auto-generated Accession Number");
...
//        echo "keytype=".$entity->obtainValidKeyField()->getKeytype()."<br>";
    ...
    public function getCorrectKeytypeId($keytypeid,$user=null) {
        ...
        //process.py script: replaced namespace by ::class: ['AppOrderformBundle:AccessionType'] by [AccessionType::class]
            $keytypeEntity = $em->getRepository(AccessionType::class)->findOneById($keytypeid);
        } else {
        ...
        //process.py script: replaced namespace by ::class: ['AppOrderformBundle:AccessionType'] by [AccessionType::class]
            $keytypeEntity = $em->getRepository(AccessionType::class)->findOneByName("Auto-generated Accession Number");
        }
    ...
    public function processDuplicationKeyField( $accession, $message ) {
        ...
        //process.py script: replaced namespace by ::class: ['AppOrderformBundle:MrnType'] by [MrnType::class]
                $mrntype = $em->getRepository(MrnType::class)->findOneById( $mrnKeytype );
                $currentDataquality->setMrntype($mrntype);
                $currentDataquality->setMrn($mrnValue);

                //set accessiontype
        //process.py script: replaced namespace by ::class: ['AppOrderformBundle:AccessionType'] by [AccessionType::class]
                $accessiontype = $em->getRepository(AccessionType::class)->findOneById( $accKeytype );
