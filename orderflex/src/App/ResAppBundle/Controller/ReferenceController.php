...
class ReferenceController extends OrderAbstractController
{
    ...
    public function InviteReferencesToSubmitLettersAction(Request $request, #[MapEntity] ResidencyApplication $resapp) {
...
//        );
    ...
    public function InviteReferenceToSubmitLetterAction(Request $request, #[MapEntity] ResidencyApplication $resapp, $referenceid) {
