...
class ResAppUserRequestController extends UserRequestController
{
     ...
     *
     * @Route("/account-requests/new", name="resapp_accountrequest_new", methods={"GET"})
     ...
     *
     * @Route("/account-requests/new", name="resapp_accountrequest_create", methods={"POST"})
     * @Template("AppUserdirectoryBundle/UserRequest/account_request.html.twig")
     */
     ...
     *
     * @Route("/account-requests", name="resapp_accountrequest", methods={"GET"})
    ...
    /**
     * @Route("/account-requests/{id}/{status}/status", name="resapp_accountrequest_status", methods={"GET"}, requirements={"id" = "\d+"})
     * @Template("AppUserdirectoryBundle/UserRequest/index.html.twig")
     */
     ...
     *
     * @Route("/account-requests-approve", name="resapp_accountrequest_approve", methods={"POST"})
     * @Template("AppUserdirectoryBundle/UserRequest/index.html.twig")
     */
