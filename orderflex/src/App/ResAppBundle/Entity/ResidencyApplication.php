...
class ResidencyApplication extends BaseUserAttributes {
    ...
    #[ORM\JoinColumn(name: 'resApp_id', referencedColumnName: 'id', onDelete: 'CASCADE')]
...
//    /**
    ...
    #[ORM\JoinColumn(name: 'residencyApplication_id', referencedColumnName: 'id')]
    ...
    #[ORM\JoinColumn(name: 'residencyApplication_id', referencedColumnName: 'id')]
    #[ORM\InverseJoinColumn(name: 'applyingtrack_id', referencedColumnName: 'id')]
    ...
    #[ORM\JoinColumn(name: 'residencyApplication_id', referencedColumnName: 'id')]
    #[ORM\InverseJoinColumn(name: 'learnarea_id', referencedColumnName: 'id')]
    ...
    #[ORM\JoinColumn(name: 'residencyapplication_id', referencedColumnName: 'id')]
    #[ORM\InverseJoinColumn(name: 'specificindividual_id', referencedColumnName: 'id')]
    ...
    public function getUsmleArr() {
        ...
        foreach( $this->getExaminations() as $examination ) {
            ...
            if( 
                ...
                !$examination->getUSMLEStep2CSScore(true) &&
            ...
            if( $examination->getUSMLEStep2CSScore(true) ) {
                $usmleArr[] = $examination->getUSMLEStep2CSScore(true);
            } else {
                $usmleArr[] = "-";
            }
    ...
    public function getComlexArr() {
        ...
        foreach( $this->getExaminations() as $examination ) {
            ...
            if( 
                ...
                !$examination->getCOMLEXLevel2PEScore(true) &&
            ...
            if( $examination->getCOMLEXLevel2PEScore(true) ) {
                $comlexArr[] = $examination->getCOMLEXLevel2PEScore(true);
            } else {
                $comlexArr[] = "-";
            }
