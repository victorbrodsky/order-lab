...
class RecLetterUtil {
    ...
    public function generateRecLetterId( $resapp, $reference, $request=null, $count=0 ) {
        ...
        if( $hash ) {
            $references = $this->em->getRepository('AppResAppBundle:Reference')->findByRecLetterHashId($hash);
...
//            return false;
        ...
        $body =
            ...
            . " Elizabeth Hammerschmidt (our residency program coordinator) at eah2006@med.cornell.edu for alternative methods of submitting your recommendation letter."
...
//            $emailUtil->sendEmail( $adminEmails, $msg, $msg );
        ...
        $references = $this->em->getRepository('AppResAppBundle:Reference')->findByRecLetterHashId($refId);
...
//            }
            ...
            if( $originalStatusStr != "Complete" ) {
                $completeStatus = $this->em->getRepository('AppResAppBundle:ResAppStatus')->findOneByName("complete");
                if (!$completeStatus) {
