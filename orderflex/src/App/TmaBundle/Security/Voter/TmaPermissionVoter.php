...
namespace App\TmaBundle\Security\Voter;
...
class TmaPermissionVoter extends BasePermissionVoter //BasePermissionVoter   //PatientHierarchyVoter
{
    ...
    {
        return 'tma';  //Site abbreviation i.e. fellapp, not fellowship-applications
    }
