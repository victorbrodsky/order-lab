...
class TransResSignUpController extends SignUpController
{
    ...
    public function __construct() {
        ...
        $this->minimumRoles = array('ROLE_TRANSRES_REQUESTER_APCP', 'ROLE_TRANSRES_REQUESTER_HEMATOPATHOLOGY', 'ROLE_TRANSRES_REQUESTER_COVID19');
        $this->roleAdmins = array('ROLE_TRANSRES_ADMIN_APCP','ROLE_TRANSRES_ADMIN_HEMATOPATHOLOGY','ROLE_TRANSRES_ADMIN_COVID19');
    }
