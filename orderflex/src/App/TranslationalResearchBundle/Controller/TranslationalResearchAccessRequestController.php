...
class TranslationalResearchAccessRequestController extends AccessRequestController
{
    ...
    #[Route(path: '/access-requests/new/create', name: 'translationalresearch_access_request_new_plain', methods: ['GET'])]
    ...
    #[Route(path: '/access-requests/new', name: 'translationalresearch_access_request_new', methods: ['GET'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request.html.twig')]
    ...
    #[Route(path: '/access-requests/new/pending', name: 'translationalresearch_access_request_create', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request.html.twig')]
    ...
    #[Route(path: '/access-requests/{id}', name: 'translationalresearch_accessrequest_management', methods: ['GET'], requirements: ['id' => '\d+'])]
    ...
    #[Route(path: '/access-requests/submit/{id}', name: 'translationalresearch_accessrequest_management_submit', methods: ['POST'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/authorized-users/', name: 'translationalresearch_authorized_users', methods: ['GET'])]
    ...
    #[Route(path: '/authorization-user-manager/{id}', name: 'translationalresearch_authorization_user_management', methods: ['GET'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/authorization-user-manager/submit/{id}', name: 'translationalresearch_authorization_user_management_submit', methods: ['POST'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/AccessRequest/access_request_management.html.twig')]
    ...
    #[Route(path: '/add-authorized-user/', name: 'translationalresearch_add_authorized_user', methods: ['GET'])]
...
//    /**
    ...
    //    }
    #[Route(path: '/generated-users/', name: 'translationalresearch_generated_users', methods: ['GET'])]
...
//        }
     ...
     */
    #[Route(path: '/account-confirmation/{redirectPath}/{specialty}', name: 'translationalresearch_account_confirmation', methods: ['GET', 'POST'])]
