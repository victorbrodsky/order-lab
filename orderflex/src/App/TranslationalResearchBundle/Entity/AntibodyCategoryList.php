...
#[ORM\Table(name: 'transres_antibodycategorytaglist')]
#[ORM\Entity]
class AntibodyCategoryTagList extends ListAbstract
{

    #[ORM\OneToMany(targetEntity: 'AntibodyCategoryTagList', mappedBy: 'original', cascade: ['persist'])]
    protected $synonyms;

    #[ORM\ManyToOne(targetEntity: 'AntibodyCategoryTagList', inversedBy: 'synonyms', cascade: ['persist'])]
