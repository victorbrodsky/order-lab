        ...
        initializeListeners: function() {
            FOS_COMMENT.thread_container.on('submit',
                ...
                function(e) {
                    ...
                    console.log("form.fos_comment_comment_new_form submit");

                    /// added by oleg ivanov ///
                    console.log("form.fos_comment_comment_new_form");
                    var addSubmitBtn = document.getElementById("fos_comment_submit_btn_oleg");
                    console.log(addSubmitBtn);
                    var submitLaddaBtn = Ladda.create( addSubmitBtn );
                    submitLaddaBtn.start();
                    /// EOF added by oleg ivanov ///
