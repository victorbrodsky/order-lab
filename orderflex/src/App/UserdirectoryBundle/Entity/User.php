...
//        return $displayName;
        ...
        //testing
        return $this->getPrimaryPublicUserId();                 //it takes ~15 sec, 3933 DB queries total,
        return (string) $this->getPrimaryUseridKeytypeStr();    //it takes ~15 sec, 3937 DB queries total, 3780 DB queries 'scan_perSiteSettings'
