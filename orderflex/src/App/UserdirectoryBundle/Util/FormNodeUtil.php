...
class FormNodeUtil
{
    ...
    public function __construct(EntityManagerInterface $em, Security $security, ContainerInterface $container, Environment $twig)
    {
        $this->em = $em;
    ...
    public function processFormNodesFromDataKeys( $data, $holderEntity, $testing=false ) {
        ...
        foreach( $formnodeData as $formNodeId => $formValue ) {
            //if( strpos((string)$key, 'formnode-') !== false ) {
                ...
                //$formNodeId = $keyArr[1];
                if( $testing ) {
                    echo "<br>############ formNodeId=" . $formNodeId . ", Value=" . $formValue . " ############<br>";
                }
...
//        }
        ...
        //3) set message by entityName to the created list. For generic fellapp it should be FellowshipApplication
        ...
        if( 1 ) {
            ...
            echo "newListElement list: classNamespace=" . $classNamespace .
                ", className=" . $className .
                ", EntityNamespaceName=".$newListElement->getEntityNamespace() . //for fellapp it should be App\FellAppBundle\Entity
                ", EntityName=".$newListElement->getEntityName() .  //for fellapp it should be FellowshipApplication
                ", EntityId=".$newListElement->getEntityId() .
                ", Value=" . $newListElement->getValue() . "<br>";
...
//TODO: move duplicate functions to FormNodeUtil.php: isFormNodeInArray, getParentFormNodeSection, createParentFormSectionTemplateRecursively
