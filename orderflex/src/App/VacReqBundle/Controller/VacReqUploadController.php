...
class VacReqUploadController extends UploadController {

    #[Route(path: '/file-delete', name: 'vacreq_file_delete', methods: ['GET', 'POST', 'DELETE'])]
     ...
     * $id - document id
     */
    #[Route(path: '/file-download/{id}/{eventtype}', name: 'vacreq_file_download', methods: ['GET'], requirements: ['id' => '\d+'])]
     ...
     * $id - document id
     */
    #[Route(path: '/file-view/{id}/{viewType}/{eventtype}', name: 'vacreq_file_view', methods: ['GET'], requirements: ['id' => '\d+'])]
