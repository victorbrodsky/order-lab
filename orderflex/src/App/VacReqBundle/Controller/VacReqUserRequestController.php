...
class VacReqUserRequestController extends UserRequestController
{
     ...
     *
     * @Route("/account-requests/new", name="vacreq_accountrequest_new", methods={"GET"})
     ...
     *
     * @Route("/account-requests/new", name="vacreq_accountrequest_create", methods={"POST"})
     * @Template("AppUserdirectoryBundle/UserRequest/account_request.html.twig")
     */
     ...
     *
     * @Route("/account-requests", name="vacreq_accountrequest", methods={"GET"})
    ...
    /**
     * @Route("/account-requests/{id}/{status}/status", name="vacreq_accountrequest_status", methods={"GET"}, requirements={"id" = "\d+"})
     * @Template("AppUserdirectoryBundle/UserRequest/index.html.twig")
     */
     ...
     *
     * @Route("/account-requests-approve", name="vacreq_accountrequest_approve", methods={"POST"})
     * @Template("AppUserdirectoryBundle/UserRequest/index.html.twig")
     */
