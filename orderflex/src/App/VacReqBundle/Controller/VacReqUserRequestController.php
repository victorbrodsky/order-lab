...
class VacReqUserRequestController extends UserRequestController
{
     ...
     */
    #[Route(path: '/account-requests/new', name: 'vacreq_accountrequest_new', methods: ['GET'])]
     ...
     */
    #[Route(path: '/account-requests/new', name: 'vacreq_accountrequest_create', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/UserRequest/account_request.html.twig')]
     ...
     */
    #[Route(path: '/account-requests', name: 'vacreq_accountrequest', methods: ['GET'])]
    ...
    #[Route(path: '/account-requests/{id}/{status}/status', name: 'vacreq_accountrequest_status', methods: ['GET'], requirements: ['id' => '\d+'])]
    #[Template('AppUserdirectoryBundle/UserRequest/index.html.twig')]
     ...
     */
    #[Route(path: '/account-requests-approve', name: 'vacreq_accountrequest_approve', methods: ['POST'])]
    #[Template('AppUserdirectoryBundle/UserRequest/index.html.twig')]
