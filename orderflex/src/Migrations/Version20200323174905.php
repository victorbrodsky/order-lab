 ...
 */
final class Version20200323174905 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE crn_crnComplexPatients_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE crn_crnEntryMessage_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE crn_crnentrytagslist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE crn_siteParameter_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE crn_crnComplexPatients (id INT NOT NULL, original_id INT DEFAULT NULL, patient_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_6A1F343A108B7592 ON crn_crnComplexPatients (original_id)');
        $this->processSql('CREATE INDEX IDX_6A1F343A6B899279 ON crn_crnComplexPatients (patient_id)');
        $this->processSql('CREATE INDEX IDX_6A1F343A61220EA6 ON crn_crnComplexPatients (creator_id)');
        $this->processSql('CREATE INDEX IDX_6A1F343AA43E35E8 ON crn_crnComplexPatients (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_6A1F343ABD42F28C ON crn_crnComplexPatients (objectType_id)');
        $this->processSql('COMMENT ON COLUMN crn_crnComplexPatients.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE crn_crnEntryMessage (id INT NOT NULL, sex_id INT DEFAULT NULL, instruction_id INT DEFAULT NULL, addPatientToList BOOLEAN DEFAULT NULL, timeSpentMinutes INT DEFAULT NULL, patientLastNameBackup VARCHAR(255) DEFAULT NULL, patientFirstNameBackup VARCHAR(255) DEFAULT NULL, patientMiddleNameBackup VARCHAR(255) DEFAULT NULL, patientDOBBackup DATE DEFAULT NULL, patientMRNBackup VARCHAR(255) DEFAULT NULL, encounterNumberBackup VARCHAR(255) DEFAULT NULL, processedDate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, patientMRNTypeBackup_id INT DEFAULT NULL, encounterTypeBackup_id INT DEFAULT NULL, encounterDateBackup_id INT DEFAULT NULL, crnTask_id INT DEFAULT NULL, processedByUser_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_DAAD4B22B5A4EC60 ON crn_crnEntryMessage (patientMRNTypeBackup_id)');
        $this->processSql('CREATE INDEX IDX_DAAD4B2299EC81B0 ON crn_crnEntryMessage (encounterTypeBackup_id)');
        $this->processSql('CREATE UNIQUE INDEX UNIQ_DAAD4B229726CFEA ON crn_crnEntryMessage (encounterDateBackup_id)');
        $this->processSql('CREATE INDEX IDX_DAAD4B225A2DB2A0 ON crn_crnEntryMessage (sex_id)');
        $this->processSql('CREATE INDEX IDX_DAAD4B221D0969BB ON crn_crnEntryMessage (crnTask_id)');
        $this->processSql('CREATE INDEX IDX_DAAD4B2262A10F76 ON crn_crnEntryMessage (instruction_id)');
        $this->processSql('CREATE INDEX IDX_DAAD4B22E9CC68A1 ON crn_crnEntryMessage (processedByUser_id)');
        $this->processSql('CREATE TABLE crn_crnentrymessage_document (message_id INT NOT NULL, document_id INT NOT NULL, PRIMARY KEY(message_id, document_id))');
        $this->processSql('CREATE INDEX IDX_3B7768CA537A1329 ON crn_crnentrymessage_document (message_id)');
        $this->processSql('CREATE UNIQUE INDEX UNIQ_3B7768CAC33F7837 ON crn_crnentrymessage_document (document_id)');
        $this->processSql('CREATE TABLE crn_crnentrymessage_patientlist (crnentrymessage_id INT NOT NULL, patientlist_id INT NOT NULL, PRIMARY KEY(crnentrymessage_id, patientlist_id))');
        $this->processSql('CREATE INDEX IDX_11C662E17241C076 ON crn_crnentrymessage_patientlist (crnentrymessage_id)');
        $this->processSql('CREATE INDEX IDX_11C662E1CFD318F2 ON crn_crnentrymessage_patientlist (patientlist_id)');
        $this->processSql('CREATE TABLE crn_crnentrymessage_entrytag (crnentrymessage_id INT NOT NULL, crnentrytagslist_id INT NOT NULL, PRIMARY KEY(crnentrymessage_id, crnentrytagslist_id))');
        $this->processSql('CREATE INDEX IDX_3CE0D94D7241C076 ON crn_crnentrymessage_entrytag (crnentrymessage_id)');
        $this->processSql('CREATE INDEX IDX_3CE0D94D5AB33B8E ON crn_crnentrymessage_entrytag (crnentrytagslist_id)');
        $this->processSql('CREATE TABLE crn_crnentrytagslist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_F148913A108B7592 ON crn_crnentrytagslist (original_id)');
        $this->processSql('CREATE INDEX IDX_F148913A61220EA6 ON crn_crnentrytagslist (creator_id)');
        $this->processSql('CREATE INDEX IDX_F148913AA43E35E8 ON crn_crnentrytagslist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_F148913ABD42F28C ON crn_crnentrytagslist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN crn_crnentrytagslist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE crn_siteParameter (id INT NOT NULL, keytypemrn_id INT DEFAULT NULL, city_id INT DEFAULT NULL, state_id INT DEFAULT NULL, country_id INT DEFAULT NULL, institution_id INT DEFAULT NULL, timezone VARCHAR(255) DEFAULT NULL, county VARCHAR(255) DEFAULT NULL, zip VARCHAR(255) DEFAULT NULL, useCache BOOLEAN DEFAULT NULL, enableDocumentUpload BOOLEAN DEFAULT NULL, defaultAccessionPrefix VARCHAR(255) DEFAULT NULL, showAccession BOOLEAN DEFAULT NULL, showAccessionHome BOOLEAN DEFAULT NULL, messageCategory_id INT DEFAULT NULL, patientList_id INT DEFAULT NULL, defaultAccessionType_id INT DEFAULT NULL, defaultInitialCommunication_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_EA1BE63B702DC596 ON crn_siteParameter (keytypemrn_id)');
        $this->processSql('CREATE INDEX IDX_EA1BE63B3841CED2 ON crn_siteParameter (messageCategory_id)');
        $this->processSql('CREATE INDEX IDX_EA1BE63B8BAC62AF ON crn_siteParameter (city_id)');
        $this->processSql('CREATE INDEX IDX_EA1BE63B5D83CC1 ON crn_siteParameter (state_id)');
        $this->processSql('CREATE INDEX IDX_EA1BE63BF92F3E70 ON crn_siteParameter (country_id)');
        $this->processSql('CREATE INDEX IDX_EA1BE63B6E216E ON crn_siteParameter (patientList_id)');
        $this->processSql('CREATE INDEX IDX_EA1BE63B10405986 ON crn_siteParameter (institution_id)');
        $this->processSql('CREATE INDEX IDX_EA1BE63BF1C351EA ON crn_siteParameter (defaultAccessionType_id)');
        $this->processSql('CREATE INDEX IDX_EA1BE63B7F55BB4B ON crn_siteParameter (defaultInitialCommunication_id)');
        $this->processSql('ALTER TABLE crn_crnComplexPatients ADD CONSTRAINT FK_6A1F343A108B7592 FOREIGN KEY (original_id) REFERENCES crn_crnComplexPatients (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnComplexPatients ADD CONSTRAINT FK_6A1F343A6B899279 FOREIGN KEY (patient_id) REFERENCES scan_patient (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnComplexPatients ADD CONSTRAINT FK_6A1F343A61220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnComplexPatients ADD CONSTRAINT FK_6A1F343AA43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnComplexPatients ADD CONSTRAINT FK_6A1F343ABD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnEntryMessage ADD CONSTRAINT FK_DAAD4B22B5A4EC60 FOREIGN KEY (patientMRNTypeBackup_id) REFERENCES scan_mrntype (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnEntryMessage ADD CONSTRAINT FK_DAAD4B2299EC81B0 FOREIGN KEY (encounterTypeBackup_id) REFERENCES scan_encounterType (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnEntryMessage ADD CONSTRAINT FK_DAAD4B229726CFEA FOREIGN KEY (encounterDateBackup_id) REFERENCES scan_encounterDate (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnEntryMessage ADD CONSTRAINT FK_DAAD4B225A2DB2A0 FOREIGN KEY (sex_id) REFERENCES scan_calllogAttachmentTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnEntryMessage ADD CONSTRAINT FK_DAAD4B221D0969BB FOREIGN KEY (crnTask_id) REFERENCES scan_calllogTask (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnEntryMessage ADD CONSTRAINT FK_DAAD4B2262A10F76 FOREIGN KEY (instruction_id) REFERENCES scan_instruction (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnEntryMessage ADD CONSTRAINT FK_DAAD4B22E9CC68A1 FOREIGN KEY (processedByUser_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnentrymessage_document ADD CONSTRAINT FK_3B7768CA537A1329 FOREIGN KEY (message_id) REFERENCES crn_crnEntryMessage (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnentrymessage_document ADD CONSTRAINT FK_3B7768CAC33F7837 FOREIGN KEY (document_id) REFERENCES user_document (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnentrymessage_patientlist ADD CONSTRAINT FK_11C662E17241C076 FOREIGN KEY (crnentrymessage_id) REFERENCES crn_crnEntryMessage (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnentrymessage_patientlist ADD CONSTRAINT FK_11C662E1CFD318F2 FOREIGN KEY (patientlist_id) REFERENCES scan_patientListHierarchy (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnentrymessage_entrytag ADD CONSTRAINT FK_3CE0D94D7241C076 FOREIGN KEY (crnentrymessage_id) REFERENCES crn_crnEntryMessage (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnentrymessage_entrytag ADD CONSTRAINT FK_3CE0D94D5AB33B8E FOREIGN KEY (crnentrytagslist_id) REFERENCES crn_crnentrytagslist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnentrytagslist ADD CONSTRAINT FK_F148913A108B7592 FOREIGN KEY (original_id) REFERENCES crn_crnentrytagslist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnentrytagslist ADD CONSTRAINT FK_F148913A61220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnentrytagslist ADD CONSTRAINT FK_F148913AA43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crnentrytagslist ADD CONSTRAINT FK_F148913ABD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_siteParameter ADD CONSTRAINT FK_EA1BE63B702DC596 FOREIGN KEY (keytypemrn_id) REFERENCES scan_mrntype (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_siteParameter ADD CONSTRAINT FK_EA1BE63B3841CED2 FOREIGN KEY (messageCategory_id) REFERENCES scan_messageCategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_siteParameter ADD CONSTRAINT FK_EA1BE63B8BAC62AF FOREIGN KEY (city_id) REFERENCES user_cityList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_siteParameter ADD CONSTRAINT FK_EA1BE63B5D83CC1 FOREIGN KEY (state_id) REFERENCES user_states (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_siteParameter ADD CONSTRAINT FK_EA1BE63BF92F3E70 FOREIGN KEY (country_id) REFERENCES user_countries (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_siteParameter ADD CONSTRAINT FK_EA1BE63B6E216E FOREIGN KEY (patientList_id) REFERENCES scan_patientListHierarchy (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_siteParameter ADD CONSTRAINT FK_EA1BE63B10405986 FOREIGN KEY (institution_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_siteParameter ADD CONSTRAINT FK_EA1BE63BF1C351EA FOREIGN KEY (defaultAccessionType_id) REFERENCES scan_accessiontype (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_siteParameter ADD CONSTRAINT FK_EA1BE63B7F55BB4B FOREIGN KEY (defaultInitialCommunication_id) REFERENCES user_healthcareProviderCommunicationList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_calllogentrymessage DROP CONSTRAINT fk_abf319835a2db2a0');
        $this->processSql('DROP INDEX idx_abf319835a2db2a0');
        $this->processSql('ALTER TABLE scan_calllogentrymessage RENAME COLUMN sex_id TO calllogattachmenttype_id');
        $this->processSql('ALTER TABLE scan_calllogentrymessage ADD CONSTRAINT FK_ABF3198329C866F4 FOREIGN KEY (calllogattachmenttype_id) REFERENCES scan_calllogAttachmentTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_ABF3198329C866F4 ON scan_calllogentrymessage (calllogattachmenttype_id)');
        ...
        $this->processSql('ALTER TABLE scan_message ADD crnEntryMessage_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE scan_message ADD CONSTRAINT FK_EC645E41B5D9FD38 FOREIGN KEY (crnEntryMessage_id) REFERENCES crn_crnEntryMessage (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE UNIQUE INDEX UNIQ_EC645E41B5D9FD38 ON scan_message (crnEntryMessage_id)');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD crnuploadpath VARCHAR(255) DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE crn_crnComplexPatients DROP CONSTRAINT FK_6A1F343A108B7592');
        $this->processSql('ALTER TABLE scan_message DROP CONSTRAINT FK_EC645E41B5D9FD38');
        $this->processSql('ALTER TABLE crn_crnentrymessage_document DROP CONSTRAINT FK_3B7768CA537A1329');
        $this->processSql('ALTER TABLE crn_crnentrymessage_patientlist DROP CONSTRAINT FK_11C662E17241C076');
        $this->processSql('ALTER TABLE crn_crnentrymessage_entrytag DROP CONSTRAINT FK_3CE0D94D7241C076');
        $this->processSql('ALTER TABLE crn_crnentrymessage_entrytag DROP CONSTRAINT FK_3CE0D94D5AB33B8E');
        $this->processSql('ALTER TABLE crn_crnentrytagslist DROP CONSTRAINT FK_F148913A108B7592');
        $this->processSql('DROP SEQUENCE crn_crnComplexPatients_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE crn_crnEntryMessage_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE crn_crnentrytagslist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE crn_siteParameter_id_seq CASCADE');
        $this->processSql('DROP TABLE crn_crnComplexPatients');
        $this->processSql('DROP TABLE crn_crnEntryMessage');
        $this->processSql('DROP TABLE crn_crnentrymessage_document');
        $this->processSql('DROP TABLE crn_crnentrymessage_patientlist');
        $this->processSql('DROP TABLE crn_crnentrymessage_entrytag');
        $this->processSql('DROP TABLE crn_crnentrytagslist');
        $this->processSql('DROP TABLE crn_siteParameter');
        ...
        $this->processSql('ALTER TABLE user_siteParameters DROP crnuploadpath');
        ...
        $this->processSql('DROP INDEX UNIQ_EC645E41B5D9FD38');
        $this->processSql('ALTER TABLE scan_message DROP crnEntryMessage_id');
        ...
        $this->processSql('ALTER TABLE scan_calllogEntryMessage DROP CONSTRAINT FK_ABF3198329C866F4');
        $this->processSql('DROP INDEX IDX_ABF3198329C866F4');
        $this->processSql('ALTER TABLE scan_calllogEntryMessage RENAME COLUMN calllogattachmenttype_id TO sex_id');
        $this->processSql('ALTER TABLE scan_calllogEntryMessage ADD CONSTRAINT fk_abf319835a2db2a0 FOREIGN KEY (sex_id) REFERENCES scan_calllogattachmenttypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX idx_abf319835a2db2a0 ON scan_calllogEntryMessage (sex_id)');
