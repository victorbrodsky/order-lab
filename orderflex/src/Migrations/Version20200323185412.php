 ...
 */
final class Version20200323185412 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD crnSiteParameter_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD CONSTRAINT FK_9DD431FC6DF38E1 FOREIGN KEY (crnSiteParameter_id) REFERENCES crn_siteParameter (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE UNIQUE INDEX UNIQ_9DD431FC6DF38E1 ON user_siteparameters (crnSiteParameter_id)');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE crn_siteparameter ADD crnResource TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE crn_siteParameter DROP crnResource');
        $this->processSql('ALTER TABLE user_siteParameters DROP CONSTRAINT FK_9DD431FC6DF38E1');
        $this->processSql('DROP INDEX UNIQ_9DD431FC6DF38E1');
        $this->processSql('ALTER TABLE user_siteParameters DROP crnSiteParameter_id');
