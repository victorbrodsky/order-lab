 ...
 */
final class Version20200324172139 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE crn_crntask_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE crn_crntask (id INT NOT NULL, description TEXT DEFAULT NULL, systemStatus VARCHAR(255) DEFAULT NULL, status BOOLEAN DEFAULT NULL, createdDate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedDate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, statusUpdatedDate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, crnEntryMessage_id INT DEFAULT NULL, crnTaskType_id INT DEFAULT NULL, createdBy_id INT DEFAULT NULL, updatedBy_id INT DEFAULT NULL, statusUpdatedBy_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_E126988BB5D9FD38 ON crn_crntask (crnEntryMessage_id)');
        $this->processSql('CREATE INDEX IDX_E126988B1FBC4D88 ON crn_crntask (crnTaskType_id)');
        $this->processSql('CREATE INDEX IDX_E126988B3174800F ON crn_crntask (createdBy_id)');
        $this->processSql('CREATE INDEX IDX_E126988B65FF1AEC ON crn_crntask (updatedBy_id)');
        $this->processSql('CREATE INDEX IDX_E126988B27A9061B ON crn_crntask (statusUpdatedBy_id)');
        $this->processSql('ALTER TABLE crn_crntask ADD CONSTRAINT FK_E126988BB5D9FD38 FOREIGN KEY (crnEntryMessage_id) REFERENCES crn_crnEntryMessage (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crntask ADD CONSTRAINT FK_E126988B1FBC4D88 FOREIGN KEY (crnTaskType_id) REFERENCES scan_calllogTaskTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crntask ADD CONSTRAINT FK_E126988B3174800F FOREIGN KEY (createdBy_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crntask ADD CONSTRAINT FK_E126988B65FF1AEC FOREIGN KEY (updatedBy_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE crn_crntask ADD CONSTRAINT FK_E126988B27A9061B FOREIGN KEY (statusUpdatedBy_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE crn_crnentrymessage DROP CONSTRAINT fk_daad4b221d0969bb');
        $this->processSql('DROP INDEX idx_daad4b221d0969bb');
        $this->processSql('ALTER TABLE crn_crnentrymessage DROP crntask_id');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP SEQUENCE crn_crntask_id_seq CASCADE');
        $this->processSql('DROP TABLE crn_crntask');
        ...
        $this->processSql('ALTER TABLE crn_crnEntryMessage ADD crntask_id INT DEFAULT NULL');
