 ...
 */
final class Version20200325205154 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_adminreview ADD id SERIAL NOT NULL');
        $this->processSql('ALTER TABLE transres_adminreview ADD PRIMARY KEY (id)');
        $this->processSql('DROP INDEX "primary"');
        $this->processSql('ALTER TABLE transres_antibody_document ADD PRIMARY KEY (request_id, document_id)');
        $this->processSql('ALTER TABLE transres_committeereview ADD id SERIAL NOT NULL');
        $this->processSql('ALTER TABLE transres_committeereview ADD PRIMARY KEY (id)');
        $this->processSql('ALTER TABLE transres_finalreview ADD id SERIAL NOT NULL');
        $this->processSql('ALTER TABLE transres_finalreview ADD PRIMARY KEY (id)');
        $this->processSql('DROP INDEX "primary"');
        $this->processSql('ALTER TABLE transres_invoice_document ADD PRIMARY KEY (invoice_id, document_id)');
        $this->processSql('ALTER TABLE transres_irbreview ADD id SERIAL NOT NULL');
        $this->processSql('ALTER TABLE transres_irbreview ADD PRIMARY KEY (id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP INDEX "primary"');
        $this->processSql('ALTER TABLE transres_adminReview DROP id');
        $this->processSql('DROP INDEX "primary"');
        $this->processSql('ALTER TABLE transres_committeeReview DROP id');
        ...
        $this->processSql('DROP INDEX "primary"');
        $this->processSql('ALTER TABLE transres_irbReview DROP id');
        $this->processSql('DROP INDEX "primary"');
        $this->processSql('ALTER TABLE transres_finalReview DROP id');
