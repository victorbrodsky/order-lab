 ...
 */
final class Version20200327131212 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE crn_crnentrymessage DROP CONSTRAINT fk_daad4b225a2db2a0');
        $this->processSql('DROP INDEX idx_daad4b225a2db2a0');
        $this->processSql('ALTER TABLE crn_crnentrymessage RENAME COLUMN sex_id TO crnattachmenttype_id');
        $this->processSql('ALTER TABLE crn_crnentrymessage ADD CONSTRAINT FK_DAAD4B22CA70C7DB FOREIGN KEY (crnattachmenttype_id) REFERENCES scan_calllogAttachmentTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_DAAD4B22CA70C7DB ON crn_crnentrymessage (crnattachmenttype_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE crn_crnEntryMessage DROP CONSTRAINT FK_DAAD4B22CA70C7DB');
        $this->processSql('DROP INDEX IDX_DAAD4B22CA70C7DB');
        $this->processSql('ALTER TABLE crn_crnEntryMessage RENAME COLUMN crnattachmenttype_id TO sex_id');
