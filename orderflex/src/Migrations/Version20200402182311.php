 ...
 */
final class Version20200402182311 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE scan_messagetagslist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE scan_messagetagtypeslist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE scan_message_tag (message_id INT NOT NULL, tag_id INT NOT NULL, PRIMARY KEY(message_id, tag_id))');
        $this->processSql('CREATE INDEX IDX_A345926B537A1329 ON scan_message_tag (message_id)');
        $this->processSql('CREATE INDEX IDX_A345926BBAD26311 ON scan_message_tag (tag_id)');
        $this->processSql('CREATE TABLE scan_messagetagslist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_466AB2A0108B7592 ON scan_messagetagslist (original_id)');
        $this->processSql('CREATE INDEX IDX_466AB2A061220EA6 ON scan_messagetagslist (creator_id)');
        $this->processSql('CREATE INDEX IDX_466AB2A0A43E35E8 ON scan_messagetagslist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_466AB2A0BD42F28C ON scan_messagetagslist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN scan_messagetagslist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE scan_tag_type (messagetagslist_id INT NOT NULL, messagetagtypeslist_id INT NOT NULL, PRIMARY KEY(messagetagslist_id, messagetagtypeslist_id))');
        $this->processSql('CREATE INDEX IDX_A3EA2C5ADDD90DF ON scan_tag_type (messagetagslist_id)');
        $this->processSql('CREATE INDEX IDX_A3EA2C5A7BCCCFBE ON scan_tag_type (messagetagtypeslist_id)');
        $this->processSql('CREATE TABLE scan_messagetagtypeslist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_A071AE6108B7592 ON scan_messagetagtypeslist (original_id)');
        $this->processSql('CREATE INDEX IDX_A071AE661220EA6 ON scan_messagetagtypeslist (creator_id)');
        $this->processSql('CREATE INDEX IDX_A071AE6A43E35E8 ON scan_messagetagtypeslist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_A071AE6BD42F28C ON scan_messagetagtypeslist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN scan_messagetagtypeslist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE scan_message_tag ADD CONSTRAINT FK_A345926B537A1329 FOREIGN KEY (message_id) REFERENCES scan_message (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_message_tag ADD CONSTRAINT FK_A345926BBAD26311 FOREIGN KEY (tag_id) REFERENCES scan_messagetagslist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_messagetagslist ADD CONSTRAINT FK_466AB2A0108B7592 FOREIGN KEY (original_id) REFERENCES scan_messagetagslist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_messagetagslist ADD CONSTRAINT FK_466AB2A061220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_messagetagslist ADD CONSTRAINT FK_466AB2A0A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_messagetagslist ADD CONSTRAINT FK_466AB2A0BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_tag_type ADD CONSTRAINT FK_A3EA2C5ADDD90DF FOREIGN KEY (messagetagslist_id) REFERENCES scan_messagetagslist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_tag_type ADD CONSTRAINT FK_A3EA2C5A7BCCCFBE FOREIGN KEY (messagetagtypeslist_id) REFERENCES scan_messagetagtypeslist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_messagetagtypeslist ADD CONSTRAINT FK_A071AE6108B7592 FOREIGN KEY (original_id) REFERENCES scan_messagetagtypeslist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_messagetagtypeslist ADD CONSTRAINT FK_A071AE661220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_messagetagtypeslist ADD CONSTRAINT FK_A071AE6A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_messagetagtypeslist ADD CONSTRAINT FK_A071AE6BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE scan_message_tag DROP CONSTRAINT FK_A345926BBAD26311');
        $this->processSql('ALTER TABLE scan_messagetagslist DROP CONSTRAINT FK_466AB2A0108B7592');
        $this->processSql('ALTER TABLE scan_tag_type DROP CONSTRAINT FK_A3EA2C5ADDD90DF');
        $this->processSql('ALTER TABLE scan_tag_type DROP CONSTRAINT FK_A3EA2C5A7BCCCFBE');
        $this->processSql('ALTER TABLE scan_messagetagtypeslist DROP CONSTRAINT FK_A071AE6108B7592');
        $this->processSql('DROP SEQUENCE scan_messagetagslist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE scan_messagetagtypeslist_id_seq CASCADE');
        $this->processSql('DROP TABLE scan_message_tag');
        $this->processSql('DROP TABLE scan_messagetagslist');
        $this->processSql('DROP TABLE scan_tag_type');
        $this->processSql('DROP TABLE scan_messagetagtypeslist');
