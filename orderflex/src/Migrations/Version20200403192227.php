 ...
 */
final class Version20200403192227 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteparameters ADD enableNewProjectOnSelector BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD enableNewProjectOnNavbar BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD enableNewProjectAccessPage BOOLEAN DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteParameters DROP enableNewProjectOnSelector');
        $this->processSql('ALTER TABLE transres_siteParameters DROP enableNewProjectOnNavbar');
        $this->processSql('ALTER TABLE transres_siteParameters DROP enableNewProjectAccessPage');
