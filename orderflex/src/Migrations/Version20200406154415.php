 ...
 */
final class Version20200406154415 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE user_admincomment_id_seq');
        $this->processSql('SELECT setval(\'user_admincomment_id_seq\', (SELECT MAX(id) FROM user_admincomment))');
        $this->processSql('ALTER TABLE user_admincomment ALTER id SET DEFAULT nextval(\'user_admincomment_id_seq\')');
        $this->processSql('CREATE SEQUENCE user_administrativetitle_id_seq');
        $this->processSql('SELECT setval(\'user_administrativetitle_id_seq\', (SELECT MAX(id) FROM user_administrativetitle))');
        $this->processSql('ALTER TABLE user_administrativetitle ALTER id SET DEFAULT nextval(\'user_administrativetitle_id_seq\')');
        $this->processSql('ALTER INDEX idx_465c3939834995b1 RENAME TO IDX_BF2A5B6F834995B1');
        $this->processSql('CREATE SEQUENCE user_appointmenttitle_id_seq');
        $this->processSql('SELECT setval(\'user_appointmenttitle_id_seq\', (SELECT MAX(id) FROM user_appointmenttitle))');
        $this->processSql('ALTER TABLE user_appointmenttitle ALTER id SET DEFAULT nextval(\'user_appointmenttitle_id_seq\')');
        $this->processSql('CREATE SEQUENCE user_book_id_seq');
        $this->processSql('SELECT setval(\'user_book_id_seq\', (SELECT MAX(id) FROM user_book))');
        $this->processSql('ALTER TABLE user_book ALTER id SET DEFAULT nextval(\'user_book_id_seq\')');
        $this->processSql('CREATE SEQUENCE user_confidentialcomment_id_seq');
        $this->processSql('SELECT setval(\'user_confidentialcomment_id_seq\', (SELECT MAX(id) FROM user_confidentialcomment))');
        $this->processSql('ALTER TABLE user_confidentialcomment ALTER id SET DEFAULT nextval(\'user_confidentialcomment_id_seq\')');
        $this->processSql('CREATE SEQUENCE user_credentials_id_seq');
        $this->processSql('SELECT setval(\'user_credentials_id_seq\', (SELECT MAX(id) FROM user_credentials))');
        $this->processSql('ALTER TABLE user_credentials ALTER id SET DEFAULT nextval(\'user_credentials_id_seq\')');
        $this->processSql('CREATE SEQUENCE user_documentcomment_id_seq');
        $this->processSql('SELECT setval(\'user_documentcomment_id_seq\', (SELECT MAX(id) FROM user_documentcomment))');
        $this->processSql('ALTER TABLE user_documentcomment ALTER id SET DEFAULT nextval(\'user_documentcomment_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
        $this->processSql('ALTER TABLE user_documentcontainer_document ADD PRIMARY KEY (documentcontainer_id, document_id)');
        $this->processSql('CREATE SEQUENCE user_employmentstatus_id_seq');
        $this->processSql('SELECT setval(\'user_employmentstatus_id_seq\', (SELECT MAX(id) FROM user_employmentstatus))');
        $this->processSql('ALTER TABLE user_employmentstatus ALTER id SET DEFAULT nextval(\'user_employmentstatus_id_seq\')');
        ...
        $this->processSql('CREATE SEQUENCE user_lecture_id_seq');
        $this->processSql('SELECT setval(\'user_lecture_id_seq\', (SELECT MAX(id) FROM user_lecture))');
        $this->processSql('ALTER TABLE user_lecture ALTER id SET DEFAULT nextval(\'user_lecture_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('CREATE SEQUENCE user_medicaltitle_id_seq');
        $this->processSql('SELECT setval(\'user_medicaltitle_id_seq\', (SELECT MAX(id) FROM user_medicaltitle))');
        $this->processSql('ALTER TABLE user_medicaltitle ALTER id SET DEFAULT nextval(\'user_medicaltitle_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('CREATE SEQUENCE scan_persitesettings_id_seq');
        $this->processSql('SELECT setval(\'scan_persitesettings_id_seq\', (SELECT MAX(id) FROM scan_persitesettings))');
        $this->processSql('ALTER TABLE scan_persitesettings ALTER id SET DEFAULT nextval(\'scan_persitesettings_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('CREATE SEQUENCE user_privatecomment_id_seq');
        $this->processSql('SELECT setval(\'user_privatecomment_id_seq\', (SELECT MAX(id) FROM user_privatecomment))');
        $this->processSql('ALTER TABLE user_privatecomment ALTER id SET DEFAULT nextval(\'user_privatecomment_id_seq\')');
        $this->processSql('CREATE SEQUENCE user_publication_id_seq');
        $this->processSql('SELECT setval(\'user_publication_id_seq\', (SELECT MAX(id) FROM user_publication))');
        $this->processSql('ALTER TABLE user_publication ALTER id SET DEFAULT nextval(\'user_publication_id_seq\')');
        $this->processSql('CREATE SEQUENCE user_publiccomment_id_seq');
        $this->processSql('SELECT setval(\'user_publiccomment_id_seq\', (SELECT MAX(id) FROM user_publiccomment))');
        $this->processSql('ALTER TABLE user_publiccomment ALTER id SET DEFAULT nextval(\'user_publiccomment_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('CREATE SEQUENCE user_training_id_seq');
        $this->processSql('SELECT setval(\'user_training_id_seq\', (SELECT MAX(id) FROM user_training))');
        $this->processSql('ALTER TABLE user_training ALTER id SET DEFAULT nextval(\'user_training_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('CREATE SEQUENCE user_userinfo_id_seq');
        $this->processSql('SELECT setval(\'user_userinfo_id_seq\', (SELECT MAX(id) FROM user_userinfo))');
        $this->processSql('ALTER TABLE user_userinfo ALTER id SET DEFAULT nextval(\'user_userinfo_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('CREATE SEQUENCE fellapp_fellowshipapplication_id_seq');
        $this->processSql('SELECT setval(\'fellapp_fellowshipapplication_id_seq\', (SELECT MAX(id) FROM fellapp_fellowshipapplication))');
        $this->processSql('ALTER TABLE fellapp_fellowshipapplication ALTER id SET DEFAULT nextval(\'fellapp_fellowshipapplication_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_fellowshipApplication ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE scan_perSiteSettings ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE user_administrativeTitle ALTER id DROP DEFAULT');
        $this->processSql('ALTER INDEX idx_bf2a5b6f834995b1 RENAME TO IDX_465C3939834995B1');
        $this->processSql('ALTER TABLE user_adminComment ALTER id DROP DEFAULT');
        $this->processSql('ALTER TABLE user_appointmentTitle ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE user_book ALTER id DROP DEFAULT');
        $this->processSql('ALTER TABLE user_credentials ALTER id DROP DEFAULT');
        $this->processSql('ALTER TABLE user_confidentialComment ALTER id DROP DEFAULT');
        $this->processSql('ALTER TABLE user_documentComment ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE user_employmentStatus ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE user_lecture ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE user_medicalTitle ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE user_privateComment ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE user_publication ALTER id DROP DEFAULT');
        $this->processSql('ALTER TABLE user_publicComment ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE user_training ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE user_userInfo ALTER id DROP DEFAULT');
