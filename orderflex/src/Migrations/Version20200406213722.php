 ...
 */
final class Version20200406213722 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE transres_adminreview_id_seq');
        $this->processSql('SELECT setval(\'transres_adminreview_id_seq\', (SELECT MAX(id) FROM transres_adminreview))');
        $this->processSql('ALTER TABLE transres_adminreview ALTER id SET DEFAULT nextval(\'transres_adminreview_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
        $this->processSql('ALTER TABLE transres_antibody_document ADD PRIMARY KEY (request_id, document_id)');
        $this->processSql('CREATE SEQUENCE transres_committeereview_id_seq');
        $this->processSql('SELECT setval(\'transres_committeereview_id_seq\', (SELECT MAX(id) FROM transres_committeereview))');
        $this->processSql('ALTER TABLE transres_committeereview ALTER id SET DEFAULT nextval(\'transres_committeereview_id_seq\')');
        $this->processSql('CREATE SEQUENCE transres_finalreview_id_seq');
        $this->processSql('SELECT setval(\'transres_finalreview_id_seq\', (SELECT MAX(id) FROM transres_finalreview))');
        $this->processSql('ALTER TABLE transres_finalreview ALTER id SET DEFAULT nextval(\'transres_finalreview_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
        $this->processSql('ALTER TABLE transres_invoice_document ADD PRIMARY KEY (invoice_id, document_id)');
        $this->processSql('CREATE SEQUENCE transres_irbreview_id_seq');
        $this->processSql('SELECT setval(\'transres_irbreview_id_seq\', (SELECT MAX(id) FROM transres_irbreview))');
        $this->processSql('ALTER TABLE transres_irbreview ALTER id SET DEFAULT nextval(\'transres_irbreview_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_adminReview ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE transres_finalReview ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE transres_committeeReview ALTER id DROP DEFAULT');
        $this->processSql('ALTER TABLE transres_irbReview ALTER id DROP DEFAULT');
