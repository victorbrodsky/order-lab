 ...
 */
final class Version20200408193140 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE calllog_siteparameter ADD defaultTagType_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE calllog_siteparameter ADD CONSTRAINT FK_1F4E90E0892091CA FOREIGN KEY (defaultTagType_id) REFERENCES scan_messagetagtypeslist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_1F4E90E0892091CA ON calllog_siteparameter (defaultTagType_id)');
        $this->processSql('ALTER TABLE crn_siteparameter ADD defaultTagType_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE crn_siteparameter ADD CONSTRAINT FK_EA1BE63B892091CA FOREIGN KEY (defaultTagType_id) REFERENCES scan_messagetagtypeslist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_EA1BE63B892091CA ON crn_siteparameter (defaultTagType_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE calllog_siteParameter DROP CONSTRAINT FK_1F4E90E0892091CA');
        $this->processSql('DROP INDEX IDX_1F4E90E0892091CA');
        $this->processSql('ALTER TABLE calllog_siteParameter DROP defaultTagType_id');
        $this->processSql('ALTER INDEX siteparameters_unique RENAME TO siteparameters_unique00000');
        $this->processSql('ALTER TABLE crn_siteParameter DROP CONSTRAINT FK_EA1BE63B892091CA');
        $this->processSql('DROP INDEX IDX_EA1BE63B892091CA');
        $this->processSql('ALTER TABLE crn_siteParameter DROP defaultTagType_id');
