 ...
 */
final class Version20200415194051 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE scan_accessionlisthierarchy_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE scan_accessionlisthierarchygrouptype_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE scan_accessionlisthierarchy (id INT NOT NULL, parent_id INT DEFAULT NULL, original_id INT DEFAULT NULL, accession_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, lft INT NOT NULL, rgt INT NOT NULL, level INT NOT NULL, root INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, organizationalGroupType_id INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_AA4EF62E727ACA70 ON scan_accessionlisthierarchy (parent_id)');
        $this->processSql('CREATE INDEX IDX_AA4EF62E108B7592 ON scan_accessionlisthierarchy (original_id)');
        $this->processSql('CREATE INDEX IDX_AA4EF62EA5A05448 ON scan_accessionlisthierarchy (organizationalGroupType_id)');
        $this->processSql('CREATE INDEX IDX_AA4EF62EA40F1370 ON scan_accessionlisthierarchy (accession_id)');
        $this->processSql('CREATE INDEX IDX_AA4EF62E61220EA6 ON scan_accessionlisthierarchy (creator_id)');
        $this->processSql('CREATE INDEX IDX_AA4EF62EA43E35E8 ON scan_accessionlisthierarchy (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_AA4EF62EBD42F28C ON scan_accessionlisthierarchy (objectType_id)');
        $this->processSql('COMMENT ON COLUMN scan_accessionlisthierarchy.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE scan_accessionlisthierarchygrouptype (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, level INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_9DA3DEFA108B7592 ON scan_accessionlisthierarchygrouptype (original_id)');
        $this->processSql('CREATE INDEX IDX_9DA3DEFA61220EA6 ON scan_accessionlisthierarchygrouptype (creator_id)');
        $this->processSql('CREATE INDEX IDX_9DA3DEFAA43E35E8 ON scan_accessionlisthierarchygrouptype (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_9DA3DEFABD42F28C ON scan_accessionlisthierarchygrouptype (objectType_id)');
        $this->processSql('COMMENT ON COLUMN scan_accessionlisthierarchygrouptype.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE scan_message_accessionlist (message_id INT NOT NULL, accessionlist_id INT NOT NULL, PRIMARY KEY(message_id, accessionlist_id))');
        $this->processSql('CREATE INDEX IDX_B427FC21537A1329 ON scan_message_accessionlist (message_id)');
        $this->processSql('CREATE INDEX IDX_B427FC21342EC623 ON scan_message_accessionlist (accessionlist_id)');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchy ADD CONSTRAINT FK_AA4EF62E727ACA70 FOREIGN KEY (parent_id) REFERENCES scan_accessionlisthierarchy (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchy ADD CONSTRAINT FK_AA4EF62E108B7592 FOREIGN KEY (original_id) REFERENCES scan_accessionlisthierarchy (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchy ADD CONSTRAINT FK_AA4EF62EA5A05448 FOREIGN KEY (organizationalGroupType_id) REFERENCES scan_accessionlisthierarchygrouptype (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchy ADD CONSTRAINT FK_AA4EF62EA40F1370 FOREIGN KEY (accession_id) REFERENCES scan_accession (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchy ADD CONSTRAINT FK_AA4EF62E61220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchy ADD CONSTRAINT FK_AA4EF62EA43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchy ADD CONSTRAINT FK_AA4EF62EBD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchygrouptype ADD CONSTRAINT FK_9DA3DEFA108B7592 FOREIGN KEY (original_id) REFERENCES scan_accessionlisthierarchygrouptype (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchygrouptype ADD CONSTRAINT FK_9DA3DEFA61220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchygrouptype ADD CONSTRAINT FK_9DA3DEFAA43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchygrouptype ADD CONSTRAINT FK_9DA3DEFABD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_message_accessionlist ADD CONSTRAINT FK_B427FC21537A1329 FOREIGN KEY (message_id) REFERENCES scan_message (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_message_accessionlist ADD CONSTRAINT FK_B427FC21342EC623 FOREIGN KEY (accessionlist_id) REFERENCES scan_accessionlisthierarchy (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE scan_message ADD addAccessionToList BOOLEAN DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE scan_accessionlisthierarchy DROP CONSTRAINT FK_AA4EF62E727ACA70');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchy DROP CONSTRAINT FK_AA4EF62E108B7592');
        $this->processSql('ALTER TABLE scan_message_accessionlist DROP CONSTRAINT FK_B427FC21342EC623');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchy DROP CONSTRAINT FK_AA4EF62EA5A05448');
        $this->processSql('ALTER TABLE scan_accessionlisthierarchygrouptype DROP CONSTRAINT FK_9DA3DEFA108B7592');
        $this->processSql('DROP SEQUENCE scan_accessionlisthierarchy_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE scan_accessionlisthierarchygrouptype_id_seq CASCADE');
        $this->processSql('DROP TABLE scan_accessionlisthierarchy');
        $this->processSql('DROP TABLE scan_accessionlisthierarchygrouptype');
        $this->processSql('DROP TABLE scan_message_accessionlist');
        ...
        $this->processSql('ALTER TABLE scan_message DROP addAccessionToList');
