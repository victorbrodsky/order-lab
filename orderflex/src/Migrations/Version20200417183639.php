 ...
 */
final class Version20200417183639 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE scan_accessionlisttype_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE scan_accessionlist_accessiontype (accessionlist_id INT NOT NULL, accessiontype_id INT NOT NULL, PRIMARY KEY(accessionlist_id, accessiontype_id))');
        $this->processSql('CREATE INDEX IDX_BB247661342EC623 ON scan_accessionlist_accessiontype (accessionlist_id)');
        $this->processSql('CREATE INDEX IDX_BB247661CCCC5C3B ON scan_accessionlist_accessiontype (accessiontype_id)');
        $this->processSql('CREATE TABLE scan_accessionlisttype (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_745E4A87108B7592 ON scan_accessionlisttype (original_id)');
        $this->processSql('CREATE INDEX IDX_745E4A8761220EA6 ON scan_accessionlisttype (creator_id)');
        $this->processSql('CREATE INDEX IDX_745E4A87A43E35E8 ON scan_accessionlisttype (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_745E4A87BD42F28C ON scan_accessionlisttype (objectType_id)');
        $this->processSql('COMMENT ON COLUMN scan_accessionlisttype.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE scan_accessionlist_accessiontype ADD CONSTRAINT FK_BB247661342EC623 FOREIGN KEY (accessionlist_id) REFERENCES scan_accessionlisthierarchy (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlist_accessiontype ADD CONSTRAINT FK_BB247661CCCC5C3B FOREIGN KEY (accessiontype_id) REFERENCES scan_accessionlisttype (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisttype ADD CONSTRAINT FK_745E4A87108B7592 FOREIGN KEY (original_id) REFERENCES scan_accessionlisttype (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisttype ADD CONSTRAINT FK_745E4A8761220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisttype ADD CONSTRAINT FK_745E4A87A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE scan_accessionlisttype ADD CONSTRAINT FK_745E4A87BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE scan_accessionlist_accessiontype DROP CONSTRAINT FK_BB247661CCCC5C3B');
        $this->processSql('ALTER TABLE scan_accessionlisttype DROP CONSTRAINT FK_745E4A87108B7592');
        $this->processSql('DROP SEQUENCE scan_accessionlisttype_id_seq CASCADE');
        $this->processSql('DROP TABLE scan_accessionlist_accessiontype');
        $this->processSql('DROP TABLE scan_accessionlisttype');
