 ...
 */
final class Version20200430162706 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_roles ADD residencySubspecialty_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_roles ADD CONSTRAINT FK_54FCD59FDCC839AF FOREIGN KEY (residencySubspecialty_id) REFERENCES user_residencySpecialty (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_54FCD59FDCC839AF ON user_roles (residencySubspecialty_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_roles DROP CONSTRAINT FK_54FCD59FDCC839AF');
        $this->processSql('DROP INDEX IDX_54FCD59FDCC839AF');
        $this->processSql('ALTER TABLE user_roles DROP residencySubspecialty_id');
