 ...
 */
final class Version20200501155343 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE user_residencyspecialty_coordinator (residencyspecialty_id INT NOT NULL, coordinator_id INT NOT NULL, PRIMARY KEY(residencyspecialty_id, coordinator_id))');
        $this->processSql('CREATE INDEX IDX_F89F27308D563D32 ON user_residencyspecialty_coordinator (residencyspecialty_id)');
        $this->processSql('CREATE INDEX IDX_F89F2730E7877946 ON user_residencyspecialty_coordinator (coordinator_id)');
        $this->processSql('CREATE TABLE user_residencyspecialty_director (residencyspecialty_id INT NOT NULL, director_id INT NOT NULL, PRIMARY KEY(residencyspecialty_id, director_id))');
        $this->processSql('CREATE INDEX IDX_E2238D3E8D563D32 ON user_residencyspecialty_director (residencyspecialty_id)');
        $this->processSql('CREATE INDEX IDX_E2238D3E899FB366 ON user_residencyspecialty_director (director_id)');
        $this->processSql('CREATE TABLE user_residencyspecialty_interviewer (residencyspecialty_id INT NOT NULL, interviewer_id INT NOT NULL, PRIMARY KEY(residencyspecialty_id, interviewer_id))');
        $this->processSql('CREATE INDEX IDX_9E7CF43A8D563D32 ON user_residencyspecialty_interviewer (residencyspecialty_id)');
        $this->processSql('CREATE INDEX IDX_9E7CF43A7906D9E8 ON user_residencyspecialty_interviewer (interviewer_id)');
        $this->processSql('ALTER TABLE user_residencyspecialty_coordinator ADD CONSTRAINT FK_F89F27308D563D32 FOREIGN KEY (residencyspecialty_id) REFERENCES user_residencySpecialty (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_residencyspecialty_coordinator ADD CONSTRAINT FK_F89F2730E7877946 FOREIGN KEY (coordinator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_residencyspecialty_director ADD CONSTRAINT FK_E2238D3E8D563D32 FOREIGN KEY (residencyspecialty_id) REFERENCES user_residencySpecialty (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_residencyspecialty_director ADD CONSTRAINT FK_E2238D3E899FB366 FOREIGN KEY (director_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_residencyspecialty_interviewer ADD CONSTRAINT FK_9E7CF43A8D563D32 FOREIGN KEY (residencyspecialty_id) REFERENCES user_residencySpecialty (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_residencyspecialty_interviewer ADD CONSTRAINT FK_9E7CF43A7906D9E8 FOREIGN KEY (interviewer_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE user_residencyspecialty ADD institution_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_residencyspecialty ADD CONSTRAINT FK_4270807B10405986 FOREIGN KEY (institution_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_4270807B10405986 ON user_residencyspecialty (institution_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP TABLE user_residencyspecialty_coordinator');
        $this->processSql('DROP TABLE user_residencyspecialty_director');
        $this->processSql('DROP TABLE user_residencyspecialty_interviewer');
        ...
        $this->processSql('ALTER TABLE user_residencySpecialty DROP CONSTRAINT FK_4270807B10405986');
        $this->processSql('DROP INDEX IDX_4270807B10405986');
        $this->processSql('ALTER TABLE user_residencySpecialty DROP institution_id');
