 ...
 */
final class Version20200507180134 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_siteparameter ADD confirmationSubjectFellApp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_siteparameter ADD confirmationBodyFellApp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_siteparameter ADD confirmationEmailFellApp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_siteparameter ADD localInstitutionResApp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_siteparameter ADD spreadsheetsPathResApp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_siteparameter ADD applicantsUploadPathResApp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_siteparameter ADD reportsUploadPathResApp TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_siteparameter DROP confirmationSubjectFellApp');
        $this->processSql('ALTER TABLE resapp_siteparameter DROP confirmationBodyFellApp');
        $this->processSql('ALTER TABLE resapp_siteparameter DROP confirmationEmailFellApp');
        $this->processSql('ALTER TABLE resapp_siteparameter DROP localInstitutionResApp');
        $this->processSql('ALTER TABLE resapp_siteparameter DROP spreadsheetsPathResApp');
        $this->processSql('ALTER TABLE resapp_siteparameter DROP applicantsUploadPathResApp');
        $this->processSql('ALTER TABLE resapp_siteparameter DROP reportsUploadPathResApp');
