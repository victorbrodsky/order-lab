 ...
 */
final class Version20200508172131 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE vacreq_siteparameter_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE vacreq_siteparameter (id INT NOT NULL, academicYearStart DATE DEFAULT NULL, academicYearEnd DATE DEFAULT NULL, holidaysUrl TEXT DEFAULT NULL, vacationAccruedDaysPerMonth INT DEFAULT NULL, maxVacationDays INT DEFAULT NULL, maxCarryOverVacationDays INT DEFAULT NULL, noteForVacationDays TEXT DEFAULT NULL, noteForCarryOverDays TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD vacreqSiteParameter_id INT DEFAULT NULL');
        ...
        $this->processSql('CREATE UNIQUE INDEX UNIQ_9DD431F8B89F04D ON user_siteparameters (vacreqSiteParameter_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP SEQUENCE vacreq_siteparameter_id_seq CASCADE');
        $this->processSql('DROP TABLE vacreq_siteparameter');
        ...
        $this->processSql('DROP INDEX UNIQ_9DD431F8B89F04D');
        $this->processSql('ALTER TABLE user_siteParameters DROP vacreqSiteParameter_id');
