 ...
 */
final class Version20200508204527 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP CONSTRAINT FK_9DD431F8B89F04D');
        $this->processSql('ALTER TABLE user_siteparameters ADD CONSTRAINT FK_9DD431F8B89F04D FOREIGN KEY (vacreqSiteParameter_id) REFERENCES vacreq_siteparameter (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_siteParameters DROP CONSTRAINT fk_9dd431f8b89f04d');
        $this->processSql('ALTER TABLE user_siteParameters ADD CONSTRAINT fk_9dd431f8b89f04d FOREIGN KEY (vacreqsiteparameter_id) REFERENCES crn_siteparameter (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
