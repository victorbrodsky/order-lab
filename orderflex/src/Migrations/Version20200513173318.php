 ...
 */
final class Version20200513173318 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteparameters ADD humanTissueFormNote TEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteParameters DROP humanTissueFormNote');
