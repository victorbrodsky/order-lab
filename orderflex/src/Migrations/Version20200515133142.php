 ...
 */
final class Version20200515133142 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE user_telephonysiteparameter_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE user_telephonysiteparameter (id INT NOT NULL, twilioApiKey VARCHAR(255) DEFAULT NULL, phoneNumberVerification BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD telephonySiteParameter_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD CONSTRAINT FK_9DD431F1C4885F6 FOREIGN KEY (telephonySiteParameter_id) REFERENCES user_telephonysiteparameter (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE UNIQUE INDEX UNIQ_9DD431F1C4885F6 ON user_siteparameters (telephonySiteParameter_id)');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_userinfo ADD preferredMobilePhone VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE user_userinfo ADD preferredMobilePhoneVerified BOOLEAN DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_siteParameters DROP CONSTRAINT FK_9DD431F1C4885F6');
        $this->processSql('DROP SEQUENCE user_telephonysiteparameter_id_seq CASCADE');
        $this->processSql('DROP TABLE user_telephonysiteparameter');
        ...
        $this->processSql('ALTER TABLE user_userInfo DROP preferredMobilePhone');
        $this->processSql('ALTER TABLE user_userInfo DROP preferredMobilePhoneVerified');
        ...
        $this->processSql('DROP INDEX UNIQ_9DD431F1C4885F6');
        $this->processSql('ALTER TABLE user_siteParameters DROP telephonySiteParameter_id');
