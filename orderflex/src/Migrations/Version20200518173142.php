 ...
 */
final class Version20200518173142 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_telephonysiteparameter ADD twilioSid VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE user_telephonysiteparameter ADD fromPhoneNumber VARCHAR(255) DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_userinfo ADD mobilePhoneVerifyCode VARCHAR(255) DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_userInfo DROP mobilePhoneVerifyCode');
        ...
        $this->processSql('ALTER TABLE user_telephonysiteparameter DROP twilioSid');
        $this->processSql('ALTER TABLE user_telephonysiteparameter DROP fromPhoneNumber');
