 ...
 */
final class Version20200605173408 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_accessrequest ADD mobilePhone VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE user_accessrequest ADD mobilePhoneVerifyCode VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE user_accessrequest ADD mobilePhoneVerifyCodeDate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
        $this->processSql('ALTER TABLE user_accessrequest ADD mobilePhoneVerified BOOLEAN DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_accessrequest DROP mobilePhone');
        $this->processSql('ALTER TABLE user_accessrequest DROP mobilePhoneVerifyCode');
        $this->processSql('ALTER TABLE user_accessrequest DROP mobilePhoneVerifyCodeDate');
        $this->processSql('ALTER TABLE user_accessrequest DROP mobilePhoneVerified');
