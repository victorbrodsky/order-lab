 ...
 */
final class Version20200612170144 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD minority VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD firstPublications VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD allPublications VARCHAR(255) DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP minority');
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP firstPublications');
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP allPublications');
