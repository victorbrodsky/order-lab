 ...
 */
final class Version20200617203642 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD aoa BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD couple BOOLEAN DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP aoa');
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP couple');
