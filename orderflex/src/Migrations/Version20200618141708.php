 ...
 */
final class Version20200618141708 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE resapp_postsophlist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE resapp_postsophlist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_7817362D108B7592 ON resapp_postsophlist (original_id)');
        $this->processSql('CREATE INDEX IDX_7817362D61220EA6 ON resapp_postsophlist (creator_id)');
        $this->processSql('CREATE INDEX IDX_7817362DA43E35E8 ON resapp_postsophlist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_7817362DBD42F28C ON resapp_postsophlist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN resapp_postsophlist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE resapp_postsophlist ADD CONSTRAINT FK_7817362D108B7592 FOREIGN KEY (original_id) REFERENCES resapp_postsophlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_postsophlist ADD CONSTRAINT FK_7817362D61220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_postsophlist ADD CONSTRAINT FK_7817362DA43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_postsophlist ADD CONSTRAINT FK_7817362DBD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD postSoph_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP postsoph');
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD CONSTRAINT FK_5F5969B021A2B13C FOREIGN KEY (postSoph_id) REFERENCES resapp_postsophlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_postsophlist DROP CONSTRAINT FK_7817362D108B7592');
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP CONSTRAINT FK_5F5969B021A2B13C');
        $this->processSql('DROP SEQUENCE resapp_postsophlist_id_seq CASCADE');
        $this->processSql('DROP TABLE resapp_postsophlist');
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD postsoph VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP postSoph_id');
