 ...
 */
final class Version20200622161035 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('DROP INDEX uniq_5f5969b021a2b13c');
        $this->processSql('CREATE INDEX IDX_5F5969B021A2B13C ON resapp_residencyapplication (postSoph_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP INDEX IDX_5F5969B021A2B13C');
        $this->processSql('CREATE UNIQUE INDEX uniq_5f5969b021a2b13c ON resapp_residencyapplication (postsoph_id)');
