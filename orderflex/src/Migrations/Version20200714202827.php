 ...
 */
final class Version20200714202827 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD applicationSeasonEndDate DATE DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP applicationSeasonEndDate');
