 ...
 */
final class Version20200716154058 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE transres_visualinfo (id SERIAL NOT NULL, author INT DEFAULT NULL, antibodylist_id INT DEFAULT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT DEFAULT NULL, comment TEXT DEFAULT NULL, updateAuthor INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_3F43AAA0BDAFD8C8 ON transres_visualinfo (author)');
        $this->processSql('CREATE INDEX IDX_3F43AAA0505FD3E0 ON transres_visualinfo (updateAuthor)');
        $this->processSql('CREATE INDEX IDX_3F43AAA09EE0E42C ON transres_visualinfo (antibodylist_id)');
        $this->processSql('CREATE TABLE user_visualinfo_document (visualinfo_id INT NOT NULL, document_id INT NOT NULL, PRIMARY KEY(visualinfo_id, document_id))');
        $this->processSql('CREATE INDEX IDX_5C510ECDB85F7F9 ON user_visualinfo_document (visualinfo_id)');
        $this->processSql('CREATE INDEX IDX_5C510ECC33F7837 ON user_visualinfo_document (document_id)');
        $this->processSql('ALTER TABLE transres_visualinfo ADD CONSTRAINT FK_3F43AAA0BDAFD8C8 FOREIGN KEY (author) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_visualinfo ADD CONSTRAINT FK_3F43AAA0505FD3E0 FOREIGN KEY (updateAuthor) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_visualinfo ADD CONSTRAINT FK_3F43AAA09EE0E42C FOREIGN KEY (antibodylist_id) REFERENCES transres_antibodyList (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_visualinfo_document ADD CONSTRAINT FK_5C510ECDB85F7F9 FOREIGN KEY (visualinfo_id) REFERENCES transres_visualinfo (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_visualinfo_document ADD CONSTRAINT FK_5C510ECC33F7837 FOREIGN KEY (document_id) REFERENCES user_document (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE transres_antibodylist ADD inventory INT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_visualinfo_document DROP CONSTRAINT FK_5C510ECDB85F7F9');
        $this->processSql('DROP TABLE transres_visualinfo');
        $this->processSql('DROP TABLE user_visualinfo_document');
        ...
        $this->processSql('ALTER TABLE transres_antibodyList DROP inventory');
