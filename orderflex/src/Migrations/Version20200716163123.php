 ...
 */
final class Version20200716163123 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_antibodylist ADD unitPrice NUMERIC(15, 2) DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_antibodylist ADD tissueType VARCHAR(255) DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE transres_visualinfo ADD catalog VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_antibodyList DROP unitPrice');
        $this->processSql('ALTER TABLE transres_antibodyList DROP tissueType');
        ...
        $this->processSql('ALTER TABLE transres_visualinfo DROP catalog');
