 ...
 */
final class Version20200720152931 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE user_document_id_seq');
        $this->processSql('SELECT setval(\'user_document_id_seq\', (SELECT MAX(id) FROM user_document))');
        $this->processSql('ALTER TABLE user_document ALTER id SET DEFAULT nextval(\'user_document_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('DROP INDEX idx_5c510ecc33f7837');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP INDEX UNIQ_5C510ECC33F7837');
        ...
        $this->processSql('ALTER TABLE user_document ALTER id DROP DEFAULT');
