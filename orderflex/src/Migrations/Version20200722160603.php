 ...
 */
final class Version20200722160603 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE transres_visualinfo_document (visualinfo_id INT NOT NULL, document_id INT NOT NULL, PRIMARY KEY(visualinfo_id, document_id))');
        $this->processSql('CREATE INDEX IDX_A94F6C22DB85F7F9 ON transres_visualinfo_document (visualinfo_id)');
        $this->processSql('CREATE UNIQUE INDEX UNIQ_A94F6C22C33F7837 ON transres_visualinfo_document (document_id)');
        $this->processSql('ALTER TABLE transres_visualinfo_document ADD CONSTRAINT FK_A94F6C22DB85F7F9 FOREIGN KEY (visualinfo_id) REFERENCES transres_visualinfo (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_visualinfo_document ADD CONSTRAINT FK_A94F6C22C33F7837 FOREIGN KEY (document_id) REFERENCES user_document (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE UNIQUE INDEX uniq_5c510ecc33f7837 ON user_visualinfo_document (document_id)');
        ...
        $this->processSql('DROP TABLE transres_visualinfo_document');
