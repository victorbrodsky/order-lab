 ...
 */
final class Version20200728161007 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD residencyTrack_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD CONSTRAINT FK_5F5969B0D79A624B FOREIGN KEY (residencyTrack_id) REFERENCES user_residencyTrackList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_5F5969B0D79A624B ON resapp_residencyapplication (residencyTrack_id)');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE transres_visualinfo_document DROP CONSTRAINT FK_A94F6C22DB85F7F9');
        $this->processSql('DROP INDEX uniq_a94f6c22c33f7837');
        $this->processSql('ALTER TABLE transres_visualinfo_document ADD CONSTRAINT FK_A94F6C22DB85F7F9 FOREIGN KEY (visualinfo_id) REFERENCES transres_visualinfo (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_A94F6C22C33F7837 ON transres_visualinfo_document (document_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP CONSTRAINT FK_5F5969B0D79A624B');
        $this->processSql('DROP INDEX IDX_5F5969B0D79A624B');
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP residencyTrack_id');
        $this->processSql('ALTER TABLE transres_visualinfo_document DROP CONSTRAINT fk_a94f6c22db85f7f9');
        $this->processSql('DROP INDEX IDX_A94F6C22C33F7837');
