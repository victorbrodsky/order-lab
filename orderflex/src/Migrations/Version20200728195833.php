 ...
 */
final class Version20200728195833 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_roles ADD residencyTrack_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_roles ADD CONSTRAINT FK_54FCD59FD79A624B FOREIGN KEY (residencyTrack_id) REFERENCES user_residencyTrackList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_54FCD59FD79A624B ON user_roles (residencyTrack_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_roles DROP CONSTRAINT FK_54FCD59FD79A624B');
        $this->processSql('DROP INDEX IDX_54FCD59FD79A624B');
        $this->processSql('ALTER TABLE user_roles DROP residencyTrack_id');
