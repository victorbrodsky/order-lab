 ...
 */
final class Version20200730170219 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE resapp_typeconfig (id INT NOT NULL, creationdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, residencyTrack_id INT DEFAULT NULL, PRIMARY KEY(id))');
