 ...
 */
final class Version20200731140206 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE user_residencytrack_coordinator (residencytrack_id INT NOT NULL, coordinator_id INT NOT NULL, PRIMARY KEY(residencytrack_id, coordinator_id))');
        $this->processSql('CREATE INDEX IDX_2CA30B402EEC001D ON user_residencytrack_coordinator (residencytrack_id)');
        $this->processSql('CREATE INDEX IDX_2CA30B40E7877946 ON user_residencytrack_coordinator (coordinator_id)');
        $this->processSql('CREATE TABLE user_residencytrack_director (residencytrack_id INT NOT NULL, director_id INT NOT NULL, PRIMARY KEY(residencytrack_id, director_id))');
        $this->processSql('CREATE INDEX IDX_D2CE53222EEC001D ON user_residencytrack_director (residencytrack_id)');
        $this->processSql('CREATE INDEX IDX_D2CE5322899FB366 ON user_residencytrack_director (director_id)');
        $this->processSql('CREATE TABLE user_residencytrack_interviewer (residencytrack_id INT NOT NULL, interviewer_id INT NOT NULL, PRIMARY KEY(residencytrack_id, interviewer_id))');
        $this->processSql('CREATE INDEX IDX_4A40D84A2EEC001D ON user_residencytrack_interviewer (residencytrack_id)');
        $this->processSql('CREATE INDEX IDX_4A40D84A7906D9E8 ON user_residencytrack_interviewer (interviewer_id)');
        $this->processSql('ALTER TABLE user_residencytrack_coordinator ADD CONSTRAINT FK_2CA30B402EEC001D FOREIGN KEY (residencytrack_id) REFERENCES user_residencyTrackList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_residencytrack_coordinator ADD CONSTRAINT FK_2CA30B40E7877946 FOREIGN KEY (coordinator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_residencytrack_director ADD CONSTRAINT FK_D2CE53222EEC001D FOREIGN KEY (residencytrack_id) REFERENCES user_residencyTrackList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_residencytrack_director ADD CONSTRAINT FK_D2CE5322899FB366 FOREIGN KEY (director_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_residencytrack_interviewer ADD CONSTRAINT FK_4A40D84A2EEC001D FOREIGN KEY (residencytrack_id) REFERENCES user_residencyTrackList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_residencytrack_interviewer ADD CONSTRAINT FK_4A40D84A7906D9E8 FOREIGN KEY (interviewer_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE user_residencytracklist ADD institution_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_residencytracklist ADD CONSTRAINT FK_8FD8C2CE10405986 FOREIGN KEY (institution_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_8FD8C2CE10405986 ON user_residencytracklist (institution_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP TABLE user_residencytrack_coordinator');
        $this->processSql('DROP TABLE user_residencytrack_director');
        $this->processSql('DROP TABLE user_residencytrack_interviewer');
        ...
        $this->processSql('ALTER TABLE user_residencyTrackList DROP CONSTRAINT FK_8FD8C2CE10405986');
        $this->processSql('DROP INDEX IDX_8FD8C2CE10405986');
        $this->processSql('ALTER TABLE user_residencyTrackList DROP institution_id');
