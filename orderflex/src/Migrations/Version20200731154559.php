 ...
 */
final class Version20200731154559 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_typeconfig_coordinator DROP CONSTRAINT fk_71036b89c7e4641f');
        $this->processSql('ALTER TABLE resapp_typeconfig_director DROP CONSTRAINT fk_f44d2109c7e4641f');
        $this->processSql('ALTER TABLE resapp_typeconfig_interviewer DROP CONSTRAINT fk_17e0b883c7e4641f');
        $this->processSql('DROP SEQUENCE resapp_typeconfig_id_seq CASCADE');
        $this->processSql('DROP TABLE resapp_typeconfig');
        $this->processSql('DROP TABLE resapp_typeconfig_coordinator');
        $this->processSql('DROP TABLE resapp_typeconfig_director');
        $this->processSql('DROP TABLE resapp_typeconfig_interviewer');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE resapp_typeconfig_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE resapp_typeconfig (id INT NOT NULL, residencytrack_id INT DEFAULT NULL, creationdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX idx_fa40d9e1d79a624b ON resapp_typeconfig (residencytrack_id)');
        $this->processSql('CREATE TABLE resapp_typeconfig_coordinator (typeconfig_id INT NOT NULL, coordinator_id INT NOT NULL, PRIMARY KEY(typeconfig_id, coordinator_id))');
        $this->processSql('CREATE INDEX idx_71036b89e7877946 ON resapp_typeconfig_coordinator (coordinator_id)');
        $this->processSql('CREATE INDEX idx_71036b89c7e4641f ON resapp_typeconfig_coordinator (typeconfig_id)');
        $this->processSql('CREATE TABLE resapp_typeconfig_director (typeconfig_id INT NOT NULL, director_id INT NOT NULL, PRIMARY KEY(typeconfig_id, director_id))');
        $this->processSql('CREATE INDEX idx_f44d2109899fb366 ON resapp_typeconfig_director (director_id)');
        $this->processSql('CREATE INDEX idx_f44d2109c7e4641f ON resapp_typeconfig_director (typeconfig_id)');
        $this->processSql('CREATE TABLE resapp_typeconfig_interviewer (typeconfig_id INT NOT NULL, interviewer_id INT NOT NULL, PRIMARY KEY(typeconfig_id, interviewer_id))');
        $this->processSql('CREATE INDEX idx_17e0b8837906d9e8 ON resapp_typeconfig_interviewer (interviewer_id)');
        $this->processSql('CREATE INDEX idx_17e0b883c7e4641f ON resapp_typeconfig_interviewer (typeconfig_id)');
        $this->processSql('ALTER TABLE resapp_typeconfig ADD CONSTRAINT fk_fa40d9e1d79a624b FOREIGN KEY (residencytrack_id) REFERENCES user_residencytracklist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_typeconfig_coordinator ADD CONSTRAINT fk_71036b89c7e4641f FOREIGN KEY (typeconfig_id) REFERENCES resapp_typeconfig (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_typeconfig_coordinator ADD CONSTRAINT fk_71036b89e7877946 FOREIGN KEY (coordinator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_typeconfig_director ADD CONSTRAINT fk_f44d2109c7e4641f FOREIGN KEY (typeconfig_id) REFERENCES resapp_typeconfig (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_typeconfig_director ADD CONSTRAINT fk_f44d2109899fb366 FOREIGN KEY (director_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_typeconfig_interviewer ADD CONSTRAINT fk_17e0b883c7e4641f FOREIGN KEY (typeconfig_id) REFERENCES resapp_typeconfig (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_typeconfig_interviewer ADD CONSTRAINT fk_17e0b8837906d9e8 FOREIGN KEY (interviewer_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
