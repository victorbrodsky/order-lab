 ...
 */
final class Version20200806170656 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_training ADD residencyTrack_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_training ADD CONSTRAINT FK_359F6E8FD79A624B FOREIGN KEY (residencyTrack_id) REFERENCES user_residencyTrackList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_359F6E8FD79A624B ON user_training (residencyTrack_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_training DROP CONSTRAINT FK_359F6E8FD79A624B');
        $this->processSql('DROP INDEX IDX_359F6E8FD79A624B');
        $this->processSql('ALTER TABLE user_training DROP residencyTrack_id');
