 ...
 */
final class Version20200910171917 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE resapp_inputdatafile_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE resapp_inputdatafile (id INT NOT NULL, resapp_id INT DEFAULT NULL, creationdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE UNIQUE INDEX UNIQ_CB859266B5921B1A ON resapp_inputdatafile (resapp_id)');
        $this->processSql('CREATE TABLE resapp_inputdatafile_erasfile (inputdatafile_id INT NOT NULL, erasfile_id INT NOT NULL, PRIMARY KEY(inputdatafile_id, erasfile_id))');
        $this->processSql('CREATE INDEX IDX_9BC23AB8ACB54DD9 ON resapp_inputdatafile_erasfile (inputdatafile_id)');
        $this->processSql('CREATE INDEX IDX_9BC23AB8DFD87BB5 ON resapp_inputdatafile_erasfile (erasfile_id)');
        $this->processSql('ALTER TABLE resapp_inputdatafile ADD CONSTRAINT FK_CB859266B5921B1A FOREIGN KEY (resapp_id) REFERENCES resapp_residencyapplication (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_inputdatafile_erasfile ADD CONSTRAINT FK_9BC23AB8ACB54DD9 FOREIGN KEY (inputdatafile_id) REFERENCES resapp_inputdatafile (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_inputdatafile_erasfile ADD CONSTRAINT FK_9BC23AB8DFD87BB5 FOREIGN KEY (erasfile_id) REFERENCES user_document (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_inputdatafile_erasfile DROP CONSTRAINT FK_9BC23AB8ACB54DD9');
        $this->processSql('DROP SEQUENCE resapp_inputdatafile_id_seq CASCADE');
        $this->processSql('DROP TABLE resapp_inputdatafile');
        $this->processSql('DROP TABLE resapp_inputdatafile_erasfile');
