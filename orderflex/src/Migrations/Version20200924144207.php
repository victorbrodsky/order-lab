 ...
 */
final class Version20200924144207 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD aamcId VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD erasApplicantId VARCHAR(255) DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP aamcId');
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP erasApplicantId');
