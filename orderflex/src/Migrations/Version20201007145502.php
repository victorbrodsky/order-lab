 ...
 */
final class Version20201007145502 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE calllog_siteparameter ADD numberOfMrnToDisplay INT DEFAULT NULL');
        $this->processSql('ALTER TABLE crn_siteparameter ADD numberOfMrnToDisplay INT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE calllog_siteParameter DROP numberOfMrnToDisplay');
        $this->processSql('ALTER INDEX siteparameters_unique RENAME TO siteparameters_unique00000');
        $this->processSql('ALTER TABLE crn_siteParameter DROP numberOfMrnToDisplay');
