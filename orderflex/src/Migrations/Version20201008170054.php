 ...
 */
final class Version20201008170054 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE transres_requestcategory_specialty (requestcategorytypelist_id INT NOT NULL, specialtylist_id INT NOT NULL, PRIMARY KEY(requestcategorytypelist_id, specialtylist_id))');
        $this->processSql('CREATE INDEX IDX_3123F0F9164B4DCB ON transres_requestcategory_specialty (requestcategorytypelist_id)');
        $this->processSql('CREATE INDEX IDX_3123F0F9F6E6EBCE ON transres_requestcategory_specialty (specialtylist_id)');
        $this->processSql('ALTER TABLE transres_requestcategory_specialty ADD CONSTRAINT FK_3123F0F9164B4DCB FOREIGN KEY (requestcategorytypelist_id) REFERENCES transres_requestCategoryTypeList (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_requestcategory_specialty ADD CONSTRAINT FK_3123F0F9F6E6EBCE FOREIGN KEY (specialtylist_id) REFERENCES transres_specialtyList (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP TABLE transres_requestcategory_specialty');
