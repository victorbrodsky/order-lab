 ...
 */
final class Version20201102220248 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE resapp_resappfitforprogram_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE resapp_resappfitforprogram (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_AF193915108B7592 ON resapp_resappfitforprogram (original_id)');
        $this->processSql('CREATE INDEX IDX_AF19391561220EA6 ON resapp_resappfitforprogram (creator_id)');
        $this->processSql('CREATE INDEX IDX_AF193915A43E35E8 ON resapp_resappfitforprogram (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_AF193915BD42F28C ON resapp_resappfitforprogram (objectType_id)');
        $this->processSql('COMMENT ON COLUMN resapp_resappfitforprogram.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE resapp_resappfitforprogram ADD CONSTRAINT FK_AF193915108B7592 FOREIGN KEY (original_id) REFERENCES resapp_resappfitforprogram (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_resappfitforprogram ADD CONSTRAINT FK_AF19391561220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_resappfitforprogram ADD CONSTRAINT FK_AF193915A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_resappfitforprogram ADD CONSTRAINT FK_AF193915BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE resapp_interview ADD fitForProgram_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_interview ADD CONSTRAINT FK_3BCC955A326BFB75 FOREIGN KEY (fitForProgram_id) REFERENCES resapp_resappfitforprogram (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_3BCC955A326BFB75 ON resapp_interview (fitForProgram_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_resappfitforprogram DROP CONSTRAINT FK_AF193915108B7592');
        $this->processSql('ALTER TABLE resapp_interview DROP CONSTRAINT FK_3BCC955A326BFB75');
        $this->processSql('DROP SEQUENCE resapp_resappfitforprogram_id_seq CASCADE');
        $this->processSql('DROP TABLE resapp_resappfitforprogram');
        ...
        $this->processSql('DROP INDEX IDX_3BCC955A326BFB75');
        $this->processSql('ALTER TABLE resapp_interview DROP fitForProgram_id');
