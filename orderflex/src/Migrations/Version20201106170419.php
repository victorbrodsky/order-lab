 ...
 */
final class Version20201106170419 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE resapp_resapp_manualreports (resapp_id INT NOT NULL, manualreport_id INT NOT NULL, PRIMARY KEY(resapp_id, manualreport_id))');
        $this->processSql('CREATE INDEX IDX_47A08064B5921B1A ON resapp_resapp_manualreports (resapp_id)');
        $this->processSql('CREATE INDEX IDX_47A08064C7976735 ON resapp_resapp_manualreports (manualreport_id)');
        $this->processSql('CREATE TABLE fellapp_fellapp_manualreports (fellapp_id INT NOT NULL, manualreport_id INT NOT NULL, PRIMARY KEY(fellapp_id, manualreport_id))');
        $this->processSql('CREATE INDEX IDX_AAA4E7232A90CB41 ON fellapp_fellapp_manualreports (fellapp_id)');
        $this->processSql('CREATE INDEX IDX_AAA4E723C7976735 ON fellapp_fellapp_manualreports (manualreport_id)');
        $this->processSql('ALTER TABLE resapp_resapp_manualreports ADD CONSTRAINT FK_47A08064B5921B1A FOREIGN KEY (resapp_id) REFERENCES resapp_residencyapplication (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_resapp_manualreports ADD CONSTRAINT FK_47A08064C7976735 FOREIGN KEY (manualreport_id) REFERENCES user_document (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE fellapp_fellapp_manualreports ADD CONSTRAINT FK_AAA4E7232A90CB41 FOREIGN KEY (fellapp_id) REFERENCES fellapp_fellowshipApplication (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE fellapp_fellapp_manualreports ADD CONSTRAINT FK_AAA4E723C7976735 FOREIGN KEY (manualreport_id) REFERENCES user_document (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP TABLE fellapp_fellapp_manualreports');
        $this->processSql('DROP TABLE resapp_resapp_manualreports');
