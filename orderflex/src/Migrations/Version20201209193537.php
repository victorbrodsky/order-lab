 ...
 */
final class Version20201209193537 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_interview ADD submitter_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE fellapp_interview ADD CONSTRAINT FK_97C396AA919E5513 FOREIGN KEY (submitter_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_97C396AA919E5513 ON fellapp_interview (submitter_id)');
        $this->processSql('DROP INDEX "primary"');
        $this->processSql('ALTER TABLE fellapp_reference_document ADD PRIMARY KEY (reference_id, document_id)');
        $this->processSql('ALTER TABLE resapp_interview ADD submitter_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_interview ADD CONSTRAINT FK_3BCC955A919E5513 FOREIGN KEY (submitter_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_3BCC955A919E5513 ON resapp_interview (submitter_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_interview DROP CONSTRAINT FK_97C396AA919E5513');
        $this->processSql('DROP INDEX IDX_97C396AA919E5513');
        $this->processSql('ALTER TABLE fellapp_interview DROP submitter_id');
        ...
        $this->processSql('ALTER TABLE resapp_interview DROP CONSTRAINT FK_3BCC955A919E5513');
        $this->processSql('DROP INDEX IDX_3BCC955A919E5513');
        $this->processSql('ALTER TABLE resapp_interview DROP submitter_id');
