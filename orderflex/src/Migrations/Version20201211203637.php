 ...
 */
final class Version20201211203637 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_siteparameter ADD defaultResidencyTrack_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE resapp_siteparameter ADD CONSTRAINT FK_27B94F2EDF05ED52 FOREIGN KEY (defaultResidencyTrack_id) REFERENCES user_residencyTrackList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_27B94F2EDF05ED52 ON resapp_siteparameter (defaultResidencyTrack_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_siteparameter DROP CONSTRAINT FK_27B94F2EDF05ED52');
        $this->processSql('DROP INDEX IDX_27B94F2EDF05ED52');
        $this->processSql('ALTER TABLE resapp_siteparameter DROP defaultResidencyTrack_id');
