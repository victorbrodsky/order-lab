 ...
 */
final class Version20201215193348 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE resapp_applyingresidencytrack_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE resapp_learnarealist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE resapp_specificindividuallist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE resapp_applyingresidencytrack (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_59D9D060108B7592 ON resapp_applyingresidencytrack (original_id)');
        $this->processSql('CREATE INDEX IDX_59D9D06061220EA6 ON resapp_applyingresidencytrack (creator_id)');
        $this->processSql('CREATE INDEX IDX_59D9D060A43E35E8 ON resapp_applyingresidencytrack (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_59D9D060BD42F28C ON resapp_applyingresidencytrack (objectType_id)');
        $this->processSql('COMMENT ON COLUMN resapp_applyingresidencytrack.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE resapp_learnarealist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_D79DAE7108B7592 ON resapp_learnarealist (original_id)');
        $this->processSql('CREATE INDEX IDX_D79DAE761220EA6 ON resapp_learnarealist (creator_id)');
        $this->processSql('CREATE INDEX IDX_D79DAE7A43E35E8 ON resapp_learnarealist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_D79DAE7BD42F28C ON resapp_learnarealist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN resapp_learnarealist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE resapp_specificindividuallist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_E961D527108B7592 ON resapp_specificindividuallist (original_id)');
        $this->processSql('CREATE INDEX IDX_E961D52761220EA6 ON resapp_specificindividuallist (creator_id)');
        $this->processSql('CREATE INDEX IDX_E961D527A43E35E8 ON resapp_specificindividuallist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_E961D527BD42F28C ON resapp_specificindividuallist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN resapp_specificindividuallist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE resapp_applyingresidencytrack ADD CONSTRAINT FK_59D9D060108B7592 FOREIGN KEY (original_id) REFERENCES resapp_applyingresidencytrack (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_applyingresidencytrack ADD CONSTRAINT FK_59D9D06061220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_applyingresidencytrack ADD CONSTRAINT FK_59D9D060A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_applyingresidencytrack ADD CONSTRAINT FK_59D9D060BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_learnarealist ADD CONSTRAINT FK_D79DAE7108B7592 FOREIGN KEY (original_id) REFERENCES resapp_learnarealist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_learnarealist ADD CONSTRAINT FK_D79DAE761220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_learnarealist ADD CONSTRAINT FK_D79DAE7A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_learnarealist ADD CONSTRAINT FK_D79DAE7BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_specificindividuallist ADD CONSTRAINT FK_E961D527108B7592 FOREIGN KEY (original_id) REFERENCES resapp_specificindividuallist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_specificindividuallist ADD CONSTRAINT FK_E961D52761220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_specificindividuallist ADD CONSTRAINT FK_E961D527A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_specificindividuallist ADD CONSTRAINT FK_E961D527BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE resapp_applyingresidencytrack DROP CONSTRAINT FK_59D9D060108B7592');
        $this->processSql('ALTER TABLE resapp_learnarealist DROP CONSTRAINT FK_D79DAE7108B7592');
        $this->processSql('ALTER TABLE resapp_specificindividuallist DROP CONSTRAINT FK_E961D527108B7592');
        $this->processSql('DROP SEQUENCE resapp_applyingresidencytrack_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE resapp_learnarealist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE resapp_specificindividuallist_id_seq CASCADE');
        $this->processSql('DROP TABLE resapp_applyingresidencytrack');
        $this->processSql('DROP TABLE resapp_learnarealist');
        $this->processSql('DROP TABLE resapp_specificindividuallist');
