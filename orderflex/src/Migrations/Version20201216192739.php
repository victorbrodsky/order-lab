 ...
 */
final class Version20201216192739 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE resapp_application_applyingtrack (applyingtrack_id INT NOT NULL, residencyApplication_id INT NOT NULL, PRIMARY KEY(residencyApplication_id, applyingtrack_id))');
        $this->processSql('CREATE INDEX IDX_D80813AEE537A9D7 ON resapp_application_applyingtrack (residencyApplication_id)');
        $this->processSql('CREATE INDEX IDX_D80813AE5D4E7553 ON resapp_application_applyingtrack (applyingtrack_id)');
        $this->processSql('CREATE TABLE resapp_application_learnarea (learnarea_id INT NOT NULL, residencyApplication_id INT NOT NULL, PRIMARY KEY(residencyApplication_id, learnarea_id))');
        $this->processSql('CREATE INDEX IDX_CB373F39E537A9D7 ON resapp_application_learnarea (residencyApplication_id)');
        $this->processSql('CREATE INDEX IDX_CB373F39727C74EA ON resapp_application_learnarea (learnarea_id)');
        $this->processSql('CREATE TABLE resapp_application_specificIndividual (residencyApplication_id INT NOT NULL, specificIndividual_id INT NOT NULL, PRIMARY KEY(residencyApplication_id, specificIndividual_id))');
        $this->processSql('CREATE INDEX IDX_A4F6042AE537A9D7 ON resapp_application_specificIndividual (residencyApplication_id)');
        $this->processSql('CREATE INDEX IDX_A4F6042A2B00BA95 ON resapp_application_specificIndividual (specificIndividual_id)');
        $this->processSql('ALTER TABLE resapp_application_applyingtrack ADD CONSTRAINT FK_D80813AEE537A9D7 FOREIGN KEY (residencyApplication_id) REFERENCES resapp_residencyapplication (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_application_applyingtrack ADD CONSTRAINT FK_D80813AE5D4E7553 FOREIGN KEY (applyingtrack_id) REFERENCES resapp_applyingresidencytrack (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_application_learnarea ADD CONSTRAINT FK_CB373F39E537A9D7 FOREIGN KEY (residencyApplication_id) REFERENCES resapp_residencyapplication (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_application_learnarea ADD CONSTRAINT FK_CB373F39727C74EA FOREIGN KEY (learnarea_id) REFERENCES resapp_learnarealist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_application_specificIndividual ADD CONSTRAINT FK_A4F6042AE537A9D7 FOREIGN KEY (residencyApplication_id) REFERENCES resapp_residencyapplication (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_application_specificIndividual ADD CONSTRAINT FK_A4F6042A2B00BA95 FOREIGN KEY (specificIndividual_id) REFERENCES resapp_specificindividuallist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication ADD questionnaireComments TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP TABLE resapp_application_applyingtrack');
        $this->processSql('DROP TABLE resapp_application_learnarea');
        $this->processSql('DROP TABLE resapp_application_specificIndividual');
        ...
        $this->processSql('ALTER TABLE resapp_residencyapplication DROP questionnaireComments');
