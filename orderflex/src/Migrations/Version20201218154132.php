 ...
 */
final class Version20201218154132 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE INDEX IDX_EBAB07FA2853D10F ON resapp_application_specificindividual (residencyapplication_id)');
        $this->processSql('CREATE INDEX IDX_EBAB07FA987EF160 ON resapp_application_specificindividual (specificindividual_id)');
        $this->processSql('ALTER TABLE resapp_application_specificindividual ADD CONSTRAINT FK_EBAB07FA2853D10F FOREIGN KEY (residencyapplication_id) REFERENCES resapp_residencyapplication (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE resapp_application_specificindividual ADD CONSTRAINT FK_EBAB07FA987EF160 FOREIGN KEY (specificindividual_id) REFERENCES user_userWrapper (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
