 ...
 */
final class Version20210113214710 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD transresBusinessEntityName TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD transresBusinessEntityAbbreviation TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_siteParameters DROP transresBusinessEntityName');
        $this->processSql('ALTER TABLE user_siteParameters DROP transresBusinessEntityAbbreviation');
