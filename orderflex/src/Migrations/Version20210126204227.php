 ...
 */
final class Version20210126204227 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_examination ADD COMLEXLevel2PEDatePassed DATE DEFAULT NULL');
        $this->processSql('ALTER TABLE user_examination ADD COMLEXLevel2PEScore VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE user_examination ADD COMLEXLevel2PEPercentile INT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_examination DROP COMLEXLevel2PEDatePassed');
        $this->processSql('ALTER TABLE user_examination DROP COMLEXLevel2PEScore');
        $this->processSql('ALTER TABLE user_examination DROP COMLEXLevel2PEPercentile');
