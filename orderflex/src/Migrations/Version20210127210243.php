 ...
 */
final class Version20210127210243 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE user_viewmodelist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE user_viewmodelist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_29D04CFF108B7592 ON user_viewmodelist (original_id)');
        $this->processSql('CREATE INDEX IDX_29D04CFF61220EA6 ON user_viewmodelist (creator_id)');
        $this->processSql('CREATE INDEX IDX_29D04CFFA43E35E8 ON user_viewmodelist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_29D04CFFBD42F28C ON user_viewmodelist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN user_viewmodelist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE user_viewmodelist ADD CONSTRAINT FK_29D04CFF108B7592 FOREIGN KEY (original_id) REFERENCES user_viewmodelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_viewmodelist ADD CONSTRAINT FK_29D04CFF61220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_viewmodelist ADD CONSTRAINT FK_29D04CFFA43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE user_viewmodelist ADD CONSTRAINT FK_29D04CFFBD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE calllog_siteparameter ADD viewMode_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE calllog_siteparameter ADD CONSTRAINT FK_1F4E90E0C5B7392C FOREIGN KEY (viewMode_id) REFERENCES user_viewmodelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_1F4E90E0C5B7392C ON calllog_siteparameter (viewMode_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE calllog_siteParameter DROP CONSTRAINT FK_1F4E90E0C5B7392C');
        $this->processSql('ALTER TABLE user_viewmodelist DROP CONSTRAINT FK_29D04CFF108B7592');
        $this->processSql('DROP SEQUENCE user_viewmodelist_id_seq CASCADE');
        $this->processSql('DROP TABLE user_viewmodelist');
        ...
        $this->processSql('DROP INDEX IDX_1F4E90E0C5B7392C');
        $this->processSql('ALTER TABLE calllog_siteParameter DROP viewMode_id');
