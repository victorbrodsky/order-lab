 ...
 */
final class Version20210128214206 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE transres_pricetypelist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE transres_pricetypelist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_CB5B05FD108B7592 ON transres_pricetypelist (original_id)');
        $this->processSql('CREATE INDEX IDX_CB5B05FD61220EA6 ON transres_pricetypelist (creator_id)');
        $this->processSql('CREATE INDEX IDX_CB5B05FDA43E35E8 ON transres_pricetypelist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_CB5B05FDBD42F28C ON transres_pricetypelist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN transres_pricetypelist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE transres_pricetypelist ADD CONSTRAINT FK_CB5B05FD108B7592 FOREIGN KEY (original_id) REFERENCES transres_pricetypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_pricetypelist ADD CONSTRAINT FK_CB5B05FD61220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_pricetypelist ADD CONSTRAINT FK_CB5B05FDA43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_pricetypelist ADD CONSTRAINT FK_CB5B05FDBD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE transres_project ADD priceList_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD CONSTRAINT FK_995201AF46B960C4 FOREIGN KEY (priceList_id) REFERENCES transres_pricetypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_995201AF46B960C4 ON transres_project (priceList_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_pricetypelist DROP CONSTRAINT FK_CB5B05FD108B7592');
        $this->processSql('ALTER TABLE transres_project DROP CONSTRAINT FK_995201AF46B960C4');
        $this->processSql('DROP SEQUENCE transres_pricetypelist_id_seq CASCADE');
        $this->processSql('DROP TABLE transres_pricetypelist');
        ...
        $this->processSql('DROP INDEX IDX_995201AF46B960C4');
        $this->processSql('ALTER TABLE transres_project DROP priceList_id');
