 ...
 */
final class Version20210129173956 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_requestcategorytypelist ADD feeAdditionalItem VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_requestCategoryTypeList DROP feeAdditionalItem');
