 ...
 */
final class Version20210201191407 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE transres_prices_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE transres_prices (id INT NOT NULL, fee VARCHAR(255) DEFAULT NULL, feeAdditionalItem VARCHAR(255) DEFAULT NULL, requestCategoryType_id INT DEFAULT NULL, priceList_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_63371166F3C0468B ON transres_prices (requestCategoryType_id)');
        $this->processSql('CREATE INDEX IDX_6337116646B960C4 ON transres_prices (priceList_id)');
        $this->processSql('ALTER TABLE transres_prices ADD CONSTRAINT FK_63371166F3C0468B FOREIGN KEY (requestCategoryType_id) REFERENCES transres_requestCategoryTypeList (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_prices ADD CONSTRAINT FK_6337116646B960C4 FOREIGN KEY (priceList_id) REFERENCES transres_pricetypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE transres_requestcategorytypelist DROP internalfee');
        $this->processSql('ALTER TABLE transres_requestcategorytypelist DROP internalfeeadditionalitem');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP SEQUENCE transres_prices_id_seq CASCADE');
        $this->processSql('DROP TABLE transres_prices');
        ...
        $this->processSql('ALTER TABLE transres_requestCategoryTypeList ADD internalfee VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_requestCategoryTypeList ADD internalfeeadditionalitem VARCHAR(255) DEFAULT NULL');
