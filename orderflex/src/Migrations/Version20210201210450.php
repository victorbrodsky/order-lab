 ...
 */
final class Version20210201210450 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE transres_prices_id_seq');
        $this->processSql('SELECT setval(\'transres_prices_id_seq\', (SELECT MAX(id) FROM transres_prices))');
        $this->processSql('ALTER TABLE transres_prices ALTER id SET DEFAULT nextval(\'transres_prices_id_seq\')');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_prices ALTER id DROP DEFAULT');
