 ...
 */
final class Version20210202211051 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_invoiceitem ADD additionalUnitPrice NUMERIC(15, 2) DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_invoiceItem DROP additionalUnitPrice');
    }
}
