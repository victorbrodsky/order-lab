 ...
 */
final class Version20210308212759 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteparameters ADD showRemittance BOOLEAN DEFAULT NULL');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD remoteAccessUrl TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteParameters DROP showRemittance');
        $this->processSql('ALTER INDEX siteparameters_unique RENAME TO siteparameters_unique00000');
        $this->processSql('ALTER TABLE user_siteParameters DROP remoteAccessUrl');
