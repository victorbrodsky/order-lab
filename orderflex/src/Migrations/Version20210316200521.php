 ...
 */
final class Version20210316200521 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_project ADD approvedProjectBudget VARCHAR(255) DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
