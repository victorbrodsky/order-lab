 ...
 */
final class Version20210319190329 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_project ADD grandTotal NUMERIC(15, 2) DEFAULT NULL');
        //$this->processSql('ALTER TABLE transres_project ALTER approvedprojectbudget TYPE NUMERIC(15, 2)');
        //$this->processSql('ALTER TABLE transres_project ALTER approvedprojectbudget DROP DEFAULT');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_project DROP grandTotal');
        //$this->processSql('ALTER TABLE transres_project ALTER approvedProjectBudget TYPE VARCHAR(255)');
        //$this->processSql('ALTER TABLE transres_project ALTER approvedProjectBudget DROP DEFAULT');
