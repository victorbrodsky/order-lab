 ...
 */
final class Version20210319204909 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_project ADD approvedProjectBudget NUMERIC(15, 2) DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_project DROP approvedProjectBudget');
