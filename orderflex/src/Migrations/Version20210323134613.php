 ...
 */
final class Version20210323134613 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_project ADD noBudgetLimit BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project RENAME COLUMN grandtotal TO total');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_project DROP noBudgetLimit');
        $this->processSql('ALTER TABLE transres_project RENAME COLUMN total TO grandtotal');
