 ...
 */
final class Version20210331152941 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE transres_transResSiteParameters_transresIntakeForm (transResSiteParameter_id INT NOT NULL, transresIntakeForm_id INT NOT NULL, PRIMARY KEY(transResSiteParameter_id, transresIntakeForm_id))');
        $this->processSql('CREATE INDEX IDX_DCD553B3378898F4 ON transres_transResSiteParameters_transresIntakeForm (transResSiteParameter_id)');
        $this->processSql('CREATE INDEX IDX_DCD553B374549ED4 ON transres_transResSiteParameters_transresIntakeForm (transresIntakeForm_id)');
        $this->processSql('ALTER TABLE transres_transResSiteParameters_transresIntakeForm ADD CONSTRAINT FK_DCD553B3378898F4 FOREIGN KEY (transResSiteParameter_id) REFERENCES transres_siteParameters (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_transResSiteParameters_transresIntakeForm ADD CONSTRAINT FK_DCD553B374549ED4 FOREIGN KEY (transresIntakeForm_id) REFERENCES user_document (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP TABLE transres_transResSiteParameters_transresIntakeForm');
