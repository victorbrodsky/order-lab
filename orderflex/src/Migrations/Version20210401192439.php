 ...
 */
final class Version20210401192439 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteparameters ALTER projectspecialty_id DROP NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteParameters ALTER projectSpecialty_id SET NOT NULL');
