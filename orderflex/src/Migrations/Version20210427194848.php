 ...
 */
final class Version20210427194848 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteparameters ADD overBudgetFromEmail VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD overBudgetSubject TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD overBudgetBody TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD overBudgetSendEmail BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD approvedBudgetSendEmail BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD approvedBudgetFromEmail VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD approvedBudgetSubject TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD approvedBudgetBody TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD budgetLimitRemovalSubject TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD budgetLimitRemovalBody TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD overBudgetCalculation VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteParameters DROP overBudgetFromEmail');
        $this->processSql('ALTER TABLE transres_siteParameters DROP overBudgetSubject');
        $this->processSql('ALTER TABLE transres_siteParameters DROP overBudgetBody');
        $this->processSql('ALTER TABLE transres_siteParameters DROP overBudgetSendEmail');
        $this->processSql('ALTER TABLE transres_siteParameters DROP approvedBudgetSendEmail');
        $this->processSql('ALTER TABLE transres_siteParameters DROP approvedBudgetFromEmail');
        $this->processSql('ALTER TABLE transres_siteParameters DROP approvedBudgetSubject');
        $this->processSql('ALTER TABLE transres_siteParameters DROP approvedBudgetBody');
        $this->processSql('ALTER TABLE transres_siteParameters DROP budgetLimitRemovalSubject');
        $this->processSql('ALTER TABLE transres_siteParameters DROP budgetLimitRemovalBody');
        $this->processSql('ALTER TABLE transres_siteParameters DROP overBudgetCalculation');
