 ...
 */
final class Version20210512163106 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE transres_invoiceitem_id_seq');
        $this->processSql('SELECT setval(\'transres_invoiceitem_id_seq\', (SELECT MAX(id) FROM transres_invoiceitem))');
        $this->processSql('ALTER TABLE transres_invoiceitem ALTER id SET DEFAULT nextval(\'transres_invoiceitem_id_seq\')');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_product ALTER id DROP DEFAULT');
        ...
        $this->processSql('ALTER TABLE transres_invoiceItem ALTER id DROP DEFAULT');
    }
}
