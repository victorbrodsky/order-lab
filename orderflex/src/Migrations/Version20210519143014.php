 ...
 */
final class Version20210519143014 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_specialtylist ADD rolename VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_specialtylist ADD friendlyname VARCHAR(255) DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_specialtyList DROP rolename');
        $this->processSql('ALTER TABLE transres_specialtyList DROP friendlyname');
