 ...
 */
final class Version20210603170459 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_fellowshipsubspecialty ADD seasonYearStart DATE DEFAULT NULL');
        $this->processSql('ALTER TABLE user_fellowshipsubspecialty ADD seasonYearEnd DATE DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_residencyspecialty ADD seasonYearStart DATE DEFAULT NULL');
        $this->processSql('ALTER TABLE user_residencyspecialty ADD seasonYearEnd DATE DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_fellowshipSubspecialty DROP seasonYearStart');
        $this->processSql('ALTER TABLE user_fellowshipSubspecialty DROP seasonYearEnd');
        ...
        $this->processSql('ALTER TABLE user_residencySpecialty DROP seasonYearStart');
        $this->processSql('ALTER TABLE user_residencySpecialty DROP seasonYearEnd');
