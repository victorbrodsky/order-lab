 ...
 */
final class Version20210608142504 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_residencytracklist ADD seasonYearStart DATE DEFAULT NULL');
        $this->processSql('ALTER TABLE user_residencytracklist ADD seasonYearEnd DATE DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_residencyTrackList DROP seasonYearStart');
        $this->processSql('ALTER TABLE user_residencyTrackList DROP seasonYearEnd');
