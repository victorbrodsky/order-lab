 ...
 */
final class Version20210622140059 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE transres_workqueuelist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE transres_workqueuelist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_77AA9826108B7592 ON transres_workqueuelist (original_id)');
        $this->processSql('CREATE INDEX IDX_77AA982661220EA6 ON transres_workqueuelist (creator_id)');
        $this->processSql('CREATE INDEX IDX_77AA9826A43E35E8 ON transres_workqueuelist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_77AA9826BD42F28C ON transres_workqueuelist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN transres_workqueuelist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE transres_workqueuelist ADD CONSTRAINT FK_77AA9826108B7592 FOREIGN KEY (original_id) REFERENCES transres_workqueuelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_workqueuelist ADD CONSTRAINT FK_77AA982661220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_workqueuelist ADD CONSTRAINT FK_77AA9826A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_workqueuelist ADD CONSTRAINT FK_77AA9826BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE transres_prices ADD workqueue_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_prices ADD CONSTRAINT FK_63371166E6F802F1 FOREIGN KEY (workqueue_id) REFERENCES transres_workqueuelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_63371166E6F802F1 ON transres_prices (workqueue_id)');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE transres_requestcategorytypelist ADD workqueue_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_requestcategorytypelist ADD CONSTRAINT FK_D47882F3E6F802F1 FOREIGN KEY (workqueue_id) REFERENCES transres_workqueuelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_D47882F3E6F802F1 ON transres_requestcategorytypelist (workqueue_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_prices DROP CONSTRAINT FK_63371166E6F802F1');
        $this->processSql('ALTER TABLE transres_requestCategoryTypeList DROP CONSTRAINT FK_D47882F3E6F802F1');
        $this->processSql('ALTER TABLE transres_workqueuelist DROP CONSTRAINT FK_77AA9826108B7592');
        $this->processSql('DROP SEQUENCE transres_workqueuelist_id_seq CASCADE');
        $this->processSql('DROP TABLE transres_workqueuelist');
        ...
        $this->processSql('DROP INDEX IDX_D47882F3E6F802F1');
        $this->processSql('ALTER TABLE transres_requestCategoryTypeList DROP workqueue_id');
        ...
        $this->processSql('DROP INDEX IDX_63371166E6F802F1');
        $this->processSql('ALTER TABLE transres_prices DROP workqueue_id');
