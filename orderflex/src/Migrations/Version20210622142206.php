 ...
 */
final class Version20210622142206 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE transres_price_workqueue (price_id INT NOT NULL, workqueue_id INT NOT NULL, PRIMARY KEY(price_id, workqueue_id))');
        $this->processSql('CREATE INDEX IDX_F2B672ADD614C7E7 ON transres_price_workqueue (price_id)');
        $this->processSql('CREATE INDEX IDX_F2B672ADE6F802F1 ON transres_price_workqueue (workqueue_id)');
        $this->processSql('CREATE TABLE transres_requestcategory_workqueue (requestcategory_id INT NOT NULL, workqueue_id INT NOT NULL, PRIMARY KEY(requestcategory_id, workqueue_id))');
        $this->processSql('CREATE INDEX IDX_A5EE85539F4AA20 ON transres_requestcategory_workqueue (requestcategory_id)');
        $this->processSql('CREATE INDEX IDX_A5EE855E6F802F1 ON transres_requestcategory_workqueue (workqueue_id)');
        $this->processSql('ALTER TABLE transres_price_workqueue ADD CONSTRAINT FK_F2B672ADD614C7E7 FOREIGN KEY (price_id) REFERENCES transres_prices (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_price_workqueue ADD CONSTRAINT FK_F2B672ADE6F802F1 FOREIGN KEY (workqueue_id) REFERENCES transres_workqueuelist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_requestcategory_workqueue ADD CONSTRAINT FK_A5EE85539F4AA20 FOREIGN KEY (requestcategory_id) REFERENCES transres_requestCategoryTypeList (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_requestcategory_workqueue ADD CONSTRAINT FK_A5EE855E6F802F1 FOREIGN KEY (workqueue_id) REFERENCES transres_workqueuelist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP TABLE transres_price_workqueue');
        $this->processSql('DROP TABLE transres_requestcategory_workqueue');
