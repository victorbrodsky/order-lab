 ...
 */
final class Version20210701141224 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE transres_orderablestatusList_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE transres_orderablestatusList (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_B2130E36108B7592 ON transres_orderablestatusList (original_id)');
        $this->processSql('CREATE INDEX IDX_B2130E3661220EA6 ON transres_orderablestatusList (creator_id)');
        $this->processSql('CREATE INDEX IDX_B2130E36A43E35E8 ON transres_orderablestatusList (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_B2130E36BD42F28C ON transres_orderablestatusList (objectType_id)');
        $this->processSql('COMMENT ON COLUMN transres_orderablestatusList.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE transres_orderablestatusList ADD CONSTRAINT FK_B2130E36108B7592 FOREIGN KEY (original_id) REFERENCES transres_orderablestatusList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_orderablestatusList ADD CONSTRAINT FK_B2130E3661220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_orderablestatusList ADD CONSTRAINT FK_B2130E36A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_orderablestatusList ADD CONSTRAINT FK_B2130E36BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE transres_product ADD orderableStatus INT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_product ADD CONSTRAINT FK_65ABD5ECCD8563C0 FOREIGN KEY (orderableStatus) REFERENCES transres_orderablestatusList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_65ABD5ECCD8563C0 ON transres_product (orderableStatus)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_orderablestatusList DROP CONSTRAINT FK_B2130E36108B7592');
        $this->processSql('ALTER TABLE transres_product DROP CONSTRAINT FK_65ABD5ECCD8563C0');
        $this->processSql('DROP SEQUENCE transres_orderablestatusList_id_seq CASCADE');
        $this->processSql('DROP TABLE transres_orderablestatusList');
        ...
        $this->processSql('DROP INDEX IDX_65ABD5ECCD8563C0');
        $this->processSql('ALTER TABLE transres_product DROP orderableStatus');
