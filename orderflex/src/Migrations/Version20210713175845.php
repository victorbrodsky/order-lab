 ...
 */
final class Version20210713175845 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteparameters ADD projectExprDuration INT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD projectExprDurationEmail INT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD projectExprDurationChangeStatus INT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD projectExprApply BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD projectExprApplyChangeStatus BOOLEAN DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteParameters DROP projectExprDuration');
        $this->processSql('ALTER TABLE transres_siteParameters DROP projectExprDurationEmail');
        $this->processSql('ALTER TABLE transres_siteParameters DROP projectExprDurationChangeStatus');
        $this->processSql('ALTER TABLE transres_siteParameters DROP projectExprApply');
        $this->processSql('ALTER TABLE transres_siteParameters DROP projectExprApplyChangeStatus');
