 ...
 */
final class Version20210716193637 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteparameters ADD sendExpriringProjectEmail BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD expiringProjectEmailFrom TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD expiringProjectEmailSubject TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD expiringProjectEmailBody TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD sendExpiredProjectEmail BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD expiredProjectEmailFrom TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD expiredProjectEmailSubject TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD expiredProjectEmailBody TEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteParameters DROP sendExpriringProjectEmail');
        $this->processSql('ALTER TABLE transres_siteParameters DROP expiringProjectEmailFrom');
        $this->processSql('ALTER TABLE transres_siteParameters DROP expiringProjectEmailSubject');
        $this->processSql('ALTER TABLE transres_siteParameters DROP expiringProjectEmailBody');
        $this->processSql('ALTER TABLE transres_siteParameters DROP sendExpiredProjectEmail');
        $this->processSql('ALTER TABLE transres_siteParameters DROP expiredProjectEmailFrom');
        $this->processSql('ALTER TABLE transres_siteParameters DROP expiredProjectEmailSubject');
        $this->processSql('ALTER TABLE transres_siteParameters DROP expiredProjectEmailBody');
