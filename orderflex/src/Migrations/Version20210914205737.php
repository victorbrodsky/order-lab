 ...
 */
final class Version20210914205737 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_project ADD closureReason TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD reactivationReason TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD targetState VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD targetStateRequester_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD CONSTRAINT FK_995201AF337718E1 FOREIGN KEY (targetStateRequester_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_995201AF337718E1 ON transres_project (targetStateRequester_id)');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE transres_siteparameters ADD sendProjectReactivationRequest BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD projectReactivationFromEmail VARCHAR(255) DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD projectReactivationSubject TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_siteparameters ADD projectReactivationBody TEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE transres_project DROP CONSTRAINT FK_995201AF337718E1');
        $this->processSql('DROP INDEX IDX_995201AF337718E1');
        $this->processSql('ALTER TABLE transres_project DROP closureReason');
        $this->processSql('ALTER TABLE transres_project DROP reactivationReason');
        $this->processSql('ALTER TABLE transres_project DROP targetState');
        $this->processSql('ALTER TABLE transres_project DROP targetStateRequester_id');
        ...
        $this->processSql('ALTER TABLE transres_siteParameters DROP sendProjectReactivationRequest');
        $this->processSql('ALTER TABLE transres_siteParameters DROP projectReactivationFromEmail');
        $this->processSql('ALTER TABLE transres_siteParameters DROP projectReactivationSubject');
        $this->processSql('ALTER TABLE transres_siteParameters DROP projectReactivationBody');
