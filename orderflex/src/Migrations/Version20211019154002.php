 ...
 */
final class Version20211019154002 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE dashboard_chartlist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE dashboard_charttypelist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE dashboard_datasourcelist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE dashboard_filterlist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE dashboard_topiclist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE dashboard_updatefrequencylist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE dashboard_visualizationlist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE dashboard_chartlist (id INT NOT NULL, original_id INT DEFAULT NULL, visualization_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, width VARCHAR(255) DEFAULT NULL, height VARCHAR(255) DEFAULT NULL, chartTitle VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, dataSource_id INT DEFAULT NULL, updateFrequency_id INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_CAEBC0A2108B7592 ON dashboard_chartlist (original_id)');
        $this->processSql('CREATE INDEX IDX_CAEBC0A2B695AE45 ON dashboard_chartlist (visualization_id)');
        $this->processSql('CREATE INDEX IDX_CAEBC0A2F3D3127E ON dashboard_chartlist (dataSource_id)');
        $this->processSql('CREATE INDEX IDX_CAEBC0A22FF4733C ON dashboard_chartlist (updateFrequency_id)');
        $this->processSql('CREATE INDEX IDX_CAEBC0A261220EA6 ON dashboard_chartlist (creator_id)');
        $this->processSql('CREATE INDEX IDX_CAEBC0A2A43E35E8 ON dashboard_chartlist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_CAEBC0A2BD42F28C ON dashboard_chartlist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN dashboard_chartlist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE dashboard_chart_accessrole (chart_id INT NOT NULL, role_id INT NOT NULL, PRIMARY KEY(chart_id, role_id))');
        $this->processSql('CREATE INDEX IDX_FEC23FCFBEF83E0A ON dashboard_chart_accessrole (chart_id)');
        $this->processSql('CREATE INDEX IDX_FEC23FCFD60322AC ON dashboard_chart_accessrole (role_id)');
        $this->processSql('CREATE TABLE dashboard_chart_denyrole (chart_id INT NOT NULL, role_id INT NOT NULL, PRIMARY KEY(chart_id, role_id))');
        $this->processSql('CREATE INDEX IDX_863F636FBEF83E0A ON dashboard_chart_denyrole (chart_id)');
        $this->processSql('CREATE INDEX IDX_863F636FD60322AC ON dashboard_chart_denyrole (role_id)');
        $this->processSql('CREATE TABLE dashboard_chart_denyuser (chart_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(chart_id, user_id))');
        $this->processSql('CREATE INDEX IDX_5CC53F4CBEF83E0A ON dashboard_chart_denyuser (chart_id)');
        $this->processSql('CREATE INDEX IDX_5CC53F4CA76ED395 ON dashboard_chart_denyuser (user_id)');
        $this->processSql('CREATE TABLE dashboard_chart_downloadrole (chart_id INT NOT NULL, role_id INT NOT NULL, PRIMARY KEY(chart_id, role_id))');
        $this->processSql('CREATE INDEX IDX_3BC2D006BEF83E0A ON dashboard_chart_downloadrole (chart_id)');
        $this->processSql('CREATE INDEX IDX_3BC2D006D60322AC ON dashboard_chart_downloadrole (role_id)');
        $this->processSql('CREATE TABLE dashboard_chart_institution (chart_id INT NOT NULL, institution_id INT NOT NULL, PRIMARY KEY(chart_id, institution_id))');
        $this->processSql('CREATE INDEX IDX_3776722ABEF83E0A ON dashboard_chart_institution (chart_id)');
        $this->processSql('CREATE INDEX IDX_3776722A10405986 ON dashboard_chart_institution (institution_id)');
        $this->processSql('CREATE TABLE dashboard_chart_topic (chartlist_id INT NOT NULL, topiclist_id INT NOT NULL, PRIMARY KEY(chartlist_id, topiclist_id))');
        $this->processSql('CREATE INDEX IDX_21504208A6A6DD68 ON dashboard_chart_topic (chartlist_id)');
        $this->processSql('CREATE INDEX IDX_21504208679AC2D0 ON dashboard_chart_topic (topiclist_id)');
        $this->processSql('CREATE TABLE dashboard_chart_type (chart_id INT NOT NULL, type_id INT NOT NULL, PRIMARY KEY(chart_id, type_id))');
        $this->processSql('CREATE INDEX IDX_FAC15E98BEF83E0A ON dashboard_chart_type (chart_id)');
        $this->processSql('CREATE INDEX IDX_FAC15E98C54C8C93 ON dashboard_chart_type (type_id)');
        $this->processSql('CREATE TABLE dashboard_charttypelist (id INT NOT NULL, original_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, lft INT NOT NULL, rgt INT NOT NULL, level INT NOT NULL, root INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_E7AAC493108B7592 ON dashboard_charttypelist (original_id)');
        $this->processSql('CREATE INDEX IDX_E7AAC493727ACA70 ON dashboard_charttypelist (parent_id)');
        $this->processSql('CREATE INDEX IDX_E7AAC49361220EA6 ON dashboard_charttypelist (creator_id)');
        $this->processSql('CREATE INDEX IDX_E7AAC493A43E35E8 ON dashboard_charttypelist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_E7AAC493BD42F28C ON dashboard_charttypelist (objectType_id)');
        $this->processSql('CREATE INDEX charttypelist_name_idx ON dashboard_charttypelist (name)');
        $this->processSql('COMMENT ON COLUMN dashboard_charttypelist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE dashboard_datasourcelist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_1362A810108B7592 ON dashboard_datasourcelist (original_id)');
        $this->processSql('CREATE INDEX IDX_1362A81061220EA6 ON dashboard_datasourcelist (creator_id)');
        $this->processSql('CREATE INDEX IDX_1362A810A43E35E8 ON dashboard_datasourcelist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_1362A810BD42F28C ON dashboard_datasourcelist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN dashboard_datasourcelist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE dashboard_filterlist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_CA8B34CE108B7592 ON dashboard_filterlist (original_id)');
        $this->processSql('CREATE INDEX IDX_CA8B34CE61220EA6 ON dashboard_filterlist (creator_id)');
        $this->processSql('CREATE INDEX IDX_CA8B34CEA43E35E8 ON dashboard_filterlist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_CA8B34CEBD42F28C ON dashboard_filterlist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN dashboard_filterlist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE dashboard_topiclist (id INT NOT NULL, original_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, lft INT NOT NULL, rgt INT NOT NULL, level INT NOT NULL, root INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_72F7C8B3108B7592 ON dashboard_topiclist (original_id)');
        $this->processSql('CREATE INDEX IDX_72F7C8B3727ACA70 ON dashboard_topiclist (parent_id)');
        $this->processSql('CREATE INDEX IDX_72F7C8B361220EA6 ON dashboard_topiclist (creator_id)');
        $this->processSql('CREATE INDEX IDX_72F7C8B3A43E35E8 ON dashboard_topiclist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_72F7C8B3BD42F28C ON dashboard_topiclist (objectType_id)');
        $this->processSql('CREATE INDEX topiclist_name_idx ON dashboard_topiclist (name)');
        $this->processSql('COMMENT ON COLUMN dashboard_topiclist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE dashboard_updatefrequencylist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_4EF2B8C9108B7592 ON dashboard_updatefrequencylist (original_id)');
        $this->processSql('CREATE INDEX IDX_4EF2B8C961220EA6 ON dashboard_updatefrequencylist (creator_id)');
        $this->processSql('CREATE INDEX IDX_4EF2B8C9A43E35E8 ON dashboard_updatefrequencylist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_4EF2B8C9BD42F28C ON dashboard_updatefrequencylist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN dashboard_updatefrequencylist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE dashboard_visualizationlist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_65BD2790108B7592 ON dashboard_visualizationlist (original_id)');
        $this->processSql('CREATE INDEX IDX_65BD279061220EA6 ON dashboard_visualizationlist (creator_id)');
        $this->processSql('CREATE INDEX IDX_65BD2790A43E35E8 ON dashboard_visualizationlist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_65BD2790BD42F28C ON dashboard_visualizationlist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN dashboard_visualizationlist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD CONSTRAINT FK_CAEBC0A2108B7592 FOREIGN KEY (original_id) REFERENCES dashboard_chartlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD CONSTRAINT FK_CAEBC0A2B695AE45 FOREIGN KEY (visualization_id) REFERENCES dashboard_visualizationlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD CONSTRAINT FK_CAEBC0A2F3D3127E FOREIGN KEY (dataSource_id) REFERENCES dashboard_datasourcelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD CONSTRAINT FK_CAEBC0A22FF4733C FOREIGN KEY (updateFrequency_id) REFERENCES dashboard_updatefrequencylist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD CONSTRAINT FK_CAEBC0A261220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD CONSTRAINT FK_CAEBC0A2A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD CONSTRAINT FK_CAEBC0A2BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_accessrole ADD CONSTRAINT FK_FEC23FCFBEF83E0A FOREIGN KEY (chart_id) REFERENCES dashboard_chartlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_accessrole ADD CONSTRAINT FK_FEC23FCFD60322AC FOREIGN KEY (role_id) REFERENCES user_roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_denyrole ADD CONSTRAINT FK_863F636FBEF83E0A FOREIGN KEY (chart_id) REFERENCES dashboard_chartlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_denyrole ADD CONSTRAINT FK_863F636FD60322AC FOREIGN KEY (role_id) REFERENCES user_roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_denyuser ADD CONSTRAINT FK_5CC53F4CBEF83E0A FOREIGN KEY (chart_id) REFERENCES dashboard_chartlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_denyuser ADD CONSTRAINT FK_5CC53F4CA76ED395 FOREIGN KEY (user_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_downloadrole ADD CONSTRAINT FK_3BC2D006BEF83E0A FOREIGN KEY (chart_id) REFERENCES dashboard_chartlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_downloadrole ADD CONSTRAINT FK_3BC2D006D60322AC FOREIGN KEY (role_id) REFERENCES user_roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_institution ADD CONSTRAINT FK_3776722ABEF83E0A FOREIGN KEY (chart_id) REFERENCES dashboard_chartlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_institution ADD CONSTRAINT FK_3776722A10405986 FOREIGN KEY (institution_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_topic ADD CONSTRAINT FK_21504208A6A6DD68 FOREIGN KEY (chartlist_id) REFERENCES dashboard_chartlist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_topic ADD CONSTRAINT FK_21504208679AC2D0 FOREIGN KEY (topiclist_id) REFERENCES dashboard_topiclist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_type ADD CONSTRAINT FK_FAC15E98BEF83E0A FOREIGN KEY (chart_id) REFERENCES dashboard_chartlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_type ADD CONSTRAINT FK_FAC15E98C54C8C93 FOREIGN KEY (type_id) REFERENCES dashboard_charttypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_charttypelist ADD CONSTRAINT FK_E7AAC493108B7592 FOREIGN KEY (original_id) REFERENCES dashboard_charttypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_charttypelist ADD CONSTRAINT FK_E7AAC493727ACA70 FOREIGN KEY (parent_id) REFERENCES dashboard_charttypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_charttypelist ADD CONSTRAINT FK_E7AAC49361220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_charttypelist ADD CONSTRAINT FK_E7AAC493A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_charttypelist ADD CONSTRAINT FK_E7AAC493BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_datasourcelist ADD CONSTRAINT FK_1362A810108B7592 FOREIGN KEY (original_id) REFERENCES dashboard_datasourcelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_datasourcelist ADD CONSTRAINT FK_1362A81061220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_datasourcelist ADD CONSTRAINT FK_1362A810A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_datasourcelist ADD CONSTRAINT FK_1362A810BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_filterlist ADD CONSTRAINT FK_CA8B34CE108B7592 FOREIGN KEY (original_id) REFERENCES dashboard_filterlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_filterlist ADD CONSTRAINT FK_CA8B34CE61220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_filterlist ADD CONSTRAINT FK_CA8B34CEA43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_filterlist ADD CONSTRAINT FK_CA8B34CEBD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topiclist ADD CONSTRAINT FK_72F7C8B3108B7592 FOREIGN KEY (original_id) REFERENCES dashboard_topiclist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topiclist ADD CONSTRAINT FK_72F7C8B3727ACA70 FOREIGN KEY (parent_id) REFERENCES dashboard_topiclist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topiclist ADD CONSTRAINT FK_72F7C8B361220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topiclist ADD CONSTRAINT FK_72F7C8B3A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topiclist ADD CONSTRAINT FK_72F7C8B3BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_updatefrequencylist ADD CONSTRAINT FK_4EF2B8C9108B7592 FOREIGN KEY (original_id) REFERENCES dashboard_updatefrequencylist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_updatefrequencylist ADD CONSTRAINT FK_4EF2B8C961220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_updatefrequencylist ADD CONSTRAINT FK_4EF2B8C9A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_updatefrequencylist ADD CONSTRAINT FK_4EF2B8C9BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_visualizationlist ADD CONSTRAINT FK_65BD2790108B7592 FOREIGN KEY (original_id) REFERENCES dashboard_visualizationlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_visualizationlist ADD CONSTRAINT FK_65BD279061220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_visualizationlist ADD CONSTRAINT FK_65BD2790A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_visualizationlist ADD CONSTRAINT FK_65BD2790BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE dashboard_chartlist DROP CONSTRAINT FK_CAEBC0A2108B7592');
        $this->processSql('ALTER TABLE dashboard_chart_accessrole DROP CONSTRAINT FK_FEC23FCFBEF83E0A');
        $this->processSql('ALTER TABLE dashboard_chart_denyrole DROP CONSTRAINT FK_863F636FBEF83E0A');
        $this->processSql('ALTER TABLE dashboard_chart_denyuser DROP CONSTRAINT FK_5CC53F4CBEF83E0A');
        $this->processSql('ALTER TABLE dashboard_chart_downloadrole DROP CONSTRAINT FK_3BC2D006BEF83E0A');
        $this->processSql('ALTER TABLE dashboard_chart_institution DROP CONSTRAINT FK_3776722ABEF83E0A');
        $this->processSql('ALTER TABLE dashboard_chart_topic DROP CONSTRAINT FK_21504208A6A6DD68');
        $this->processSql('ALTER TABLE dashboard_chart_type DROP CONSTRAINT FK_FAC15E98BEF83E0A');
        $this->processSql('ALTER TABLE dashboard_chart_type DROP CONSTRAINT FK_FAC15E98C54C8C93');
        $this->processSql('ALTER TABLE dashboard_charttypelist DROP CONSTRAINT FK_E7AAC493108B7592');
        $this->processSql('ALTER TABLE dashboard_charttypelist DROP CONSTRAINT FK_E7AAC493727ACA70');
        $this->processSql('ALTER TABLE dashboard_chartlist DROP CONSTRAINT FK_CAEBC0A2F3D3127E');
        $this->processSql('ALTER TABLE dashboard_datasourcelist DROP CONSTRAINT FK_1362A810108B7592');
        $this->processSql('ALTER TABLE dashboard_filterlist DROP CONSTRAINT FK_CA8B34CE108B7592');
        $this->processSql('ALTER TABLE dashboard_chart_topic DROP CONSTRAINT FK_21504208679AC2D0');
        $this->processSql('ALTER TABLE dashboard_topiclist DROP CONSTRAINT FK_72F7C8B3108B7592');
        $this->processSql('ALTER TABLE dashboard_topiclist DROP CONSTRAINT FK_72F7C8B3727ACA70');
        $this->processSql('ALTER TABLE dashboard_chartlist DROP CONSTRAINT FK_CAEBC0A22FF4733C');
        $this->processSql('ALTER TABLE dashboard_updatefrequencylist DROP CONSTRAINT FK_4EF2B8C9108B7592');
        $this->processSql('ALTER TABLE dashboard_chartlist DROP CONSTRAINT FK_CAEBC0A2B695AE45');
        $this->processSql('ALTER TABLE dashboard_visualizationlist DROP CONSTRAINT FK_65BD2790108B7592');
        $this->processSql('DROP SEQUENCE dashboard_chartlist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE dashboard_charttypelist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE dashboard_datasourcelist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE dashboard_filterlist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE dashboard_topiclist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE dashboard_updatefrequencylist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE dashboard_visualizationlist_id_seq CASCADE');
        $this->processSql('DROP TABLE dashboard_chartlist');
        $this->processSql('DROP TABLE dashboard_chart_accessrole');
        $this->processSql('DROP TABLE dashboard_chart_denyrole');
        $this->processSql('DROP TABLE dashboard_chart_denyuser');
        $this->processSql('DROP TABLE dashboard_chart_downloadrole');
        $this->processSql('DROP TABLE dashboard_chart_institution');
        $this->processSql('DROP TABLE dashboard_chart_topic');
        $this->processSql('DROP TABLE dashboard_chart_type');
        $this->processSql('DROP TABLE dashboard_charttypelist');
        $this->processSql('DROP TABLE dashboard_datasourcelist');
        $this->processSql('DROP TABLE dashboard_filterlist');
        $this->processSql('DROP TABLE dashboard_topiclist');
        $this->processSql('DROP TABLE dashboard_updatefrequencylist');
        $this->processSql('DROP TABLE dashboard_visualizationlist');
