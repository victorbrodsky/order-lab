 ...
 */
final class Version20211104173522 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE dashboard_chart_favoriteuser (chart_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(chart_id, user_id))');
        $this->processSql('CREATE INDEX IDX_C356EA7ABEF83E0A ON dashboard_chart_favoriteuser (chart_id)');
        $this->processSql('CREATE INDEX IDX_C356EA7AA76ED395 ON dashboard_chart_favoriteuser (user_id)');
        $this->processSql('ALTER TABLE dashboard_chart_favoriteuser ADD CONSTRAINT FK_C356EA7ABEF83E0A FOREIGN KEY (chart_id) REFERENCES dashboard_chartlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chart_favoriteuser ADD CONSTRAINT FK_C356EA7AA76ED395 FOREIGN KEY (user_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP TABLE dashboard_chart_favoriteuser');
