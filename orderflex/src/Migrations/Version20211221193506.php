 ...
 */
final class Version20211221193506 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE TABLE dashboard_topic_accessrole (topic_id INT NOT NULL, role_id INT NOT NULL, PRIMARY KEY(topic_id, role_id))');
        $this->processSql('CREATE INDEX IDX_AEEE362E1F55203D ON dashboard_topic_accessrole (topic_id)');
        $this->processSql('CREATE INDEX IDX_AEEE362ED60322AC ON dashboard_topic_accessrole (role_id)');
        $this->processSql('CREATE TABLE dashboard_topic_denyrole (topic_id INT NOT NULL, role_id INT NOT NULL, PRIMARY KEY(topic_id, role_id))');
        $this->processSql('CREATE INDEX IDX_272B8B161F55203D ON dashboard_topic_denyrole (topic_id)');
        $this->processSql('CREATE INDEX IDX_272B8B16D60322AC ON dashboard_topic_denyrole (role_id)');
        $this->processSql('CREATE TABLE dashboard_topic_denyuser (topic_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(topic_id, user_id))');
        $this->processSql('CREATE INDEX IDX_FDD1D7351F55203D ON dashboard_topic_denyuser (topic_id)');
        $this->processSql('CREATE INDEX IDX_FDD1D735A76ED395 ON dashboard_topic_denyuser (user_id)');
        $this->processSql('CREATE TABLE dashboard_topic_downloadrole (topic_id INT NOT NULL, role_id INT NOT NULL, PRIMARY KEY(topic_id, role_id))');
        $this->processSql('CREATE INDEX IDX_57BFA231F55203D ON dashboard_topic_downloadrole (topic_id)');
        $this->processSql('CREATE INDEX IDX_57BFA23D60322AC ON dashboard_topic_downloadrole (role_id)');
        $this->processSql('CREATE TABLE dashboard_topic_favoriteuser (topic_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(topic_id, user_id))');
        $this->processSql('CREATE INDEX IDX_FDEFC05F1F55203D ON dashboard_topic_favoriteuser (topic_id)');
        $this->processSql('CREATE INDEX IDX_FDEFC05FA76ED395 ON dashboard_topic_favoriteuser (user_id)');
        $this->processSql('CREATE TABLE dashboard_topic_institution (topic_id INT NOT NULL, institution_id INT NOT NULL, PRIMARY KEY(topic_id, institution_id))');
        $this->processSql('CREATE INDEX IDX_E02B8CCD1F55203D ON dashboard_topic_institution (topic_id)');
        $this->processSql('CREATE INDEX IDX_E02B8CCD10405986 ON dashboard_topic_institution (institution_id)');
        $this->processSql('ALTER TABLE dashboard_topic_accessrole ADD CONSTRAINT FK_AEEE362E1F55203D FOREIGN KEY (topic_id) REFERENCES dashboard_topiclist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_accessrole ADD CONSTRAINT FK_AEEE362ED60322AC FOREIGN KEY (role_id) REFERENCES user_roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_denyrole ADD CONSTRAINT FK_272B8B161F55203D FOREIGN KEY (topic_id) REFERENCES dashboard_topiclist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_denyrole ADD CONSTRAINT FK_272B8B16D60322AC FOREIGN KEY (role_id) REFERENCES user_roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_denyuser ADD CONSTRAINT FK_FDD1D7351F55203D FOREIGN KEY (topic_id) REFERENCES dashboard_topiclist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_denyuser ADD CONSTRAINT FK_FDD1D735A76ED395 FOREIGN KEY (user_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_downloadrole ADD CONSTRAINT FK_57BFA231F55203D FOREIGN KEY (topic_id) REFERENCES dashboard_topiclist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_downloadrole ADD CONSTRAINT FK_57BFA23D60322AC FOREIGN KEY (role_id) REFERENCES user_roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_favoriteuser ADD CONSTRAINT FK_FDEFC05F1F55203D FOREIGN KEY (topic_id) REFERENCES dashboard_topiclist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_favoriteuser ADD CONSTRAINT FK_FDEFC05FA76ED395 FOREIGN KEY (user_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_institution ADD CONSTRAINT FK_E02B8CCD1F55203D FOREIGN KEY (topic_id) REFERENCES dashboard_topiclist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_topic_institution ADD CONSTRAINT FK_E02B8CCD10405986 FOREIGN KEY (institution_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD requester_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD imagePath TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD imagedate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD chartComment TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD requesteddate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
        $this->processSql('ALTER TABLE dashboard_chartlist ADD CONSTRAINT FK_CAEBC0A2ED442CF4 FOREIGN KEY (requester_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_CAEBC0A2ED442CF4 ON dashboard_chartlist (requester_id)');
        $this->processSql('ALTER TABLE dashboard_topiclist ADD requester_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE dashboard_topiclist ADD requesteddate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
        $this->processSql('ALTER TABLE dashboard_topiclist ADD topicComment TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE dashboard_topiclist ADD CONSTRAINT FK_72F7C8B3ED442CF4 FOREIGN KEY (requester_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_72F7C8B3ED442CF4 ON dashboard_topiclist (requester_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP TABLE dashboard_topic_accessrole');
        $this->processSql('DROP TABLE dashboard_topic_denyrole');
        $this->processSql('DROP TABLE dashboard_topic_denyuser');
        $this->processSql('DROP TABLE dashboard_topic_downloadrole');
        $this->processSql('DROP TABLE dashboard_topic_favoriteuser');
        $this->processSql('DROP TABLE dashboard_topic_institution');
        ...
        $this->processSql('ALTER TABLE dashboard_chartlist DROP CONSTRAINT FK_CAEBC0A2ED442CF4');
        $this->processSql('DROP INDEX IDX_CAEBC0A2ED442CF4');
        $this->processSql('ALTER TABLE dashboard_chartlist DROP requester_id');
        $this->processSql('ALTER TABLE dashboard_chartlist DROP imagePath');
        $this->processSql('ALTER TABLE dashboard_chartlist DROP imagedate');
        $this->processSql('ALTER TABLE dashboard_chartlist DROP chartComment');
        $this->processSql('ALTER TABLE dashboard_chartlist DROP requesteddate');
        $this->processSql('ALTER TABLE dashboard_topiclist DROP CONSTRAINT FK_72F7C8B3ED442CF4');
        $this->processSql('DROP INDEX IDX_72F7C8B3ED442CF4');
        $this->processSql('ALTER TABLE dashboard_topiclist DROP requester_id');
        $this->processSql('ALTER TABLE dashboard_topiclist DROP requesteddate');
        $this->processSql('ALTER TABLE dashboard_topiclist DROP topicComment');
