 ...
 */
final class Version20220110194749 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE dashboard_siteparameter_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE dashboard_siteparameter (id INT NOT NULL, topic_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_DD9C13331F55203D ON dashboard_siteparameter (topic_id)');
        $this->processSql('CREATE TABLE dashboard_siteparameter_chart (siteparameter_id INT NOT NULL, chart_id INT NOT NULL, PRIMARY KEY(siteparameter_id, chart_id))');
        $this->processSql('CREATE INDEX IDX_B807A698C9C55698 ON dashboard_siteparameter_chart (siteparameter_id)');
        $this->processSql('CREATE INDEX IDX_B807A698BEF83E0A ON dashboard_siteparameter_chart (chart_id)');
        $this->processSql('ALTER TABLE dashboard_siteparameter ADD CONSTRAINT FK_DD9C13331F55203D FOREIGN KEY (topic_id) REFERENCES dashboard_topiclist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_siteparameter_chart ADD CONSTRAINT FK_B807A698C9C55698 FOREIGN KEY (siteparameter_id) REFERENCES dashboard_siteparameter (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE dashboard_siteparameter_chart ADD CONSTRAINT FK_B807A698BEF83E0A FOREIGN KEY (chart_id) REFERENCES dashboard_chartlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE dashboard_siteparameter_chart DROP CONSTRAINT FK_B807A698C9C55698');
        $this->processSql('DROP SEQUENCE dashboard_siteparameter_id_seq CASCADE');
        $this->processSql('DROP TABLE dashboard_siteparameter');
        $this->processSql('DROP TABLE dashboard_siteparameter_chart');
