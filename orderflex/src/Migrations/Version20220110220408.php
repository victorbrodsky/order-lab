 ...
 */
final class Version20220110220408 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP holidaysurl');
        $this->processSql('ALTER TABLE user_siteparameters DROP vacationaccrueddayspermonth');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_siteParameters ADD holidaysurl TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteParameters ADD vacationaccrueddayspermonth INT DEFAULT NULL');
