 ...
 */
final class Version20220110235814 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD dashboardSiteParameter_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD CONSTRAINT FK_9DD431F454D0C2A FOREIGN KEY (dashboardSiteParameter_id) REFERENCES dashboard_siteparameter (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE UNIQUE INDEX UNIQ_9DD431F454D0C2A ON user_siteparameters (dashboardSiteParameter_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE user_siteParameters DROP CONSTRAINT FK_9DD431F454D0C2A');
        $this->processSql('DROP INDEX UNIQ_9DD431F454D0C2A');
        $this->processSql('ALTER TABLE user_siteParameters DROP dashboardSiteParameter_id');
