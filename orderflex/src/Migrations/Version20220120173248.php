 ...
 */
final class Version20220120173248 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER INDEX uniq_9dd431fe0acd3a5 RENAME TO UNIQ_468040CFE0ACD3A5');
        $this->processSql('ALTER INDEX uniq_9dd431fa3f422e8 RENAME TO UNIQ_468040CFA3F422E8');
        $this->processSql('ALTER INDEX uniq_9dd431f6aab1c15 RENAME TO UNIQ_468040CF6AAB1C15');
        $this->processSql('ALTER INDEX uniq_9dd431f22f7aae2 RENAME TO UNIQ_468040CF22F7AAE2');
        $this->processSql('ALTER INDEX uniq_9dd431f2cf5057 RENAME TO UNIQ_468040CF2CF5057');
        $this->processSql('ALTER INDEX uniq_9dd431fd8fc87cc RENAME TO UNIQ_468040CFD8FC87CC');
        $this->processSql('ALTER INDEX uniq_9dd431f1d750569 RENAME TO UNIQ_468040CF1D750569');
        $this->processSql('ALTER INDEX uniq_9dd431fc6df38e1 RENAME TO UNIQ_468040CFC6DF38E1');
        $this->processSql('ALTER INDEX uniq_9dd431f454d0c2a RENAME TO UNIQ_468040CF454D0C2A');
        $this->processSql('ALTER INDEX idx_9dd431f78f00945 RENAME TO IDX_468040CF78F00945');
        $this->processSql('ALTER INDEX idx_9dd431f6a45a6ab RENAME TO IDX_468040CF6A45A6AB');
        $this->processSql('ALTER INDEX idx_9dd431f204e8e5b RENAME TO IDX_468040CF204E8E5B');
        $this->processSql('ALTER INDEX idx_9dd431faa9587ea RENAME TO IDX_468040CFAA9587EA');
        $this->processSql('ALTER INDEX idx_9dd431ff621dfce RENAME TO IDX_468040CFF621DFCE');
        $this->processSql('ALTER INDEX idx_9dd431fd74f144 RENAME TO IDX_468040CFD74F144');
        $this->processSql('ALTER INDEX idx_9dd431f14bda53b RENAME TO IDX_468040CF14BDA53B');
        $this->processSql('ALTER INDEX idx_9dd431ff46b1459 RENAME TO IDX_468040CFF46B1459');
        $this->processSql('ALTER INDEX idx_9dd431faf8d7b75 RENAME TO IDX_468040CFAF8D7B75');
        $this->processSql('ALTER INDEX uniq_9dd431f8b89f04d RENAME TO UNIQ_468040CF8B89F04D');
        $this->processSql('ALTER INDEX uniq_9dd431f1c4885f6 RENAME TO UNIQ_468040CF1C4885F6');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER INDEX uniq_468040cfe0acd3a5 RENAME TO uniq_9dd431fe0acd3a5');
        $this->processSql('ALTER INDEX idx_468040cfaa9587ea RENAME TO idx_9dd431faa9587ea');
        $this->processSql('ALTER INDEX idx_468040cf78f00945 RENAME TO idx_9dd431f78f00945');
        $this->processSql('ALTER INDEX idx_468040cfaf8d7b75 RENAME TO idx_9dd431faf8d7b75');
        $this->processSql('ALTER INDEX uniq_468040cf6aab1c15 RENAME TO uniq_9dd431f6aab1c15');
        $this->processSql('ALTER INDEX idx_468040cf6a45a6ab RENAME TO idx_9dd431f6a45a6ab');
        $this->processSql('ALTER INDEX idx_468040cf204e8e5b RENAME TO idx_9dd431f204e8e5b');
        $this->processSql('ALTER INDEX uniq_468040cf454d0c2a RENAME TO uniq_9dd431f454d0c2a');
        $this->processSql('ALTER INDEX uniq_468040cf8b89f04d RENAME TO uniq_9dd431f8b89f04d');
        $this->processSql('ALTER INDEX uniq_468040cfc6df38e1 RENAME TO uniq_9dd431fc6df38e1');
        $this->processSql('ALTER INDEX idx_468040cff46b1459 RENAME TO idx_9dd431ff46b1459');
        $this->processSql('ALTER INDEX uniq_468040cfa3f422e8 RENAME TO uniq_9dd431fa3f422e8');
        $this->processSql('ALTER INDEX uniq_468040cf1d750569 RENAME TO uniq_9dd431f1d750569');
        $this->processSql('ALTER INDEX uniq_468040cf22f7aae2 RENAME TO uniq_9dd431f22f7aae2');
        $this->processSql('ALTER INDEX uniq_468040cf2cf5057 RENAME TO uniq_9dd431f2cf5057');
        $this->processSql('ALTER INDEX uniq_468040cf1c4885f6 RENAME TO uniq_9dd431f1c4885f6');
        $this->processSql('ALTER INDEX idx_468040cff621dfce RENAME TO idx_9dd431ff621dfce');
        $this->processSql('ALTER INDEX idx_468040cfd74f144 RENAME TO idx_9dd431fd74f144');
        $this->processSql('ALTER INDEX uniq_468040cfd8fc87cc RENAME TO uniq_9dd431fd8fc87cc');
        $this->processSql('ALTER INDEX idx_468040cf14bda53b RENAME TO idx_9dd431f14bda53b');
