 ...
 */
final class Version20220128155526 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE vacreq_floatingtextlist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE vacreq_floatingtypelist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE vacreq_floatingtextlist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, textAttribute TEXT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_CEA9C564108B7592 ON vacreq_floatingtextlist (original_id)');
        $this->processSql('CREATE INDEX IDX_CEA9C56461220EA6 ON vacreq_floatingtextlist (creator_id)');
        $this->processSql('CREATE INDEX IDX_CEA9C564A43E35E8 ON vacreq_floatingtextlist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_CEA9C564BD42F28C ON vacreq_floatingtextlist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN vacreq_floatingtextlist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE vacreq_floatingtypelist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, textAttribute TEXT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_DF040F81108B7592 ON vacreq_floatingtypelist (original_id)');
        $this->processSql('CREATE INDEX IDX_DF040F8161220EA6 ON vacreq_floatingtypelist (creator_id)');
        $this->processSql('CREATE INDEX IDX_DF040F81A43E35E8 ON vacreq_floatingtypelist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_DF040F81BD42F28C ON vacreq_floatingtypelist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN vacreq_floatingtypelist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE vacreq_floatingtextlist ADD CONSTRAINT FK_CEA9C564108B7592 FOREIGN KEY (original_id) REFERENCES vacreq_floatingtextlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floatingtextlist ADD CONSTRAINT FK_CEA9C56461220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floatingtextlist ADD CONSTRAINT FK_CEA9C564A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floatingtextlist ADD CONSTRAINT FK_CEA9C564BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floatingtypelist ADD CONSTRAINT FK_DF040F81108B7592 FOREIGN KEY (original_id) REFERENCES vacreq_floatingtypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floatingtypelist ADD CONSTRAINT FK_DF040F8161220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floatingtypelist ADD CONSTRAINT FK_DF040F81A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floatingtypelist ADD CONSTRAINT FK_DF040F81BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE vacreq_siteparameter ADD floatingDayName TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE vacreq_siteparameter ADD floatingDayNote TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE vacreq_siteparameter ADD floatingRestrictDateRange BOOLEAN DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('ALTER TABLE vacreq_floatingtextlist DROP CONSTRAINT FK_CEA9C564108B7592');
        $this->processSql('ALTER TABLE vacreq_floatingtypelist DROP CONSTRAINT FK_DF040F81108B7592');
        $this->processSql('DROP SEQUENCE vacreq_floatingtextlist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE vacreq_floatingtypelist_id_seq CASCADE');
        $this->processSql('DROP TABLE vacreq_floatingtextlist');
        $this->processSql('DROP TABLE vacreq_floatingtypelist');
        ...
        $this->processSql('ALTER TABLE vacreq_siteparameter DROP floatingDayName');
        $this->processSql('ALTER TABLE vacreq_siteparameter DROP floatingDayNote');
        $this->processSql('ALTER TABLE vacreq_siteparameter DROP floatingRestrictDateRange');
