 ...
 */
final class Version20220208172536 extends PostgresMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->processSql('CREATE SEQUENCE vacreq_floating_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE vacreq_floating (id INT NOT NULL, user_id INT DEFAULT NULL, submitter_id INT DEFAULT NULL, institution_id INT DEFAULT NULL, approver_id INT DEFAULT NULL, createDate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updateDate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, approvedRejectDate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, approverComment TEXT DEFAULT NULL, work BOOLEAN DEFAULT NULL, floatingDay DATE DEFAULT NULL, updateAuthor INT DEFAULT NULL, floatingType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_809D890FA76ED395 ON vacreq_floating (user_id)');
        $this->processSql('CREATE INDEX IDX_809D890F919E5513 ON vacreq_floating (submitter_id)');
        $this->processSql('CREATE INDEX IDX_809D890F505FD3E0 ON vacreq_floating (updateAuthor)');
        $this->processSql('CREATE INDEX IDX_809D890F10405986 ON vacreq_floating (institution_id)');
        $this->processSql('CREATE INDEX IDX_809D890FBB23766C ON vacreq_floating (approver_id)');
        $this->processSql('CREATE INDEX IDX_809D890F315034D0 ON vacreq_floating (floatingType_id)');
        $this->processSql('ALTER TABLE vacreq_floating ADD CONSTRAINT FK_809D890FA76ED395 FOREIGN KEY (user_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floating ADD CONSTRAINT FK_809D890F919E5513 FOREIGN KEY (submitter_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floating ADD CONSTRAINT FK_809D890F505FD3E0 FOREIGN KEY (updateAuthor) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floating ADD CONSTRAINT FK_809D890F10405986 FOREIGN KEY (institution_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floating ADD CONSTRAINT FK_809D890FBB23766C FOREIGN KEY (approver_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_floating ADD CONSTRAINT FK_809D890F315034D0 FOREIGN KEY (floatingType_id) REFERENCES vacreq_floatingtypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->processSql('DROP SEQUENCE vacreq_floating_id_seq CASCADE');
        $this->processSql('DROP TABLE vacreq_floating');
