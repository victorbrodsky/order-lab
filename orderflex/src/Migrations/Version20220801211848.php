 ...
 */
final class Version20220801211848 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('DROP TABLE migration_versions');
        ...
        $this->processSql('ALTER TABLE user_fosuser ADD lastActivity TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('CREATE TABLE migration_versions (version VARCHAR(192) NOT NULL, executed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, execution_time INT DEFAULT NULL, PRIMARY KEY(version))');
        ...
        $this->processSql('ALTER TABLE user_fosuser DROP lastActivity');
