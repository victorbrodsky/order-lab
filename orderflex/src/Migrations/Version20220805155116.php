 ...
 */
final class Version20220805155116 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD externalMonitorUrl TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD monitorScript TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP externalMonitorUrl');
        $this->processSql('ALTER TABLE user_siteparameters DROP monitorScript');
