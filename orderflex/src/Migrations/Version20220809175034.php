 ...
 */
final class Version20220809175034 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD monitorCheckInterval INT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP monitorCheckInterval');
