 ...
 */
final class Version20220817205746 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_fosuser ALTER lastloggedurl TYPE TEXT');
        $this->processSql('ALTER TABLE user_fosuser ALTER lastloggedurl DROP DEFAULT');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_fosuser ALTER lastLoggedUrl TYPE VARCHAR(255)');
        $this->processSql('ALTER TABLE user_fosuser ALTER lastLoggedUrl DROP DEFAULT');
