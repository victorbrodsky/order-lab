 ...
 */
final class Version20220831185521 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD sendEmailUserAdded BOOLEAN DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP sendEmailUserAdded');
