 ...
 */
final class Version20220912154823 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('CREATE SEQUENCE vacreq_approvaltypelist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE vacreq_approvaltypelist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, vacationAccruedDaysPerMonth INT DEFAULT NULL, maxVacationDays INT DEFAULT NULL, maxCarryOverVacationDays INT DEFAULT NULL, noteForVacationDays TEXT DEFAULT NULL, noteForCarryOverDays TEXT DEFAULT NULL, allowCarryOver INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, textAttribute TEXT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_295B3F7E108B7592 ON vacreq_approvaltypelist (original_id)');
        $this->processSql('CREATE INDEX IDX_295B3F7E61220EA6 ON vacreq_approvaltypelist (creator_id)');
        $this->processSql('CREATE INDEX IDX_295B3F7EA43E35E8 ON vacreq_approvaltypelist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_295B3F7EBD42F28C ON vacreq_approvaltypelist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN vacreq_approvaltypelist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE vacreq_approvaltypes_institutions (approvaltype_id INT NOT NULL, institution_id INT NOT NULL, PRIMARY KEY(approvaltype_id, institution_id))');
        $this->processSql('CREATE INDEX IDX_92FF099718FBA999 ON vacreq_approvaltypes_institutions (approvaltype_id)');
        $this->processSql('CREATE INDEX IDX_92FF099710405986 ON vacreq_approvaltypes_institutions (institution_id)');
        $this->processSql('ALTER TABLE vacreq_approvaltypelist ADD CONSTRAINT FK_295B3F7E108B7592 FOREIGN KEY (original_id) REFERENCES vacreq_approvaltypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_approvaltypelist ADD CONSTRAINT FK_295B3F7E61220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_approvaltypelist ADD CONSTRAINT FK_295B3F7EA43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_approvaltypelist ADD CONSTRAINT FK_295B3F7EBD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_approvaltypes_institutions ADD CONSTRAINT FK_92FF099718FBA999 FOREIGN KEY (approvaltype_id) REFERENCES vacreq_approvaltypelist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_approvaltypes_institutions ADD CONSTRAINT FK_92FF099710405986 FOREIGN KEY (institution_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE vacreq_approvaltypelist DROP CONSTRAINT FK_295B3F7E108B7592');
        $this->processSql('ALTER TABLE vacreq_approvaltypes_institutions DROP CONSTRAINT FK_92FF099718FBA999');
        $this->processSql('DROP SEQUENCE vacreq_approvaltypelist_id_seq CASCADE');
        $this->processSql('DROP TABLE vacreq_approvaltypelist');
        $this->processSql('DROP TABLE vacreq_approvaltypes_institutions');
