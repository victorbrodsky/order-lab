 ...
 */
final class Version20220912193006 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE vacreq_approvaltypelist ALTER vacationaccrueddayspermonth TYPE NUMERIC(15, 9)');
        $this->processSql('ALTER TABLE vacreq_approvaltypelist ALTER vacationaccrueddayspermonth DROP DEFAULT');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE vacreq_approvaltypelist ALTER vacationAccruedDaysPerMonth TYPE INT');
        $this->processSql('ALTER TABLE vacreq_approvaltypelist ALTER vacationAccruedDaysPerMonth DROP DEFAULT');
