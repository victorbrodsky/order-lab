 ...
 */
final class Version20220915192645 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('CREATE TABLE vacreq_request_informuser (request_id INT NOT NULL, informuser_id INT NOT NULL, PRIMARY KEY(request_id, informuser_id))');
        $this->processSql('CREATE INDEX IDX_F037B71A427EB8A5 ON vacreq_request_informuser (request_id)');
        $this->processSql('CREATE INDEX IDX_F037B71A70457876 ON vacreq_request_informuser (informuser_id)');
        $this->processSql('CREATE TABLE vacreq_settings_informuser (settings_id INT NOT NULL, informuser_id INT NOT NULL, PRIMARY KEY(settings_id, informuser_id))');
        $this->processSql('CREATE INDEX IDX_863AC33559949888 ON vacreq_settings_informuser (settings_id)');
        $this->processSql('CREATE INDEX IDX_863AC33570457876 ON vacreq_settings_informuser (informuser_id)');
        $this->processSql('CREATE TABLE vacreq_settings_approvaltype (vacreqsettings_id INT NOT NULL, vacreqapprovaltypelist_id INT NOT NULL, PRIMARY KEY(vacreqsettings_id, vacreqapprovaltypelist_id))');
        $this->processSql('CREATE INDEX IDX_62B197E95B244110 ON vacreq_settings_approvaltype (vacreqsettings_id)');
        $this->processSql('CREATE INDEX IDX_62B197E947A3C18E ON vacreq_settings_approvaltype (vacreqapprovaltypelist_id)');
        $this->processSql('ALTER TABLE vacreq_request_informuser ADD CONSTRAINT FK_F037B71A427EB8A5 FOREIGN KEY (request_id) REFERENCES vacreq_request (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_request_informuser ADD CONSTRAINT FK_F037B71A70457876 FOREIGN KEY (informuser_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_settings_informuser ADD CONSTRAINT FK_863AC33559949888 FOREIGN KEY (settings_id) REFERENCES vacreq_settings (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_settings_informuser ADD CONSTRAINT FK_863AC33570457876 FOREIGN KEY (informuser_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_settings_approvaltype ADD CONSTRAINT FK_62B197E95B244110 FOREIGN KEY (vacreqsettings_id) REFERENCES vacreq_settings (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_settings_approvaltype ADD CONSTRAINT FK_62B197E947A3C18E FOREIGN KEY (vacreqapprovaltypelist_id) REFERENCES vacreq_approvaltypelist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('DROP TABLE vacreq_request_informuser');
        $this->processSql('DROP TABLE vacreq_settings_informuser');
        $this->processSql('DROP TABLE vacreq_settings_approvaltype');
