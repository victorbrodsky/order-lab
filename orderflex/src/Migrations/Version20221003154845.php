 ...
 */
final class Version20221003154845 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('DROP TABLE vacreq_settings_proxysubmitteruser');
        ...
        $this->processSql('ALTER TABLE vacreq_approvaltypelist DROP allowcarryover');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('CREATE TABLE vacreq_settings_proxysubmitteruser (settings_id INT NOT NULL, proxysubmitteruser_id INT NOT NULL, PRIMARY KEY(settings_id, proxysubmitteruser_id))');
        $this->processSql('CREATE INDEX idx_8c6e1458bed5706d ON vacreq_settings_proxysubmitteruser (proxysubmitteruser_id)');
        $this->processSql('CREATE INDEX idx_8c6e145859949888 ON vacreq_settings_proxysubmitteruser (settings_id)');
        $this->processSql('ALTER TABLE vacreq_settings_proxysubmitteruser ADD CONSTRAINT fk_8c6e145859949888 FOREIGN KEY (settings_id) REFERENCES vacreq_settings (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_settings_proxysubmitteruser ADD CONSTRAINT fk_8c6e1458bed5706d FOREIGN KEY (proxysubmitteruser_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE vacreq_approvaltypelist ADD allowcarryover INT DEFAULT NULL');
