 ...
 */
final class Version20221003155851 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE vacreq_approvaltypelist ADD allowCarryOver BOOLEAN DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
