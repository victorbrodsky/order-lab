 ...
 */
final class Version20221013135958 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD dbBackupConfig TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD filesBackupConfig TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP dbBackupConfig');
        $this->processSql('ALTER TABLE user_siteparameters DROP filesBackupConfig');
