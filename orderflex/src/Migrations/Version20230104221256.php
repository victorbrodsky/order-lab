 ...
 */
final class Version20230104221256 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_fosuser ADD activeAD BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE user_fosuser ADD lastAdCheck TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_fosuser DROP activeAD');
        $this->processSql('ALTER TABLE user_fosuser DROP lastAdCheck');
