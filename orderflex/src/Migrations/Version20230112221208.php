 ...
 */
final class Version20230112221208 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE vacreq_siteparameter ADD holidayDatesUrl TEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE vacreq_siteparameter DROP holidayDatesUrl');
