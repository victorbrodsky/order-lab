 ...
 */
final class Version20230120170550 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('CREATE SEQUENCE vacreq_holidayList_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE vacreq_observedholidayList_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE vacreq_holidayList (id INT NOT NULL, original_id INT DEFAULT NULL, country_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, holidayName VARCHAR(255) DEFAULT NULL, holidayDate DATE DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, textAttribute TEXT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_F9C9F790108B7592 ON vacreq_holidayList (original_id)');
        $this->processSql('CREATE INDEX IDX_F9C9F790F92F3E70 ON vacreq_holidayList (country_id)');
        $this->processSql('CREATE INDEX IDX_F9C9F79061220EA6 ON vacreq_holidayList (creator_id)');
        $this->processSql('CREATE INDEX IDX_F9C9F790A43E35E8 ON vacreq_holidayList (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_F9C9F790BD42F28C ON vacreq_holidayList (objectType_id)');
        $this->processSql('COMMENT ON COLUMN vacreq_holidayList.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE vacreq_holiday_institution (holiday_id INT NOT NULL, institution_id INT NOT NULL, PRIMARY KEY(holiday_id, institution_id))');
        $this->processSql('CREATE INDEX IDX_298E0065830A3EC0 ON vacreq_holiday_institution (holiday_id)');
        $this->processSql('CREATE INDEX IDX_298E006510405986 ON vacreq_holiday_institution (institution_id)');
        $this->processSql('CREATE TABLE vacreq_observedholidayList (id INT NOT NULL, original_id INT DEFAULT NULL, country_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, holidayName VARCHAR(255) DEFAULT NULL, holidayDate DATE DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, textAttribute TEXT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_AB361BBB108B7592 ON vacreq_observedholidayList (original_id)');
        $this->processSql('CREATE INDEX IDX_AB361BBBF92F3E70 ON vacreq_observedholidayList (country_id)');
        $this->processSql('CREATE INDEX IDX_AB361BBB61220EA6 ON vacreq_observedholidayList (creator_id)');
        $this->processSql('CREATE INDEX IDX_AB361BBBA43E35E8 ON vacreq_observedholidayList (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_AB361BBBBD42F28C ON vacreq_observedholidayList (objectType_id)');
        $this->processSql('COMMENT ON COLUMN vacreq_observedholidayList.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE vacreq_observedholiday_institution (observedholiday_id INT NOT NULL, institution_id INT NOT NULL, PRIMARY KEY(observedholiday_id, institution_id))');
        $this->processSql('CREATE INDEX IDX_EF858561770DE49A ON vacreq_observedholiday_institution (observedholiday_id)');
        $this->processSql('CREATE INDEX IDX_EF85856110405986 ON vacreq_observedholiday_institution (institution_id)');
        $this->processSql('ALTER TABLE vacreq_holidayList ADD CONSTRAINT FK_F9C9F790108B7592 FOREIGN KEY (original_id) REFERENCES vacreq_holidayList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_holidayList ADD CONSTRAINT FK_F9C9F790F92F3E70 FOREIGN KEY (country_id) REFERENCES user_countries (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_holidayList ADD CONSTRAINT FK_F9C9F79061220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_holidayList ADD CONSTRAINT FK_F9C9F790A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_holidayList ADD CONSTRAINT FK_F9C9F790BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_holiday_institution ADD CONSTRAINT FK_298E0065830A3EC0 FOREIGN KEY (holiday_id) REFERENCES vacreq_holidayList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_holiday_institution ADD CONSTRAINT FK_298E006510405986 FOREIGN KEY (institution_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_observedholidayList ADD CONSTRAINT FK_AB361BBB108B7592 FOREIGN KEY (original_id) REFERENCES vacreq_observedholidayList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_observedholidayList ADD CONSTRAINT FK_AB361BBBF92F3E70 FOREIGN KEY (country_id) REFERENCES user_countries (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_observedholidayList ADD CONSTRAINT FK_AB361BBB61220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_observedholidayList ADD CONSTRAINT FK_AB361BBBA43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_observedholidayList ADD CONSTRAINT FK_AB361BBBBD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_observedholiday_institution ADD CONSTRAINT FK_EF858561770DE49A FOREIGN KEY (observedholiday_id) REFERENCES vacreq_observedholidayList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_observedholiday_institution ADD CONSTRAINT FK_EF85856110405986 FOREIGN KEY (institution_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE vacreq_holidayList DROP CONSTRAINT FK_F9C9F790108B7592');
        $this->processSql('ALTER TABLE vacreq_holiday_institution DROP CONSTRAINT FK_298E0065830A3EC0');
        $this->processSql('ALTER TABLE vacreq_observedholidayList DROP CONSTRAINT FK_AB361BBB108B7592');
        $this->processSql('ALTER TABLE vacreq_observedholiday_institution DROP CONSTRAINT FK_EF858561770DE49A');
        $this->processSql('DROP SEQUENCE vacreq_holidayList_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE vacreq_observedholidayList_id_seq CASCADE');
        $this->processSql('DROP TABLE vacreq_holidayList');
        $this->processSql('DROP TABLE vacreq_holiday_institution');
        $this->processSql('DROP TABLE vacreq_observedholidayList');
        $this->processSql('DROP TABLE vacreq_observedholiday_institution');
