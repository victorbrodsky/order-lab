 ...
 */
final class Version20230123161450 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('CREATE TABLE vacreq_siteparameter_institution (siteparameter_id INT NOT NULL, institution_id INT NOT NULL, PRIMARY KEY(siteparameter_id, institution_id))');
        $this->processSql('CREATE INDEX IDX_2F6920B0C9C55698 ON vacreq_siteparameter_institution (siteparameter_id)');
        $this->processSql('CREATE INDEX IDX_2F6920B010405986 ON vacreq_siteparameter_institution (institution_id)');
        $this->processSql('ALTER TABLE vacreq_siteparameter_institution ADD CONSTRAINT FK_2F6920B0C9C55698 FOREIGN KEY (siteparameter_id) REFERENCES vacreq_siteparameter (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE vacreq_siteparameter_institution ADD CONSTRAINT FK_2F6920B010405986 FOREIGN KEY (institution_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('DROP TABLE vacreq_siteparameter_institution');
