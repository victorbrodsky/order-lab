 ...
 */
final class Version20230221175104 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE vacreq_siteparameter ADD enableFloatingDay BOOLEAN DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE vacreq_siteparameter DROP enableFloatingDay');
