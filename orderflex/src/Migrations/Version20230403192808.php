 ...
 */
final class Version20230403192808 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_googleformconfig ADD felSpreadsheetFolderId TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE fellapp_googleformconfig ADD felUploadsFolderId TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE fellapp_googleformconfig ADD felTemplateFileId TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE fellapp_googleformconfig ADD felBackupTemplateFileId TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_googleFormConfig DROP felSpreadsheetFolderId');
        $this->processSql('ALTER TABLE fellapp_googleFormConfig DROP felUploadsFolderId');
        $this->processSql('ALTER TABLE fellapp_googleFormConfig DROP felTemplateFileId');
        $this->processSql('ALTER TABLE fellapp_googleFormConfig DROP felBackupTemplateFileId');
    }
}
