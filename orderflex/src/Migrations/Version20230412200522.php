 ...
 */
final class Version20230412200522 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP clientemailfellapp');
        $this->processSql('ALTER TABLE user_siteparameters DROP userimpersonateemailfellapp');
        $this->processSql('ALTER TABLE user_siteparameters DROP templateidfellapp');
        $this->processSql('ALTER TABLE user_siteparameters DROP codegoogleformfellapp');
        $this->processSql('ALTER TABLE user_siteparameters DROP folderidfellapp');
        $this->processSql('ALTER TABLE user_siteparameters DROP configfilefolderidfellapp');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD clientemailfellapp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD userimpersonateemailfellapp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD templateidfellapp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD codegoogleformfellapp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD folderidfellapp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD configfilefolderidfellapp TEXT DEFAULT NULL');
