 ...
 */
final class Version20230412204201 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD confirmationEmailFellApp TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP confirmationemailfellapp');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP confirmationEmailFellApp');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD confirmationemailfellapp TEXT DEFAULT NULL');
