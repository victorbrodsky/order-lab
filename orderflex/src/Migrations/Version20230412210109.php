 ...
 */
final class Version20230412210109 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD applicationPageLinkFellApp TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP applicationpagelinkfellapp');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP applicationPageLinkFellApp');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD applicationpagelinkfellapp TEXT DEFAULT NULL');
