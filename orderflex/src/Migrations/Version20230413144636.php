 ...
 */
final class Version20230413144636 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD authPathFellApp TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP p12keypathfellapp');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP authPathFellApp');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD p12keypathfellapp TEXT DEFAULT NULL');
