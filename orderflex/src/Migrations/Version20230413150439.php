 ...
 */
final class Version20230413150439 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD googleDriveApiUrlFellApp TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP googledriveapiurlfellapp');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP googleDriveApiUrlFellApp');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD googledriveapiurlfellapp TEXT DEFAULT NULL');
