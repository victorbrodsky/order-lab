 ...
 */
final class Version20230413160554 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD localInstitutionFellApp_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD CONSTRAINT FK_7990967F27E569C1 FOREIGN KEY (localInstitutionFellApp_id) REFERENCES user_institution (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_7990967F27E569C1 ON fellapp_siteparameter (localInstitutionFellApp_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP CONSTRAINT FK_7990967F27E569C1');
        $this->processSql('DROP INDEX IDX_7990967F27E569C1');
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP localInstitutionFellApp_id');
