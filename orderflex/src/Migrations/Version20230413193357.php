 ...
 */
final class Version20230413193357 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD identificationUploadLetterFellApp TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP identificationuploadletterfellapp');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP identificationUploadLetterFellApp');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD identificationuploadletterfellapp TEXT DEFAULT NULL');
