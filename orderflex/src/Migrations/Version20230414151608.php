 ...
 */
final class Version20230414151608 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD recLetterSaltFellApp TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP reclettersaltfellapp');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP recLetterSaltFellApp');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD reclettersaltfellapp TEXT DEFAULT NULL');
