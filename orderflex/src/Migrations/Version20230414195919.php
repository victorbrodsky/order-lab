 ...
 */
final class Version20230414195919 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD confirmationSubjectFellApp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD confirmationBodyFellApp TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP confirmationsubjectfellapp');
        $this->processSql('ALTER TABLE user_siteparameters DROP confirmationbodyfellapp');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP confirmationSubjectFellApp');
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP confirmationBodyFellApp');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD confirmationsubjectfellapp TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE user_siteparameters ADD confirmationbodyfellapp TEXT DEFAULT NULL');
