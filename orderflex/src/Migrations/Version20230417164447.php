 ...
 */
final class Version20230417164447 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteparameter ADD yearsOldAplicationsFellApp INT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
        ...
        $this->processSql('ALTER TABLE user_siteparameters DROP yearsoldaplicationsfellapp');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE fellapp_siteParameter DROP yearsOldAplicationsFellApp');
        ...
        $this->processSql('ALTER TABLE user_siteparameters ADD yearsoldaplicationsfellapp INT DEFAULT NULL');
