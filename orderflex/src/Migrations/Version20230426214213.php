 ...
 */
final class Version20230426214213 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('CREATE SEQUENCE transres_colldivlist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE SEQUENCE transres_colllablist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE transres_colldivlist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, textAttribute TEXT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_36D66928108B7592 ON transres_colldivlist (original_id)');
        $this->processSql('CREATE INDEX IDX_36D6692861220EA6 ON transres_colldivlist (creator_id)');
        $this->processSql('CREATE INDEX IDX_36D66928A43E35E8 ON transres_colldivlist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_36D66928BD42F28C ON transres_colldivlist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN transres_colldivlist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE transres_colllablist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, textAttribute TEXT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_7C0A9460108B7592 ON transres_colllablist (original_id)');
        $this->processSql('CREATE INDEX IDX_7C0A946061220EA6 ON transres_colllablist (creator_id)');
        $this->processSql('CREATE INDEX IDX_7C0A9460A43E35E8 ON transres_colllablist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_7C0A9460BD42F28C ON transres_colllablist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN transres_colllablist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE transres_project_colllab (project_id INT NOT NULL, colllab_id INT NOT NULL, PRIMARY KEY(project_id, colllab_id))');
        $this->processSql('CREATE INDEX IDX_51377DDC166D1F9C ON transres_project_colllab (project_id)');
        $this->processSql('CREATE INDEX IDX_51377DDC4299B863 ON transres_project_colllab (colllab_id)');
        $this->processSql('CREATE TABLE transres_project_colldiv (project_id INT NOT NULL, colldiv_id INT NOT NULL, PRIMARY KEY(project_id, colldiv_id))');
        $this->processSql('CREATE INDEX IDX_8D277211166D1F9C ON transres_project_colldiv (project_id)');
        $this->processSql('CREATE INDEX IDX_8D27721141C1B107 ON transres_project_colldiv (colldiv_id)');
        $this->processSql('ALTER TABLE transres_colldivlist ADD CONSTRAINT FK_36D66928108B7592 FOREIGN KEY (original_id) REFERENCES transres_colldivlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_colldivlist ADD CONSTRAINT FK_36D6692861220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_colldivlist ADD CONSTRAINT FK_36D66928A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_colldivlist ADD CONSTRAINT FK_36D66928BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_colllablist ADD CONSTRAINT FK_7C0A9460108B7592 FOREIGN KEY (original_id) REFERENCES transres_colllablist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_colllablist ADD CONSTRAINT FK_7C0A946061220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_colllablist ADD CONSTRAINT FK_7C0A9460A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_colllablist ADD CONSTRAINT FK_7C0A9460BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_project_colllab ADD CONSTRAINT FK_51377DDC166D1F9C FOREIGN KEY (project_id) REFERENCES transres_project (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_project_colllab ADD CONSTRAINT FK_51377DDC4299B863 FOREIGN KEY (colllab_id) REFERENCES transres_colllablist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_project_colldiv ADD CONSTRAINT FK_8D277211166D1F9C FOREIGN KEY (project_id) REFERENCES transres_project (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_project_colldiv ADD CONSTRAINT FK_8D27721141C1B107 FOREIGN KEY (colldiv_id) REFERENCES transres_colldivlist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE transres_colldivlist DROP CONSTRAINT FK_36D66928108B7592');
        $this->processSql('ALTER TABLE transres_project_colldiv DROP CONSTRAINT FK_8D27721141C1B107');
        $this->processSql('ALTER TABLE transres_colllablist DROP CONSTRAINT FK_7C0A9460108B7592');
        $this->processSql('ALTER TABLE transres_project_colllab DROP CONSTRAINT FK_51377DDC4299B863');
        $this->processSql('DROP SEQUENCE transres_colldivlist_id_seq CASCADE');
        $this->processSql('DROP SEQUENCE transres_colllablist_id_seq CASCADE');
        $this->processSql('DROP TABLE transres_colldivlist');
        $this->processSql('DROP TABLE transres_colllablist');
        $this->processSql('DROP TABLE transres_project_colllab');
        $this->processSql('DROP TABLE transres_project_colldiv');
