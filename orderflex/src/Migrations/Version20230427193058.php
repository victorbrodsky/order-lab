 ...
 */
final class Version20230427193058 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE transres_project ADD needStatSupport BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD amountStatSupport TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD needInfSupport BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD amountInfSupport TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD studyPopulation TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD numberPatient TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD numberLabReport TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD studyDuration TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE transres_project DROP needStatSupport');
        $this->processSql('ALTER TABLE transres_project DROP amountStatSupport');
        $this->processSql('ALTER TABLE transres_project DROP needInfSupport');
        $this->processSql('ALTER TABLE transres_project DROP amountInfSupport');
        $this->processSql('ALTER TABLE transres_project DROP studyPopulation');
        $this->processSql('ALTER TABLE transres_project DROP numberPatient');
        $this->processSql('ALTER TABLE transres_project DROP numberLabReport');
        $this->processSql('ALTER TABLE transres_project DROP studyDuration');
