 ...
 */
final class Version20230502151030 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('CREATE TABLE transres_project_subminvestigator (project_id INT NOT NULL, subminvestigator_id INT NOT NULL, PRIMARY KEY(project_id, subminvestigator_id))');
        $this->processSql('CREATE INDEX IDX_DBC9F437166D1F9C ON transres_project_subminvestigator (project_id)');
        $this->processSql('CREATE INDEX IDX_DBC9F4372E90304E ON transres_project_subminvestigator (subminvestigator_id)');
        $this->processSql('ALTER TABLE transres_project_subminvestigator ADD CONSTRAINT FK_DBC9F437166D1F9C FOREIGN KEY (project_id) REFERENCES transres_project (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_project_subminvestigator ADD CONSTRAINT FK_DBC9F4372E90304E FOREIGN KEY (subminvestigator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE transres_project ADD collDepartment TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD collInst TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD collInstPi BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD essentialInfo TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD strategy TEXT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD otherResource TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('DROP TABLE transres_project_subminvestigator');
        ...
        $this->processSql('ALTER TABLE transres_project DROP collDepartment');
        $this->processSql('ALTER TABLE transres_project DROP collInst');
        $this->processSql('ALTER TABLE transres_project DROP collInstPi');
        $this->processSql('ALTER TABLE transres_project DROP essentialInfo');
        $this->processSql('ALTER TABLE transres_project DROP strategy');
        $this->processSql('ALTER TABLE transres_project DROP otherResource');
    }
}
