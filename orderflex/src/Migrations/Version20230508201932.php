 ...
 */
final class Version20230508201932 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE transres_project ADD fundByPath BOOLEAN DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD fundDescription TEXT DEFAULT NULL');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE transres_project DROP fundByPath');
        $this->processSql('ALTER TABLE transres_project DROP fundDescription');
    }
}
