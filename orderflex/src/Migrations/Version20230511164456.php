 ...
 */
final class Version20230511164456 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('CREATE SEQUENCE transres_requestergrouplist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE transres_requestergrouplist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, textAttribute TEXT DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_65F39C14108B7592 ON transres_requestergrouplist (original_id)');
        $this->processSql('CREATE INDEX IDX_65F39C1461220EA6 ON transres_requestergrouplist (creator_id)');
        $this->processSql('CREATE INDEX IDX_65F39C14A43E35E8 ON transres_requestergrouplist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_65F39C14BD42F28C ON transres_requestergrouplist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN transres_requestergrouplist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('ALTER TABLE transres_requestergrouplist ADD CONSTRAINT FK_65F39C14108B7592 FOREIGN KEY (original_id) REFERENCES transres_requestergrouplist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_requestergrouplist ADD CONSTRAINT FK_65F39C1461220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_requestergrouplist ADD CONSTRAINT FK_65F39C14A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_requestergrouplist ADD CONSTRAINT FK_65F39C14BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->processSql('ALTER TABLE transres_project ADD requesterGroup_id INT DEFAULT NULL');
        $this->processSql('ALTER TABLE transres_project ADD CONSTRAINT FK_995201AF6E7C78D3 FOREIGN KEY (requesterGroup_id) REFERENCES transres_requestergrouplist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('CREATE INDEX IDX_995201AF6E7C78D3 ON transres_project (requesterGroup_id)');
        $this->processSql('DROP INDEX "primary"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE transres_project DROP CONSTRAINT FK_995201AF6E7C78D3');
        $this->processSql('ALTER TABLE transres_requestergrouplist DROP CONSTRAINT FK_65F39C14108B7592');
        $this->processSql('DROP SEQUENCE transres_requestergrouplist_id_seq CASCADE');
        $this->processSql('DROP TABLE transres_requestergrouplist');
        ...
        $this->processSql('DROP INDEX IDX_995201AF6E7C78D3');
        $this->processSql('ALTER TABLE transres_project DROP requesterGroup_id');
    }
}
