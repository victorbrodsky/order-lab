 ...
 */
final class Version20230518192307 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('CREATE SEQUENCE transres_compcategorylist_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->processSql('CREATE TABLE transres_compcategorylist (id INT NOT NULL, original_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, updatedby_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(255) DEFAULT NULL, shortname VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updatedon TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, orderinlist INT NOT NULL, updateAuthorRoles TEXT DEFAULT NULL, fulltitle VARCHAR(255) DEFAULT NULL, linkToListId VARCHAR(255) DEFAULT NULL, entityId VARCHAR(255) DEFAULT NULL, entityNamespace VARCHAR(255) DEFAULT NULL, entityName VARCHAR(255) DEFAULT NULL, version INT DEFAULT NULL, textAttribute TEXT DEFAULT NULL, urlSlug VARCHAR(255) DEFAULT NULL, objectType_id INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->processSql('CREATE INDEX IDX_56F9C172108B7592 ON transres_compcategorylist (original_id)');
        $this->processSql('CREATE INDEX IDX_56F9C17261220EA6 ON transres_compcategorylist (creator_id)');
        $this->processSql('CREATE INDEX IDX_56F9C172A43E35E8 ON transres_compcategorylist (updatedby_id)');
        $this->processSql('CREATE INDEX IDX_56F9C172BD42F28C ON transres_compcategorylist (objectType_id)');
        $this->processSql('COMMENT ON COLUMN transres_compcategorylist.updateAuthorRoles IS \'(DC2Type:array)\'');
        $this->processSql('CREATE TABLE transres_project_comptype (project_id INT NOT NULL, comptype_id INT NOT NULL, PRIMARY KEY(project_id, comptype_id))');
        $this->processSql('CREATE INDEX IDX_F1CE8795166D1F9C ON transres_project_comptype (project_id)');
        $this->processSql('CREATE INDEX IDX_F1CE8795DB01BAA6 ON transres_project_comptype (comptype_id)');
        $this->processSql('ALTER TABLE transres_compcategorylist ADD CONSTRAINT FK_56F9C172108B7592 FOREIGN KEY (original_id) REFERENCES transres_compcategorylist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_compcategorylist ADD CONSTRAINT FK_56F9C17261220EA6 FOREIGN KEY (creator_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_compcategorylist ADD CONSTRAINT FK_56F9C172A43E35E8 FOREIGN KEY (updatedby_id) REFERENCES user_fosuser (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_compcategorylist ADD CONSTRAINT FK_56F9C172BD42F28C FOREIGN KEY (objectType_id) REFERENCES user_objectTypeList (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_project_comptype ADD CONSTRAINT FK_F1CE8795166D1F9C FOREIGN KEY (project_id) REFERENCES transres_project (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_project_comptype ADD CONSTRAINT FK_F1CE8795DB01BAA6 FOREIGN KEY (comptype_id) REFERENCES transres_compcategorylist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE transres_compcategorylist DROP CONSTRAINT FK_56F9C172108B7592');
        $this->processSql('ALTER TABLE transres_project_comptype DROP CONSTRAINT FK_F1CE8795DB01BAA6');
        $this->processSql('DROP SEQUENCE transres_compcategorylist_id_seq CASCADE');
        $this->processSql('DROP TABLE transres_compcategorylist');
        $this->processSql('DROP TABLE transres_project_comptype');
