 ...
 */
final class Version20230523194552 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('CREATE TABLE transres_project_pdf (project_id INT NOT NULL, pdf_id INT NOT NULL, PRIMARY KEY(project_id, pdf_id))');
        $this->processSql('CREATE INDEX IDX_560FB524166D1F9C ON transres_project_pdf (project_id)');
        $this->processSql('CREATE INDEX IDX_560FB524511FC912 ON transres_project_pdf (pdf_id)');
        $this->processSql('ALTER TABLE transres_project_pdf ADD CONSTRAINT FK_560FB524166D1F9C FOREIGN KEY (project_id) REFERENCES transres_project (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->processSql('ALTER TABLE transres_project_pdf ADD CONSTRAINT FK_560FB524511FC912 FOREIGN KEY (pdf_id) REFERENCES user_document (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('DROP TABLE transres_project_pdf');
