 ...
 */
final class Version20230606143103 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteparameters ADD recipientFundNumber VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->processSql('ALTER TABLE transres_siteParameters DROP recipientFundNumber');
