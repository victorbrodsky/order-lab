 ...
 */
final class Version20250630155514 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vacreq_siteparameter ADD enableTravelIntakeForm BOOLEAN DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vacreq_siteparameter DROP enableTravelIntakeForm
        SQL);
        $this->addSql(<<<'SQL'
