 ...
 */
final class Version20250702171250 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_accountrequest ADD requestedInstitutionScope VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_accountrequest DROP requestedInstitutionScope
        SQL);
        $this->addSql(<<<'SQL'
