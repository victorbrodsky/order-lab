 ...
 */
final class Version20250707185638 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_sitelist ADD showSignUp BOOLEAN DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_sitelist ADD showRequestAccount BOOLEAN DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_sitelist ADD showForgotPassword BOOLEAN DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_siteList DROP showSignUp
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_siteList DROP showRequestAccount
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_siteList DROP showForgotPassword
        SQL);
        $this->addSql(<<<'SQL'
