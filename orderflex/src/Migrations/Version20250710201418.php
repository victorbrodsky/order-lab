 ...
 */
final class Version20250710201418 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE vacreq_siteparameter_intakepdf (siteparameter_id INT NOT NULL, document_id INT NOT NULL, PRIMARY KEY(siteparameter_id, document_id))
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_570E2C52C9C55698 ON vacreq_siteparameter_intakepdf (siteparameter_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_570E2C52C33F7837 ON vacreq_siteparameter_intakepdf (document_id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vacreq_siteparameter_intakepdf ADD CONSTRAINT FK_570E2C52C9C55698 FOREIGN KEY (siteparameter_id) REFERENCES vacreq_siteparameter (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vacreq_siteparameter_intakepdf ADD CONSTRAINT FK_570E2C52C33F7837 FOREIGN KEY (document_id) REFERENCES user_document (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vacreq_siteparameter ADD titleTravelIntakeForm TEXT DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vacreq_siteparameter_intakepdf DROP CONSTRAINT FK_570E2C52C9C55698
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vacreq_siteparameter_intakepdf DROP CONSTRAINT FK_570E2C52C33F7837
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE vacreq_siteparameter_intakepdf
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vacreq_siteparameter DROP titleTravelIntakeForm
        SQL);
        $this->addSql(<<<'SQL'
