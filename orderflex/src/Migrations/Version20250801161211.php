 ...
 */
final class Version20250801161211 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_siteparameters ADD showTenantsHomepage BOOLEAN DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_siteparameters DROP showTenantsHomepage
        SQL);
        $this->addSql(<<<'SQL'
