 ...
 */
final class Version20250929202348 extends PostgresMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE user_tenantmanager_highreslogo (tenantmanager_id INT NOT NULL, logo_id INT NOT NULL, PRIMARY KEY(tenantmanager_id, logo_id))
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_E3C64DA4165A54A3 ON user_tenantmanager_highreslogo (tenantmanager_id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_E3C64DA4F98F144A ON user_tenantmanager_highreslogo (logo_id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager_highreslogo ADD CONSTRAINT FK_E3C64DA4165A54A3 FOREIGN KEY (tenantmanager_id) REFERENCES user_tenantmanager (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager_highreslogo ADD CONSTRAINT FK_E3C64DA4F98F144A FOREIGN KEY (logo_id) REFERENCES user_document (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE fellapp_siteparameter ADD enablePublicFellApp BOOLEAN DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager ADD servicesShow BOOLEAN DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager ADD servicestext TEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager ADD width TEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager ADD height TEXT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager_highreslogo DROP CONSTRAINT FK_E3C64DA4165A54A3
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager_highreslogo DROP CONSTRAINT FK_E3C64DA4F98F144A
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE user_tenantmanager_highreslogo
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE fellapp_siteParameter DROP enablePublicFellApp
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager DROP servicesShow
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager DROP servicestext
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager DROP width
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_tenantmanager DROP height
        SQL);
        $this->addSql(<<<'SQL'
