...
run_step "4b) php bin/console doctrine:migrations:migrate --all-or-nothing --no-interaction" php bin/console doctrine:migrations:migrate --all-or-nothing --no-interaction
